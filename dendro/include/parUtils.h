 ...
 * @param searchList globally sorted unique list. No processor must call this function with an empty list.
 * @param results maximum lower bound in searchList for the  corresponding key
...
/**
 * @brief Computes the parallel rank for a set of numbers. 
 * 
 * @tparam T : in data type. 
 * @param in : array of elements of type T
 * @param sz : size of in vector
 * @param out : global rank in the order of elements in in. 
 * @param comm : mpi communicator. 
 */
template <typename T>
