...
namespace em3 {
mem::memory_pool<DendroScalar> EM3_MEM_POOL =
...
double EM3_OCTREE_MAX[3] = {(double)(1u << EM3_MAXDEPTH),
                            (double)(1u << EM3_MAXDEPTH),
                            (double)(1u << EM3_MAXDEPTH)};

//@note assumes the computational domain is a cube as well.
double EM3_RK45_TIME_STEP_SIZE = EM3_CFL_FACTOR *
                                 (EM3_COMPD_MAX[0] - EM3_COMPD_MIN[0]) *
                                 (1.0 / (double)(1u << EM3_MAXDEPTH));
