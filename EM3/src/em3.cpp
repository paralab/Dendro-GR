...
int main(int argc, char** argv) {
    ...
    shrinkOrExpandOctree(tmpNodes, em3::EM3_LOAD_IMB_TOL, DENDRO_DEFAULT_SF_K,
    ...
    if (isActive) {
        ...
        SFC::parSort::SFC_treeSort(tmpNodes, tmpVec, tmpVec, tmpVec,
                                   em3::EM3_LOAD_IMB_TOL, m_uiMaxDepth, root,
                                   ROOT_ROTATION, 1, TS_REMOVE_DUPLICATES,
                                   em3::EM3_SPLIT_FIX, commActive);
    ...
    ot::Mesh* mesh = new ot::Mesh(balOct, 1, em3::EM3_ELE_ORDER, comm, true,
                                  ot::SM_TYPE::FDM, em3::EM3_DENDRO_GRAIN_SZ,
    ...
    ode::solver::RK4_EM3 rk_em3(mesh, em3::EM3_RK45_TIME_BEGIN,
                                em3::EM3_RK45_TIME_END,
                                em3::EM3_RK45_TIME_STEP_SIZE);
    // ode::solver::RK3_EM3
    // rk_em3(mesh,em3::EM3_RK45_TIME_BEGIN,em3::EM3_RK45_TIME_END,em3::EM3_RK45_TIME_STEP_SIZE);
