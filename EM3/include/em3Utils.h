...
#define GRIDX_TO_X(xg) \
    (((Rx / RgX) * (xg - em3::EM3_OCTREE_MIN[0])) + em3::EM3_COMPD_MIN[0])
#define GRIDY_TO_Y(yg) \
    (((Ry / RgY) * (yg - em3::EM3_OCTREE_MIN[1])) + em3::EM3_COMPD_MIN[1])
#define GRIDZ_TO_Z(zg) \
    (((Rz / RgZ) * (zg - em3::EM3_OCTREE_MIN[2])) + em3::EM3_COMPD_MIN[2])

#define X_TO_GRIDX(xc) \
    (((RgX / Rx) * (xc - em3::EM3_COMPD_MIN[0])) + em3::EM3_OCTREE_MIN[0])
#define Y_TO_GRIDY(yc) \
    (((RgY / Ry) * (yc - em3::EM3_COMPD_MIN[1])) + em3::EM3_OCTREE_MIN[1])
#define Z_TO_GRIDZ(zc) \
    (((RgZ / Rz) * (zc - em3::EM3_COMPD_MIN[2])) + em3::EM3_OCTREE_MIN[2])
 ...
 *be (VAR::U_SYMAT5+1)
 * @note This function is taken from the old single core em3 version.
 **/
 ...
 * @param[in/out] zipVars: em3 variables to which dissipation needs to be
 * appied.
