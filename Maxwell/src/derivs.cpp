        ...
        for (int j = jb; j < je; j++) {
            Du[IDX(ib, j, k)] =
                ...
                (-u[IDX(ib + 4, j, k)] + 6.0 * u[IDX(ib + 3, j, k)] -
                 15.0 * u[IDX(ib + 2, j, k)] + 20.0 * u[IDX(ib + 1, j, k)] -
                 15.0 * u[IDX(ib, j, k)] + 6.0 * u[IDX(ib - 1, j, k)] -
                 u[IDX(ib - 2, j, k)]);
            ...
            Du[IDX(ie - 1, j, k)] =
                pre_factor_6_dx *
                (-u[IDX(ie + 1, j, k)] + 6.0 * u[IDX(ie, j, k)] -
                 15.0 * u[IDX(ie - 1, j, k)] + 20.0 * u[IDX(ie - 2, j, k)] -
                 15.0 * u[IDX(ie - 3, j, k)] + 6.0 * u[IDX(ie - 4, j, k)] -
                 u[IDX(ie - 5, j, k)]);
        }
    }
        ...
        for (int i = ib; i < ie; i++) {
            Du[IDX(i, jb, k)] =
                ...
                (-u[IDX(i, jb + 4, k)] + 6.0 * u[IDX(i, jb + 3, k)] -
                 15.0 * u[IDX(i, jb + 2, k)] + 20.0 * u[IDX(i, jb + 1, k)] -
                 15.0 * u[IDX(i, jb, k)] + 6.0 * u[IDX(i, jb - 1, k)] -
                 u[IDX(i, jb - 2, k)]);
            ...
            Du[IDX(i, je - 1, k)] =
                pre_factor_6_dy *
                (-u[IDX(i, je + 1, k)] + 6.0 * u[IDX(i, je, k)] -
                 15.0 * u[IDX(i, je - 1, k)] + 20.0 * u[IDX(i, je - 2, k)] -
                 15.0 * u[IDX(i, je - 3, k)] + 6.0 * u[IDX(i, je - 4, k)] -
                 u[IDX(i, je - 5, k)]);
        }
    }
        ...
        for (int i = ib; i < ie; i++) {
            Du[IDX(i, j, kb)] =
                ...
                (-u[IDX(i, j, kb + 4)] + 6.0 * u[IDX(i, j, kb + 3)] -
                 15.0 * u[IDX(i, j, kb + 2)] + 20.0 * u[IDX(i, j, kb + 1)] -
                 15.0 * u[IDX(i, j, kb)] + 6.0 * u[IDX(i, j, kb - 1)] -
                 u[IDX(i, j, kb - 2)]);
            ...
            Du[IDX(i, j, ke - 1)] =
                pre_factor_6_dz *
                (-u[IDX(i, j, ke + 1)] + 6.0 * u[IDX(i, j, ke)] -
                 15.0 * u[IDX(i, j, ke - 1)] + 20.0 * u[IDX(i, j, ke - 2)] -
                 15.0 * u[IDX(i, j, ke - 3)] + 6.0 * u[IDX(i, j, ke - 4)] -
                 u[IDX(i, j, ke - 5)]);
        }
    }
