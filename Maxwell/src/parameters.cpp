...
namespace maxwell
{
	...
	double MAXWELL_COMPD_MIN[3]={MAXWELL_GRID_MIN_X,MAXWELL_GRID_MIN_Y,MAXWELL_GRID_MIN_Z};
	double MAXWELL_COMPD_MAX[3]={MAXWELL_GRID_MAX_X,MAXWELL_GRID_MAX_Y,MAXWELL_GRID_MAX_Z};

	double MAXWELL_OCTREE_MIN[3]={0.0,0.0,0.0};
	double MAXWELL_OCTREE_MAX[3]={(double)(1u<<MAXWELL_MAXDEPTH),(double)(1u<<MAXWELL_MAXDEPTH),(double)(1u<<MAXWELL_MAXDEPTH)};
