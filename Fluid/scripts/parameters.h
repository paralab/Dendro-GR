...
namespace fluid
{
	...
	extern unsigned int FLUID_TIME_STEP_OUTPUT_FREQ;extern unsigned int FLUID_SPLIT_FIX;	extern double FLUID_COMPD_MIN[3];
	...
	static const unsigned int FLUID_NUM_VARS_INTENL=(FLUID_RK45_STAGES+1)*FLUID_NUM_VARS;
