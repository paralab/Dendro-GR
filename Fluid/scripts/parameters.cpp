...
unsigned int FLUID_VTU_OUTPUT_EVOL_INDICES[FLUID_NUM_VARS] = {0, 1, 2, 3, 4};

unsigned int FLUID_DENDRO_GRAIN_SZ                         = 100;

unsigned int FLUID_ASYNC_COMM_K                            = 2;
...
unsigned int FLUID_REFINE_VARIABLE_INDICES[FLUID_NUM_VARS] = {0, 1, 2, 3, 4};

double FLUID_RK45_TIME_BEGIN                               = 0;

double FLUID_RK45_TIME_END                                 = 30;
...
double FLUID_COMPD_MIN[3]                = {FLUID_GRID_MIN_X, FLUID_GRID_MIN_Y,
                                            FLUID_GRID_MIN_Z};
double FLUID_COMPD_MAX[3]                = {FLUID_GRID_MAX_X, FLUID_GRID_MAX_Y,
                                            FLUID_GRID_MAX_Z};

double FLUID_OCTREE_MIN[3]               = {0.0, 0.0, 0.0};
double FLUID_OCTREE_MAX[3]               = {(double)(1u << FLUID_MAXDEPTH),
                                            (double)(1u << FLUID_MAXDEPTH),
                                            (double)(1u << FLUID_MAXDEPTH)};
