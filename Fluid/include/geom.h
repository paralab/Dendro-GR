...
// This file is a holdover from the lanl_rmhd project. I'm sure Dendro probably has
// a differential geometry library somewhere, and it would probably better to use
// that, but I just want to get the code working in its original flat-space form
// first and fix it later. - Jacob Fields, 11/15/2018
...
// metric_vars {{{
inline void metric_vars(double gu[3][3], double *detg, double gd[3][3], const double *pos){
