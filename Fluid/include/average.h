...
namespace average {
    // The weights are not a trivial calculation, so they are precomputed and stored separately.
    ...
    double avg2d(double *datain[], double *xi[], int shp[], double r, const double cth[],
