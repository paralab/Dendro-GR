...
namespace fluid
{
     ...
     * */
    void fluid_rhs(const ot::Mesh* pMesh,DendroScalar time, DendroScalar **uzipVarsRHS, const DendroScalar **uZipVars, const DendroScalar **uZipVarsPrim);
     ...
     * */
    void fluid_block_rhs(DendroScalar time, DendroScalar **uzipVarsRHS, const DendroScalar **uZipVars, const DendroScalar **uZipVarsPrim,
                         const unsigned int &offset,
                         const DendroScalar *ptmin, const DendroScalar *ptmax, const unsigned int *sz,
     ...
     * @param [in] bflag: boundary flag
     * */
    void fluid_block_bcs_prim(DendroScalar **uZipVarsPrim, const unsigned int &offset,
                              const DendroScalar *pmin, const DendroScalar *pmax,
                              const unsigned int *sz, const unsigned int &bflag);


    void fake_initial_data(DendroScalar x, DendroScalar y, DendroScalar z, DendroScalar *u);
