...
unsigned int FLUID_VTU_OUTPUT_EVOL_INDICES[FLUID_NUM_EVOL_VARS] = {0, 1, 2, 3,
                                                                   4};

unsigned int FLUID_VTU_OUTPUT_PRIM_INDICES[FLUID_NUM_PRIM_VARS] = {0, 1, 2, 3,
                                                                   4, 5, 6, 7};
...
unsigned int FLUID_REFINE_VARIABLE_INDICES[FLUID_NUM_PRIM_VARS] = {0, 4, 5, 6,
                                                                   7};
