...
*@brief Contains utility functions for EM4 simulation.
*/
//
...
namespace em4
{
    ...
    void readParamFile(const char * fName,MPI_Comm comm)
    {
        ...
        if(!rank)
        {
            ...
            if(parFile.find("EM4_ELE_ORDER")!=parFile.end())
                em4::EM4_ELE_ORDER = parFile["EM4_ELE_ORDER"];

            em4::EM4_IO_OUTPUT_FREQ=parFile["EM4_IO_OUTPUT_FREQ"];
            em4::EM4_REMESH_TEST_FREQ=parFile["EM4_REMESH_TEST_FREQ"];
            em4::EM4_CHECKPT_FREQ=parFile["EM4_CHECKPT_FREQ"];
            em4::EM4_IO_OUTPUT_GAP=parFile["EM4_IO_OUTPUT_GAP"];
            em4::EM4_VTU_FILE_PREFIX=parFile["EM4_VTU_FILE_PREFIX"].get<std::string>();
            em4::EM4_CHKPT_FILE_PREFIX=parFile["EM4_CHKPT_FILE_PREFIX"].get<std::string>();
            em4::EM4_PROFILE_FILE_PREFIX=parFile["EM4_PROFILE_FILE_PREFIX"].get<std::string>();
            em4::EM4_RESTORE_SOLVER=parFile["EM4_RESTORE_SOLVER"];
            em4::EM4_ENABLE_BLOCK_ADAPTIVITY=parFile["EM4_ENABLE_BLOCK_ADAPTIVITY"];
            em4::EM4_BLK_MIN_X=parFile["EM4_BLK_MIN_X"];
            em4::EM4_BLK_MIN_Y=parFile["EM4_BLK_MIN_Y"];
            em4::EM4_BLK_MIN_Z=parFile["EM4_BLK_MIN_Z"];
            em4::EM4_BLK_MAX_X=parFile["EM4_BLK_MAX_X"];
            em4::EM4_BLK_MAX_Y=parFile["EM4_BLK_MAX_Y"];
            em4::EM4_BLK_MAX_Z=parFile["EM4_BLK_MAX_Z"];
            em4::EM4_DENDRO_GRAIN_SZ=parFile["EM4_DENDRO_GRAIN_SZ"];
            em4::EM4_ASYNC_COMM_K=parFile["EM4_ASYNC_COMM_K"];
            em4::EM4_DENDRO_AMR_FAC=parFile["EM4_DENDRO_AMR_FAC"];
            em4::EM4_LOAD_IMB_TOL=parFile["EM4_LOAD_IMB_TOL"];
            em4::EM4_RK45_TIME_BEGIN=parFile["EM4_RK45_TIME_BEGIN"];
            em4::EM4_RK45_TIME_END=parFile["EM4_RK45_TIME_END"];
            em4::EM4_RK45_TIME_STEP_SIZE=parFile["EM4_RK45_TIME_STEP_SIZE"];
            em4::EM4_RK45_DESIRED_TOL=parFile["EM4_RK45_DESIRED_TOL"];
            em4::EM4_DIM=parFile["EM4_DIM"];
            em4::EM4_MAXDEPTH=parFile["EM4_MAXDEPTH"];
            em4::EM4_GRID_MIN_X=parFile["EM4_GRID_MIN_X"];
            em4::EM4_GRID_MAX_X=parFile["EM4_GRID_MAX_X"];
            em4::EM4_GRID_MIN_Y=parFile["EM4_GRID_MIN_Y"];
            em4::EM4_GRID_MAX_Y=parFile["EM4_GRID_MAX_Y"];
            em4::EM4_GRID_MIN_Z=parFile["EM4_GRID_MIN_Z"];
            em4::EM4_GRID_MAX_Z=parFile["EM4_GRID_MAX_Z"];
            em4::KO_DISS_SIGMA=parFile["KO_DISS_SIGMA"];
            if(parFile.find("DISSIPATION_TYPE") != parFile.end()) {
                em4::DISSIPATION_TYPE=parFile["DISSIPATION_TYPE"];
            };

            em4::EM4_ID_TYPE=parFile["EM4_ID_TYPE"];
            em4::EM4_ID_AMP1=parFile["EM4_ID_AMP1"];
            em4::EM4_ID_LAMBDA1=parFile["EM4_ID_LAMBDA1"];
            em4::EM4_ID_AMP2=parFile["EM4_ID_AMP2"];
            //em4::EM4_ID_DELTA1=parFile["EM4_ID_DELTA1"];
            //em4::EM4_ID_DELTA2=parFile["EM4_ID_DELTA2"];
            //em4::EM4_ID_XC1=parFile["EM4_ID_XC1"];
            //em4::EM4_ID_YC1=parFile["EM4_ID_YC1"];
            //em4::EM4_ID_ZC1=parFile["EM4_ID_ZC1"];
            //em4::EM4_ID_XC2=parFile["EM4_ID_XC2"];
            //em4::EM4_ID_YC2=parFile["EM4_ID_YC2"];
            //em4::EM4_ID_ZC2=parFile["EM4_ID_ZC2"];
            
            //em4::EM4_ID_EPSX1=parFile["EM4_ID_EPSX1"];
            //em4::EM4_ID_EPSY1=parFile["EM4_ID_EPSY1"];
            //em4::EM4_ID_EPSZ1=parFile["EM4_ID_EPSZ1"];
            
            //em4::EM4_ID_EPSX2=parFile["EM4_ID_EPSX2"];
            //em4::EM4_ID_EPSY2=parFile["EM4_ID_EPSY2"];
            //em4::EM4_ID_EPSZ2=parFile["EM4_ID_EPSZ2"];

            //em4::EM4_ID_R1=parFile["EM4_ID_R1"];
            //em4::EM4_ID_R2=parFile["EM4_ID_R2"];
            //em4::EM4_ID_NU1=parFile["EM4_ID_NU1"];
            //em4::EM4_ID_NU2=parFile["EM4_ID_NU2"];
            //em4::EM4_ID_OMEGA=parFile["EM4_ID_OMEGA"];

            em4::EM4_WAVELET_TOL=parFile["EM4_WAVELET_TOL"];
            em4::EM4_CFL_FACTOR=parFile["EM4_CFL_FACTOR"];


            if(parFile.find("EM4_CHI_REFINE_VAL")!=parFile.end())
                em4::EM4_CHI_REFINE_VAL = parFile["EM4_CHI_REFINE_VAL"];

            if(parFile.find("EM4_VTU_Z_SLICE_ONLY")!=parFile.end())
                em4::EM4_VTU_Z_SLICE_ONLY = parFile["EM4_VTU_Z_SLICE_ONLY"];

            if(parFile.find("EM4_CHI_COARSEN_VAL")!=parFile.end())
                em4::EM4_CHI_COARSEN_VAL = parFile["EM4_CHI_COARSEN_VAL"];

            if(parFile.find("EM4_REFINEMENT_MODE")!=parFile.end())
                em4::EM4_REFINEMENT_MODE = static_cast<em4::RefinementMode>(parFile["EM4_REFINEMENT_MODE"]);

            em4::EM4_NUM_REFINE_VARS=parFile["EM4_NUM_REFINE_VARS"];

            for(unsigned int i=0;i<em4::EM4_NUM_REFINE_VARS;i++)
                em4::EM4_REFINE_VARIABLE_INDICES[i]=parFile["EM4_REFINE_VARIABLE_INDICES"][i];

            em4::EM4_NUM_EVOL_VARS_VTU_OUTPUT=parFile["EM4_NUM_EVOL_VARS_VTU_OUTPUT"];
            em4::EM4_NUM_CONST_VARS_VTU_OUTPUT=parFile["EM4_NUM_CONST_VARS_VTU_OUTPUT"];

            for(unsigned int i=0;i<em4::EM4_NUM_EVOL_VARS_VTU_OUTPUT;i++)
                em4::EM4_VTU_OUTPUT_EVOL_INDICES[i]=parFile["EM4_VTU_OUTPUT_EVOL_INDICES"][i];

            for(unsigned int i=0;i<em4::EM4_NUM_CONST_VARS_VTU_OUTPUT;i++)
                em4::EM4_VTU_OUTPUT_CONST_INDICES[i]=parFile["EM4_VTU_OUTPUT_CONST_INDICES"][i];

            vtu_len=EM4_VTU_FILE_PREFIX.size();
            chp_len=EM4_CHKPT_FILE_PREFIX.size();
            prf_len=EM4_PROFILE_FILE_PREFIX.size();

        }

        par::Mpi_Bcast(&EM4_ELE_ORDER,1,0,comm);
        par::Mpi_Bcast(&EM4_IO_OUTPUT_FREQ,1,0,comm);
        par::Mpi_Bcast(&EM4_REMESH_TEST_FREQ,1,0,comm);
        par::Mpi_Bcast(&EM4_CHECKPT_FREQ,1,0,comm);
        par::Mpi_Bcast(&EM4_IO_OUTPUT_GAP,1,0,comm);

        par::Mpi_Bcast(&vtu_len,1,0,comm);
        par::Mpi_Bcast(&chp_len,1,0,comm);
        par::Mpi_Bcast(&prf_len,1,0,comm);

        par::Mpi_Bcast(&EM4_DENDRO_GRAIN_SZ,1,0,comm);
        par::Mpi_Bcast(&EM4_DENDRO_AMR_FAC,1,0,comm);
        par::Mpi_Bcast(&EM4_ASYNC_COMM_K,1,0,comm);

        par::Mpi_Bcast(&EM4_CFL_FACTOR,1,0,comm);

        par::Mpi_Bcast(&EM4_CHI_REFINE_VAL,1,0,comm);
        par::Mpi_Bcast(&EM4_CHI_COARSEN_VAL,1,0,comm);
        par::Mpi_Bcast((unsigned int*)&EM4_REFINEMENT_MODE,1,0,comm);
        
        par::Mpi_Bcast(&EM4_VTU_Z_SLICE_ONLY,1,0,comm);
        ...
        if(!rank)
        {
           for(unsigned int k=0;k<vtu_len;k++)
               vtu_name[k]=EM4_VTU_FILE_PREFIX[k];

            for(unsigned int k=0;k<chp_len;k++)
                chp_name[k]=EM4_CHKPT_FILE_PREFIX[k];

            for(unsigned int k=0;k<prf_len;k++)
                prf_name[k]=EM4_PROFILE_FILE_PREFIX[k];
        ...
        EM4_VTU_FILE_PREFIX=std::string(vtu_name);
        EM4_CHKPT_FILE_PREFIX=std::string(chp_name);
        EM4_PROFILE_FILE_PREFIX=std::string(prf_name);


        par::Mpi_Bcast(&EM4_RESTORE_SOLVER,1,0,comm);
        par::Mpi_Bcast(&EM4_ENABLE_BLOCK_ADAPTIVITY,1,0,comm);

        par::Mpi_Bcast(&EM4_WAVELET_TOL,1,0,comm);

        par::Mpi_Bcast(&EM4_LOAD_IMB_TOL,1,0,comm);
        par::Mpi_Bcast(&EM4_RK45_TIME_BEGIN,1,0,comm);
        par::Mpi_Bcast(&EM4_RK45_TIME_END,1,0,comm);
        par::Mpi_Bcast(&EM4_RK45_TIME_STEP_SIZE,1,0,comm);
        par::Mpi_Bcast(&EM4_RK45_DESIRED_TOL,1,0,comm);
        par::Mpi_Bcast(&EM4_DIM,1,0,comm);
        par::Mpi_Bcast(&EM4_MAXDEPTH,1,0,comm);

        par::Mpi_Bcast(&EM4_ID_TYPE,1,0,comm);
        par::Mpi_Bcast(&EM4_ID_AMP1,1,0,comm);
        par::Mpi_Bcast(&EM4_ID_LAMBDA1,1,0,comm);
        par::Mpi_Bcast(&EM4_ID_AMP2,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_DELTA1,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_DELTA2,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_XC1,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_YC1,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_ZC1,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_XC2,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_YC2,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_ZC2,1,0,comm);

        //par::Mpi_Bcast(&EM4_ID_EPSX1,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_EPSY1,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_EPSZ1,1,0,comm);

        //par::Mpi_Bcast(&EM4_ID_EPSX2,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_EPSY2,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_EPSZ2,1,0,comm);

        //par::Mpi_Bcast(&EM4_ID_R1,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_R2,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_NU1,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_NU2,1,0,comm);
        //par::Mpi_Bcast(&EM4_ID_OMEGA,1,0,comm);

        par::Mpi_Bcast(&EM4_GRID_MIN_X,1,0,comm);
        par::Mpi_Bcast(&EM4_GRID_MAX_X,1,0,comm);
        par::Mpi_Bcast(&EM4_GRID_MIN_Y,1,0,comm);
        par::Mpi_Bcast(&EM4_GRID_MAX_Y,1,0,comm);
        par::Mpi_Bcast(&EM4_GRID_MIN_Z,1,0,comm);
        par::Mpi_Bcast(&EM4_GRID_MAX_Z,1,0,comm);

        par::Mpi_Bcast(&EM4_BLK_MIN_X,1,0,comm);
        par::Mpi_Bcast(&EM4_BLK_MIN_Y,1,0,comm);
        par::Mpi_Bcast(&EM4_BLK_MIN_Z,1,0,comm);

        par::Mpi_Bcast(&EM4_BLK_MAX_X,1,0,comm);
        par::Mpi_Bcast(&EM4_BLK_MAX_Y,1,0,comm);
        par::Mpi_Bcast(&EM4_BLK_MAX_Z,1,0,comm);

        EM4_OCTREE_MAX[0]=(double )(1u<<em4::EM4_MAXDEPTH);
        EM4_OCTREE_MAX[1]=(double )(1u<<em4::EM4_MAXDEPTH);
        EM4_OCTREE_MAX[2]=(double )(1u<<em4::EM4_MAXDEPTH);

        EM4_COMPD_MIN[0]=EM4_GRID_MIN_X;
        EM4_COMPD_MIN[1]=EM4_GRID_MIN_Y;
        EM4_COMPD_MIN[2]=EM4_GRID_MIN_Z;
        EM4_PADDING_WIDTH = EM4_ELE_ORDER>>1u;

        EM4_COMPD_MAX[0]=EM4_GRID_MAX_X;
        EM4_COMPD_MAX[1]=EM4_GRID_MAX_Y;
        EM4_COMPD_MAX[2]=EM4_GRID_MAX_Z;


        par::Mpi_Bcast(&KO_DISS_SIGMA, 1, 0, comm);
        par::Mpi_Bcast(&DISSIPATION_TYPE, 1, 0, comm);

        par::Mpi_Bcast(&EM4_NUM_REFINE_VARS,1,0,comm);
        par::Mpi_Bcast(&EM4_NUM_EVOL_VARS_VTU_OUTPUT,1,0,comm);
        par::Mpi_Bcast(&EM4_NUM_CONST_VARS_VTU_OUTPUT,1,0,comm);


        if(EM4_NUM_REFINE_VARS>EM4_NUM_VARS){std::cout<<"Error[parameter file]: Number of refine variables should be less than number of EM4_NUM_VARS"<<std::endl; exit(0);}
        if(EM4_NUM_EVOL_VARS_VTU_OUTPUT>EM4_NUM_VARS){std::cout<<"Error[parameter file]: Number of evolution VTU variables should be less than number of EM4_NUM_VARS"<<std::endl; exit(0);}

        par::Mpi_Bcast(EM4_REFINE_VARIABLE_INDICES,EM4_NUM_VARS,0,comm);
        par::Mpi_Bcast(EM4_VTU_OUTPUT_EVOL_INDICES,EM4_NUM_VARS,0,comm);
        par::Mpi_Bcast(EM4_VTU_OUTPUT_CONST_INDICES,EM4_CONSTRAINT_NUM_VARS,0,comm);
    ...
    void dumpParamFile(std::ostream& sout, int root, MPI_Comm comm)
    {
        ...
        if(rank ==root)
        {
            ...
            sout<<YLW<<"\tEM4_ELE_ORDER :"<<em4::EM4_ELE_ORDER<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_PADDING_WIDTH :"<<em4::EM4_PADDING_WIDTH<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_DIM :"<<em4::EM4_DIM<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_IO_OUTPUT_FREQ :"<<em4::EM4_IO_OUTPUT_FREQ<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_REMESH_TEST_FREQ :"<<em4::EM4_REMESH_TEST_FREQ<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_CHECKPT_FREQ :"<<em4::EM4_CHECKPT_FREQ<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_RESTORE_SOLVER :"<<em4::EM4_RESTORE_SOLVER<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_ENABLE_BLOCK_ADAPTIVITY :"<<em4::EM4_ENABLE_BLOCK_ADAPTIVITY<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_VTU_FILE_PREFIX :"<<em4::EM4_VTU_FILE_PREFIX<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_CHKPT_FILE_PREFIX :"<<em4::EM4_CHKPT_FILE_PREFIX<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_PROFILE_FILE_PREFIX :"<<em4::EM4_PROFILE_FILE_PREFIX<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_VTU_Z_SLICE_ONLY :"<<em4::EM4_VTU_Z_SLICE_ONLY<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_IO_OUTPUT_GAP :"<<em4::EM4_IO_OUTPUT_GAP<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_DENDRO_GRAIN_SZ :"<<em4::EM4_DENDRO_GRAIN_SZ<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_ASYNC_COMM_K :"<<em4::EM4_ASYNC_COMM_K<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_DENDRO_AMR_FAC :"<<em4::EM4_DENDRO_AMR_FAC<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_CFL_FACTOR:"<<em4::EM4_CFL_FACTOR<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_WAVELET_TOL :"<<em4::EM4_WAVELET_TOL<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_LOAD_IMB_TOL :"<<em4::EM4_LOAD_IMB_TOL<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_RK45_TIME_BEGIN :"<<em4::EM4_RK45_TIME_BEGIN<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_RK45_TIME_END :"<<em4::EM4_RK45_TIME_END<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_RK45_TIME_STEP_SIZE :"<<em4::EM4_RK45_TIME_STEP_SIZE<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_RK45_DESIRED_TOL :"<<em4::EM4_RK45_DESIRED_TOL<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_COMPD_MIN : ( :"<<em4::EM4_COMPD_MIN[0]<<" ,"<<em4::EM4_COMPD_MIN[1]<<","<<em4::EM4_COMPD_MIN[2]<<" )"<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_COMPD_MAX : ( :"<<em4::EM4_COMPD_MAX[0]<<" ,"<<em4::EM4_COMPD_MAX[1]<<","<<em4::EM4_COMPD_MAX[2]<<" )"<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_BLK_MIN : ( :"<<em4::EM4_BLK_MIN_X<<" ,"<<em4::EM4_BLK_MIN_Y<<","<<em4::EM4_BLK_MIN_Z<<" )"<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_BLK_MAX : ( :"<<em4::EM4_BLK_MAX_X<<" ,"<<em4::EM4_BLK_MAX_Y<<","<<em4::EM4_BLK_MAX_Z<<" )"<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_OCTREE_MIN : ( :"<<em4::EM4_OCTREE_MIN[0]<<" ,"<<em4::EM4_OCTREE_MIN[1]<<","<<em4::EM4_OCTREE_MIN[2]<<" )"<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_OCTREE_MAX : ( :"<<em4::EM4_OCTREE_MAX[0]<<" ,"<<em4::EM4_OCTREE_MAX[1]<<","<<em4::EM4_OCTREE_MAX[2]<<" )"<<NRM<<std::endl;
            sout<<YLW<<"\tKO_DISS_SIGMA :"<<em4::KO_DISS_SIGMA<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_ID_TYPE:"<<em4::EM4_ID_TYPE<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_ID_AMP1:"<<em4::EM4_ID_AMP1<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_ID_LAMBDA1:"<<em4::EM4_ID_LAMBDA1<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_ID_AMP2:"<<em4::EM4_ID_AMP2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_DELTA1:"<<em4::EM4_ID_DELTA1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_DELTA2:"<<em4::EM4_ID_DELTA2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_XC1:"<<em4::EM4_ID_XC1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_YC1:"<<em4::EM4_ID_YC1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_ZC1:"<<em4::EM4_ID_ZC1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_XC2:"<<em4::EM4_ID_XC2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_YC2:"<<em4::EM4_ID_YC2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_ZC2:"<<em4::EM4_ID_ZC2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_EPSX1:"<<em4::EM4_ID_EPSX1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_EPSY1:"<<em4::EM4_ID_EPSY1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_EPSZ1:"<<em4::EM4_ID_EPSY1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_EPSX2:"<<em4::EM4_ID_EPSX2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_EPSY2:"<<em4::EM4_ID_EPSY2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_EPSZ2:"<<em4::EM4_ID_EPSY2<<NRM<<std::endl;            // sout<<YLW<<"\tEM4_ID_R1:"<<em4::EM4_ID_R1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_R2:"<<em4::EM4_ID_R2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_NU1:"<<em4::EM4_ID_NU1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_NU2:"<<em4::EM4_ID_NU2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM4_ID_OMEGA:"<<em4::EM4_ID_OMEGA<<NRM<<std::endl;




            //std::cout<<YLW<<"\tEM4_DIM :"<<em4::EM4_DIM<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_MAXDEPTH :"<<em4::EM4_MAXDEPTH<<NRM<<std::endl;

            sout<<YLW<<"\tEM4_NUM_REFINE_VARS :"<<em4::EM4_NUM_REFINE_VARS<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_REFINE_VARIABLE_INDICES :[";
            for(unsigned int i=0;i<em4::EM4_NUM_REFINE_VARS-1;i++)
                sout<<em4::EM4_REFINE_VARIABLE_INDICES[i]<<", ";
            sout<<em4::EM4_REFINE_VARIABLE_INDICES[em4::EM4_NUM_REFINE_VARS-1]<<"]"<<NRM<<std::endl;

            sout<<YLW<<"\tEM4_REFINEMENT_MODE :"<<em4::EM4_REFINEMENT_MODE<<NRM<<std::endl;

            sout<<YLW<<"\tEM4_NUM_EVOL_VARS_VTU_OUTPUT :"<<em4::EM4_NUM_EVOL_VARS_VTU_OUTPUT<<NRM<<std::endl;
            sout<<YLW<<"\tEM4_VTU_OUTPUT_EVOL_INDICES :[";
            for(unsigned int i=0;i<em4::EM4_NUM_EVOL_VARS_VTU_OUTPUT-1;i++)
                sout<<em4::EM4_VTU_OUTPUT_EVOL_INDICES[i]<<", ";
            sout<<em4::EM4_VTU_OUTPUT_EVOL_INDICES[em4::EM4_NUM_EVOL_VARS_VTU_OUTPUT-1]<<"]"<<NRM<<std::endl;
    ...
    namespace timer
    {
        ...
        void profileInfo(const char* filePrefix,const ot::Mesh* pMesh)
        {
            ...
            if(!activeRank)
            {
                ...
                outfile<<"partition tol : "<<em4::EM4_LOAD_IMB_TOL<<std::endl;
                outfile<<"wavelet tol : "<<em4::EM4_WAVELET_TOL<<std::endl;
                outfile<<"maxdepth : "<<em4::EM4_MAXDEPTH<<std::endl;
        ...
        void profileInfoIntermediate(const char* filePrefix,const ot::Mesh* pMesh,const unsigned int currentStep)
        {
...
#ifdef EM4_PROFILE_HUMAN_READABLE
            if(!activeRank)
            {
            ...
            if(!rank) outfile<<em4::EM4_LOAD_IMB_TOL<<"\t ";
            if(!rank) outfile<<em4::EM4_WAVELET_TOL<<"\t ";
            if(!rank) outfile<<em4::EM4_MAXDEPTH<<"\t ";
