...
// I think this is redundant ... 
      ...
      em4_bcs(E_rhs0, E0, grad_0_E0, grad_1_E0, grad_2_E0, pmin, pmax,
              2.0, 0.0, sz, bflag);
      em4_bcs(E_rhs1, E1, grad_0_E1, grad_1_E1, grad_2_E1, pmin, pmax,
              2.0, 0.0, sz, bflag);
      em4_bcs(E_rhs2, E2, grad_0_E2, grad_1_E2, grad_2_E2, pmin, pmax,
              2.0, 0.0, sz, bflag);
      
      em4_bcs(B_rhs0, B0, grad_0_B0, grad_1_B0, grad_2_B0, pmin, pmax,
              2.0, 0.0, sz, bflag);
      em4_bcs(B_rhs1, B1, grad_0_B1, grad_1_B1, grad_2_B1, pmin, pmax,
              2.0, 0.0, sz, bflag);
      em4_bcs(B_rhs2, B2, grad_0_B2, grad_1_B2, grad_2_B2, pmin, pmax,
              2.0, 0.0, sz, bflag);
 ...
 *
 *----------------------------------------------------------------------*/
void em4_bcs(double *f_rhs, const double *f,
