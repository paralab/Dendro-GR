...
int main (int argc, char** argv)
{
    ...
    if(rank==1|| npes==1)
    {
        ...
        std::cout<<YLW<<"\tEM4_ELE_ORDER :"<<em4::EM4_ELE_ORDER<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_PADDING_WIDTH :"<<em4::EM4_PADDING_WIDTH<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_DIM :"<<em4::EM4_DIM<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_IO_OUTPUT_FREQ :"<<em4::EM4_IO_OUTPUT_FREQ<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_REMESH_TEST_FREQ :"<<em4::EM4_REMESH_TEST_FREQ<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_CHECKPT_FREQ :"<<em4::EM4_CHECKPT_FREQ<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_RESTORE_SOLVER :"<<em4::EM4_RESTORE_SOLVER<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_ENABLE_BLOCK_ADAPTIVITY :"<<em4::EM4_ENABLE_BLOCK_ADAPTIVITY<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_VTU_FILE_PREFIX :"<<em4::EM4_VTU_FILE_PREFIX<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_CHKPT_FILE_PREFIX :"<<em4::EM4_CHKPT_FILE_PREFIX<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_PROFILE_FILE_PREFIX :"<<em4::EM4_PROFILE_FILE_PREFIX<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_VTU_Z_SLICE_ONLY :"<<em4::EM4_VTU_Z_SLICE_ONLY<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_IO_OUTPUT_GAP :"<<em4::EM4_IO_OUTPUT_GAP<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_DENDRO_GRAIN_SZ :"<<em4::EM4_DENDRO_GRAIN_SZ<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_ASYNC_COMM_K :"<<em4::EM4_ASYNC_COMM_K<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_DENDRO_AMR_FAC :"<<em4::EM4_DENDRO_AMR_FAC<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_CFL_FACTOR:"<<em4::EM4_CFL_FACTOR<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_WAVELET_TOL :"<<em4::EM4_WAVELET_TOL<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_LOAD_IMB_TOL :"<<em4::EM4_LOAD_IMB_TOL<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_RK45_TIME_BEGIN :"<<em4::EM4_RK45_TIME_BEGIN<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_RK45_TIME_END :"<<em4::EM4_RK45_TIME_END<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_RK45_TIME_STEP_SIZE :"<<em4::EM4_RK45_TIME_STEP_SIZE<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_RK45_DESIRED_TOL :"<<em4::EM4_RK45_DESIRED_TOL<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_COMPD_MIN : ( :"<<em4::EM4_COMPD_MIN[0]<<" ,"<<em4::EM4_COMPD_MIN[1]<<","<<em4::EM4_COMPD_MIN[2]<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_COMPD_MAX : ( :"<<em4::EM4_COMPD_MAX[0]<<" ,"<<em4::EM4_COMPD_MAX[1]<<","<<em4::EM4_COMPD_MAX[2]<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_BLK_MIN : ( :"<<em4::EM4_BLK_MIN_X<<" ,"<<em4::EM4_BLK_MIN_Y<<","<<em4::EM4_BLK_MIN_Z<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_BLK_MAX : ( :"<<em4::EM4_BLK_MAX_X<<" ,"<<em4::EM4_BLK_MAX_Y<<","<<em4::EM4_BLK_MAX_Z<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_OCTREE_MIN : ( :"<<em4::EM4_OCTREE_MIN[0]<<" ,"<<em4::EM4_OCTREE_MIN[1]<<","<<em4::EM4_OCTREE_MIN[2]<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_OCTREE_MAX : ( :"<<em4::EM4_OCTREE_MAX[0]<<" ,"<<em4::EM4_OCTREE_MAX[1]<<","<<em4::EM4_OCTREE_MAX[2]<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tKO_DISS_SIGMA :"<<em4::KO_DISS_SIGMA<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_ID_TYPE:"<<em4::EM4_ID_TYPE<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_ID_AMP1:"<<em4::EM4_ID_AMP1<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_ID_LAMBDA1:"<<em4::EM4_ID_LAMBDA1<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_ID_AMP2:"<<em4::EM4_ID_AMP2<<NRM<<std::endl;
        ...
        //std::cout<<YLW<<"\tEM4_DIM :"<<em4::EM4_DIM<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM4_MAXDEPTH :"<<em4::EM4_MAXDEPTH<<NRM<<std::endl;

        std::cout<<YLW<<"\tEM4_NUM_REFINE_VARS :"<<em4::EM4_NUM_REFINE_VARS<<NRM<<std::endl;
        ...
        std::cout<<em4::EM4_REFINE_VARIABLE_INDICES[em4::EM4_NUM_REFINE_VARS-1]<<"]"<<NRM<<std::endl;

        std::cout<<YLW<<"\tEM4_REFINEMENT_MODE :"<<em4::EM4_REFINEMENT_MODE<<NRM<<std::endl;

        std::cout<<YLW<<"\tEM4_NUM_EVOL_VARS_VTU_OUTPUT :"<<em4::EM4_NUM_EVOL_VARS_VTU_OUTPUT<<NRM<<std::endl;
        ...
        std::cout<<em4::EM4_VTU_OUTPUT_EVOL_INDICES[em4::EM4_NUM_EVOL_VARS_VTU_OUTPUT-1]<<"]"<<NRM<<std::endl;
    ...
    const unsigned int grainSz=em4::EM4_DENDRO_GRAIN_SZ;//DENDRO_DEFAULT_GRAIN_SZ;
    ...
    shrinkOrExpandOctree(tmpNodes,em4::EM4_LOAD_IMB_TOL,DENDRO_DEFAULT_SF_K,isActive,commActive,comm);
    ...
    if(isActive)
    {
        ...
        SFC::parSort::SFC_treeSort(tmpNodes,tmpVec,tmpVec,tmpVec,em4::EM4_LOAD_IMB_TOL,m_uiMaxDepth,root,ROOT_ROTATION,1,TS_REMOVE_DUPLICATES,em4::EM4_SPLIT_FIX,commActive);
        std::swap(tmpNodes,tmpVec);
        tmpVec.clear();

        SFC::parSort::SFC_treeSort(tmpNodes,tmpVec,tmpVec,tmpVec,em4::EM4_LOAD_IMB_TOL,m_uiMaxDepth,root,ROOT_ROTATION,1,TS_CONSTRUCT_OCTREE,em4::EM4_SPLIT_FIX,commActive);
        std::swap(tmpNodes,tmpVec);
        tmpVec.clear();
        ...
        SFC::parSort::SFC_treeSort(tmpNodes,balOct,balOct,balOct,em4::EM4_LOAD_IMB_TOL,m_uiMaxDepth,root,ROOT_ROTATION,1,TS_BALANCE_OCTREE,em4::EM4_SPLIT_FIX,commActive);
        tmpNodes.clear();
    ...
    ot::Mesh * mesh=new ot::Mesh(balOct,1,em4::EM4_ELE_ORDER,comm,true,ot::SM_TYPE::FDM,em4::EM4_DENDRO_GRAIN_SZ,em4::EM4_LOAD_IMB_TOL,em4::EM4_SPLIT_FIX);
    ...
    ode::solver::RK4_EM4 rk_em4(mesh,em4::EM4_RK45_TIME_BEGIN,em4::EM4_RK45_TIME_END,em4::EM4_RK45_TIME_STEP_SIZE);
    //ode::solver::RK3_EM4 rk_em4(mesh,em4::EM4_RK45_TIME_BEGIN,em4::EM4_RK45_TIME_END,em4::EM4_RK45_TIME_STEP_SIZE);
