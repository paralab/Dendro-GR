...
namespace em4 {
mem::memory_pool<DendroScalar> EM4_MEM_POOL =
...
double EM4_OCTREE_MAX[3] = {(double)(1u << EM4_MAXDEPTH),
                            (double)(1u << EM4_MAXDEPTH),
                            (double)(1u << EM4_MAXDEPTH)};

//@note assumes the computational domain is a cube as well.
double EM4_RK45_TIME_STEP_SIZE = EM4_CFL_FACTOR *
                                 (EM4_COMPD_MAX[0] - EM4_COMPD_MIN[0]) *
                                 (1.0 / (double)(1u << EM4_MAXDEPTH));
