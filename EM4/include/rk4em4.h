...
*@brief rk4 solver for em4 equations.
*/
//

#ifndef SFCSORTBENCH_RK4EM4_H
#define SFCSORTBENCH_RK4EM4_H
...
namespace ode
{
    namespace solver
    {
        ...
        class RK4_EM4 : public RK
        {

        private:

            // variables for EM4 formulation.
        ...
        public:
             ...
             * * */
            RK4_EM4(ot::Mesh *pMesh, double pTBegin, double pTEnd,double pTh);

            /**@brief default destructor*/
            ~RK4_EM4();

            /** @brief: read parameters related to EM4 simulation and store them in static variables defined in parameters.h*/
