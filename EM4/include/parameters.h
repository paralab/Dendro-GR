...
namespace em4
{
    ...
    enum VAR {U_E0=0,U_E1=1,U_E2=2,U_B0=3,U_B1=4,U_B2=5,U_PHI=6,U_PSI=7}; 

    enum VAR_CONSTRAINT {C_DIVE=0,C_DIVB=1};

    /**@brief variable names. */
    static const char * EM4_VAR_NAMES[]={"U_E0","U_E1","U_E2","U_B0","U_B1","U_B2","U_PHI","U_PSI"};
    ...
    static const unsigned int EM4_NUM_VARS_INTENL=(EM4_RK45_STAGES+1)*EM4_NUM_VARS;
    ...
    /**@brief solution output gap (instead of freq. we can use to output the solution if currentTime > lastIOOutputTime + EM4_IO_OUTPUT_GAP)*/
    ...
    /**@brief AMR coarsening factor (we coarsen if tol<EM4_DENDRO_AMR_FAC*EM4_WAVELET_TOL)*/
