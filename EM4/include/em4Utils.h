...
#define GRIDX_TO_X(xg) (((Rx/RgX)*(xg-em4::EM4_OCTREE_MIN[0]))+em4::EM4_COMPD_MIN[0])
#define GRIDY_TO_Y(yg) (((Ry/RgY)*(yg-em4::EM4_OCTREE_MIN[1]))+em4::EM4_COMPD_MIN[1])
#define GRIDZ_TO_Z(zg) (((Rz/RgZ)*(zg-em4::EM4_OCTREE_MIN[2]))+em4::EM4_COMPD_MIN[2])

#define X_TO_GRIDX(xc) (((RgX/Rx)*(xc-em4::EM4_COMPD_MIN[0]))+em4::EM4_OCTREE_MIN[0])
#define Y_TO_GRIDY(yc) (((RgY/Ry)*(yc-em4::EM4_COMPD_MIN[1]))+em4::EM4_OCTREE_MIN[1])
#define Z_TO_GRIDZ(zc) (((RgZ/Rz)*(zc-em4::EM4_COMPD_MIN[2]))+em4::EM4_OCTREE_MIN[2])
 ...
 * */
  ...
  * */
   ...
   * @param root rank to dump the parameter file. Normally use rank!=0 to see if the mpi broadcast worked correctly. 
 ...
 **/
 ...
 double computeWTol(double x,double y,double z,double * hx);
   ...
   */
    ...
    * @param[in/out] zipVars: em4 variables to which dissipation needs to be appied.   
