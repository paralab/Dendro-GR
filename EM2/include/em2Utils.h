...
#define GRIDX_TO_X(xg) (((Rx/RgX)*(xg-em2::EM2_OCTREE_MIN[0]))+em2::EM2_COMPD_MIN[0])
#define GRIDY_TO_Y(yg) (((Ry/RgY)*(yg-em2::EM2_OCTREE_MIN[1]))+em2::EM2_COMPD_MIN[1])
#define GRIDZ_TO_Z(zg) (((Rz/RgZ)*(zg-em2::EM2_OCTREE_MIN[2]))+em2::EM2_COMPD_MIN[2])

#define X_TO_GRIDX(xc) (((RgX/Rx)*(xc-em2::EM2_COMPD_MIN[0]))+em2::EM2_OCTREE_MIN[0])
#define Y_TO_GRIDY(yc) (((RgY/Ry)*(yc-em2::EM2_COMPD_MIN[1]))+em2::EM2_OCTREE_MIN[1])
#define Z_TO_GRIDZ(zc) (((RgZ/Rz)*(zc-em2::EM2_COMPD_MIN[2]))+em2::EM2_OCTREE_MIN[2])
 ...
 * */
 ...
 double computeWTol(double x,double y,double z,double* hx);
   ...
   */
    ...
    * @param[in/out] zipVars: em2 variables to which dissipation needs to be appied.   
