...
#define Rx (em2::EM2_COMPD_MAX[0] - em2::EM2_COMPD_MIN[0])
#define Ry (em2::EM2_COMPD_MAX[1] - em2::EM2_COMPD_MIN[1])
#define Rz (em2::EM2_COMPD_MAX[2] - em2::EM2_COMPD_MIN[2])

#define RgX (em2::EM2_OCTREE_MAX[0] - em2::EM2_OCTREE_MIN[0])
#define RgY (em2::EM2_OCTREE_MAX[1] - em2::EM2_OCTREE_MIN[1])
#define RgZ (em2::EM2_OCTREE_MAX[2] - em2::EM2_OCTREE_MIN[2])

#define GRIDX_TO_X(xg) \
    (((Rx / RgX) * (xg - em2::EM2_OCTREE_MIN[0])) + em2::EM2_COMPD_MIN[0])
#define GRIDY_TO_Y(yg) \
    (((Ry / RgY) * (yg - em2::EM2_OCTREE_MIN[1])) + em2::EM2_COMPD_MIN[1])
#define GRIDZ_TO_Z(zg) \
    (((Rz / RgZ) * (zg - em2::EM2_OCTREE_MIN[2])) + em2::EM2_COMPD_MIN[2])

#define X_TO_GRIDX(xc) \
    (((RgX / Rx) * (xc - em2::EM2_COMPD_MIN[0])) + em2::EM2_OCTREE_MIN[0])
#define Y_TO_GRIDY(yc) \
    (((RgY / Ry) * (yc - em2::EM2_COMPD_MIN[1])) + em2::EM2_OCTREE_MIN[1])
#define Z_TO_GRIDZ(zc) \
    (((RgZ / Rz) * (zc - em2::EM2_COMPD_MIN[2])) + em2::EM2_OCTREE_MIN[2])
...
/**
 * @brief dump the read parameters
 *
 * @param sout
 * @param root
 * @param comm
 ...
 *be (VAR::U_SYMAT5+1)
 * @note This function is taken from the old single core em2 version.
 **/
 ...
 * @param[in/out] zipVars: em2 variables to which dissipation needs to be
 * appied.
