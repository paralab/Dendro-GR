...
namespace em2
{
    ...
    enum VAR {U_E0=0,U_E1=1,U_E2=2,U_A0=3,U_A1=4,U_A2=5,U_PSI=6,U_GAMMA=7};

    enum VAR_CONSTRAINT {C_DIVE=0,C_DIVA=1};

    /**@brief variable names. */
    static const char * EM2_VAR_NAMES[]={"U_E0","U_E1","U_E2","U_A0","U_A1","U_A2","U_PSI","U_GAMMA"};
    ...
    static const unsigned int EM2_NUM_VARS_INTENL=(EM2_RK45_STAGES+1)*EM2_NUM_VARS;
    ...
    /**@brief solution output gap (instead of freq. we can use to output the solution if currentTime > lastIOOutputTime + EM2_IO_OUTPUT_GAP)*/
    ...
    /**@brief AMR coarsening factor (we coarsen if tol<EM2_DENDRO_AMR_FAC*EM2_WAVELET_TOL)*/
