...
namespace em2
{
    class EM2Ctx : public ts::Ctx<EM2Ctx,DendroScalar, DendroIntL>
    {
        ...
        public :
            ...
            */
            ...
            unsigned int get_async_batch_sz() {return EM2_ASYNC_COMM_K;}

            /**@brief: returns the number of variables considered when performing refinement*/
            unsigned int get_num_refine_vars() {return EM2_NUM_REFINE_VARS;}

            /**@brief: return the pointer for containing evolution refinement variable ids*/
            const unsigned int* get_refine_var_ids() { return EM2_REFINE_VARIABLE_INDICES;}
            ...
            std::function<double(double, double, double,double*)> get_wtol_function(){
                ...
                std::function<double(double,double,double,double*)> waveletTolFunc =[wtol](double x,double y, double z,double* hx){ return em2::computeWTol(x,y,z,hx);};
