...
mem::memory_pool<DendroScalar> EM2_MEM_POOL =
    mem::memory_pool<DendroScalar>(0, 16);
...
double EM2_OCTREE_MAX[3] = {(double)(1u << EM2_MAXDEPTH),
                            (double)(1u << EM2_MAXDEPTH),
                            (double)(1u << EM2_MAXDEPTH)};

//@note assumes the computational domain is a cube as well.
double EM2_RK45_TIME_STEP_SIZE = EM2_CFL_FACTOR *
                                 (EM2_COMPD_MAX[0] - EM2_COMPD_MIN[0]) *
                                 (1.0 / (double)(1u << EM2_MAXDEPTH));
...
unsigned int EM2_REFINE_VARIABLE_INDICES[EM2_NUM_VARS] = {0, 1, 2, 3,
                                                          4, 5, 6, 7};

unsigned int EM2_NUM_EVOL_VARS_VTU_OUTPUT              = 8;
unsigned int EM2_NUM_CONST_VARS_VTU_OUTPUT             = 8;
unsigned int EM2_VTU_OUTPUT_EVOL_INDICES[EM2_NUM_VARS] = {0, 1, 2, 3,
                                                          4, 5, 6, 7};
