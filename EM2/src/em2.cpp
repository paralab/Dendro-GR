...
int main (int argc, char** argv)
{
    ...
    if(rank==1|| npes==1)
    {
        ...
        std::cout<<YLW<<"\tEM2_ELE_ORDER :"<<em2::EM2_ELE_ORDER<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_PADDING_WIDTH :"<<em2::EM2_PADDING_WIDTH<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_DIM :"<<em2::EM2_DIM<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_IO_OUTPUT_FREQ :"<<em2::EM2_IO_OUTPUT_FREQ<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_REMESH_TEST_FREQ :"<<em2::EM2_REMESH_TEST_FREQ<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_CHECKPT_FREQ :"<<em2::EM2_CHECKPT_FREQ<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_RESTORE_SOLVER :"<<em2::EM2_RESTORE_SOLVER<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_ENABLE_BLOCK_ADAPTIVITY :"<<em2::EM2_ENABLE_BLOCK_ADAPTIVITY<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_VTU_FILE_PREFIX :"<<em2::EM2_VTU_FILE_PREFIX<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_CHKPT_FILE_PREFIX :"<<em2::EM2_CHKPT_FILE_PREFIX<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_PROFILE_FILE_PREFIX :"<<em2::EM2_PROFILE_FILE_PREFIX<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_VTU_Z_SLICE_ONLY :"<<em2::EM2_VTU_Z_SLICE_ONLY<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_IO_OUTPUT_GAP :"<<em2::EM2_IO_OUTPUT_GAP<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_DENDRO_GRAIN_SZ :"<<em2::EM2_DENDRO_GRAIN_SZ<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_ASYNC_COMM_K :"<<em2::EM2_ASYNC_COMM_K<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_DENDRO_AMR_FAC :"<<em2::EM2_DENDRO_AMR_FAC<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_CFL_FACTOR:"<<em2::EM2_CFL_FACTOR<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_WAVELET_TOL :"<<em2::EM2_WAVELET_TOL<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_LOAD_IMB_TOL :"<<em2::EM2_LOAD_IMB_TOL<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_RK45_TIME_BEGIN :"<<em2::EM2_RK45_TIME_BEGIN<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_RK45_TIME_END :"<<em2::EM2_RK45_TIME_END<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_RK45_TIME_STEP_SIZE :"<<em2::EM2_RK45_TIME_STEP_SIZE<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_RK45_DESIRED_TOL :"<<em2::EM2_RK45_DESIRED_TOL<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_COMPD_MIN : ( :"<<em2::EM2_COMPD_MIN[0]<<" ,"<<em2::EM2_COMPD_MIN[1]<<","<<em2::EM2_COMPD_MIN[2]<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_COMPD_MAX : ( :"<<em2::EM2_COMPD_MAX[0]<<" ,"<<em2::EM2_COMPD_MAX[1]<<","<<em2::EM2_COMPD_MAX[2]<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_BLK_MIN : ( :"<<em2::EM2_BLK_MIN_X<<" ,"<<em2::EM2_BLK_MIN_Y<<","<<em2::EM2_BLK_MIN_Z<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_BLK_MAX : ( :"<<em2::EM2_BLK_MAX_X<<" ,"<<em2::EM2_BLK_MAX_Y<<","<<em2::EM2_BLK_MAX_Z<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_OCTREE_MIN : ( :"<<em2::EM2_OCTREE_MIN[0]<<" ,"<<em2::EM2_OCTREE_MIN[1]<<","<<em2::EM2_OCTREE_MIN[2]<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_OCTREE_MAX : ( :"<<em2::EM2_OCTREE_MAX[0]<<" ,"<<em2::EM2_OCTREE_MAX[1]<<","<<em2::EM2_OCTREE_MAX[2]<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tKO_DISS_SIGMA :"<<em2::KO_DISS_SIGMA<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_ID_TYPE:"<<em2::EM2_ID_TYPE<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_ID_AMP1:"<<em2::EM2_ID_AMP1<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_ID_LAMBDA1:"<<em2::EM2_ID_LAMBDA1<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_ID_AMP2:"<<em2::EM2_ID_AMP2<<NRM<<std::endl;
        ...
        //std::cout<<YLW<<"\tEM2_DIM :"<<em2::EM2_DIM<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM2_MAXDEPTH :"<<em2::EM2_MAXDEPTH<<NRM<<std::endl;

        std::cout<<YLW<<"\tEM2_NUM_REFINE_VARS :"<<em2::EM2_NUM_REFINE_VARS<<NRM<<std::endl;
        ...
        std::cout<<em2::EM2_REFINE_VARIABLE_INDICES[em2::EM2_NUM_REFINE_VARS-1]<<"]"<<NRM<<std::endl;

        std::cout<<YLW<<"\tEM2_REFINEMENT_MODE :"<<em2::EM2_REFINEMENT_MODE<<NRM<<std::endl;

        std::cout<<YLW<<"\tEM2_NUM_EVOL_VARS_VTU_OUTPUT :"<<em2::EM2_NUM_EVOL_VARS_VTU_OUTPUT<<NRM<<std::endl;
        ...
        std::cout<<em2::EM2_VTU_OUTPUT_EVOL_INDICES[em2::EM2_NUM_EVOL_VARS_VTU_OUTPUT-1]<<"]"<<NRM<<std::endl;
    ...
    const unsigned int grainSz=em2::EM2_DENDRO_GRAIN_SZ;//DENDRO_DEFAULT_GRAIN_SZ;
    ...
    shrinkOrExpandOctree(tmpNodes,em2::EM2_LOAD_IMB_TOL,DENDRO_DEFAULT_SF_K,isActive,commActive,comm);
    ...
    if(isActive)
    {
        ...
        SFC::parSort::SFC_treeSort(tmpNodes,tmpVec,tmpVec,tmpVec,em2::EM2_LOAD_IMB_TOL,m_uiMaxDepth,root,ROOT_ROTATION,1,TS_REMOVE_DUPLICATES,em2::EM2_SPLIT_FIX,commActive);
        std::swap(tmpNodes,tmpVec);
        tmpVec.clear();

        SFC::parSort::SFC_treeSort(tmpNodes,tmpVec,tmpVec,tmpVec,em2::EM2_LOAD_IMB_TOL,m_uiMaxDepth,root,ROOT_ROTATION,1,TS_CONSTRUCT_OCTREE,em2::EM2_SPLIT_FIX,commActive);
        std::swap(tmpNodes,tmpVec);
        tmpVec.clear();
        ...
        SFC::parSort::SFC_treeSort(tmpNodes,balOct,balOct,balOct,em2::EM2_LOAD_IMB_TOL,m_uiMaxDepth,root,ROOT_ROTATION,1,TS_BALANCE_OCTREE,em2::EM2_SPLIT_FIX,commActive);
        tmpNodes.clear();
    ...
    ot::Mesh * mesh=new ot::Mesh(balOct,1,em2::EM2_ELE_ORDER,comm,true,ot::SM_TYPE::FDM,em2::EM2_DENDRO_GRAIN_SZ,em2::EM2_LOAD_IMB_TOL,em2::EM2_SPLIT_FIX);
    ...
    ode::solver::RK4_EM2 rk_em2(mesh,em2::EM2_RK45_TIME_BEGIN,em2::EM2_RK45_TIME_END,em2::EM2_RK45_TIME_STEP_SIZE);
    //ode::solver::RK3_EM2 rk_em2(mesh,em2::EM2_RK45_TIME_BEGIN,em2::EM2_RK45_TIME_END,em2::EM2_RK45_TIME_STEP_SIZE);
