...
*@brief Contains utility functions for EM2 simulation.
*/
//
...
namespace em2
{
    ...
    void readParamFile(const char * fName,MPI_Comm comm)
    {
        ...
        if(!rank)
        {
            ...
            if(parFile.find("EM2_ELE_ORDER")!=parFile.end())
                em2::EM2_ELE_ORDER = parFile["EM2_ELE_ORDER"];

            em2::EM2_IO_OUTPUT_FREQ=parFile["EM2_IO_OUTPUT_FREQ"];
            em2::EM2_REMESH_TEST_FREQ=parFile["EM2_REMESH_TEST_FREQ"];
            em2::EM2_CHECKPT_FREQ=parFile["EM2_CHECKPT_FREQ"];
            em2::EM2_IO_OUTPUT_GAP=parFile["EM2_IO_OUTPUT_GAP"];
            em2::EM2_VTU_FILE_PREFIX=parFile["EM2_VTU_FILE_PREFIX"].get<std::string>();
            em2::EM2_CHKPT_FILE_PREFIX=parFile["EM2_CHKPT_FILE_PREFIX"].get<std::string>();
            em2::EM2_PROFILE_FILE_PREFIX=parFile["EM2_PROFILE_FILE_PREFIX"].get<std::string>();
            em2::EM2_RESTORE_SOLVER=parFile["EM2_RESTORE_SOLVER"];
            em2::EM2_ENABLE_BLOCK_ADAPTIVITY=parFile["EM2_ENABLE_BLOCK_ADAPTIVITY"];
            em2::EM2_BLK_MIN_X=parFile["EM2_BLK_MIN_X"];
            em2::EM2_BLK_MIN_Y=parFile["EM2_BLK_MIN_Y"];
            em2::EM2_BLK_MIN_Z=parFile["EM2_BLK_MIN_Z"];
            em2::EM2_BLK_MAX_X=parFile["EM2_BLK_MAX_X"];
            em2::EM2_BLK_MAX_Y=parFile["EM2_BLK_MAX_Y"];
            em2::EM2_BLK_MAX_Z=parFile["EM2_BLK_MAX_Z"];
            em2::EM2_DENDRO_GRAIN_SZ=parFile["EM2_DENDRO_GRAIN_SZ"];
            em2::EM2_ASYNC_COMM_K=parFile["EM2_ASYNC_COMM_K"];
            em2::EM2_DENDRO_AMR_FAC=parFile["EM2_DENDRO_AMR_FAC"];
            em2::EM2_LOAD_IMB_TOL=parFile["EM2_LOAD_IMB_TOL"];
            em2::EM2_RK45_TIME_BEGIN=parFile["EM2_RK45_TIME_BEGIN"];
            em2::EM2_RK45_TIME_END=parFile["EM2_RK45_TIME_END"];
            em2::EM2_RK45_TIME_STEP_SIZE=parFile["EM2_RK45_TIME_STEP_SIZE"];
            em2::EM2_RK45_DESIRED_TOL=parFile["EM2_RK45_DESIRED_TOL"];
            em2::EM2_DIM=parFile["EM2_DIM"];
            em2::EM2_MAXDEPTH=parFile["EM2_MAXDEPTH"];
            em2::EM2_GRID_MIN_X=parFile["EM2_GRID_MIN_X"];
            em2::EM2_GRID_MAX_X=parFile["EM2_GRID_MAX_X"];
            em2::EM2_GRID_MIN_Y=parFile["EM2_GRID_MIN_Y"];
            em2::EM2_GRID_MAX_Y=parFile["EM2_GRID_MAX_Y"];
            em2::EM2_GRID_MIN_Z=parFile["EM2_GRID_MIN_Z"];
            em2::EM2_GRID_MAX_Z=parFile["EM2_GRID_MAX_Z"];
            em2::KO_DISS_SIGMA=parFile["KO_DISS_SIGMA"];
            if(parFile.find("DISSIPATION_TYPE") != parFile.end()) {
                em2::DISSIPATION_TYPE=parFile["DISSIPATION_TYPE"];
            };

            em2::EM2_ID_TYPE=parFile["EM2_ID_TYPE"];
            em2::EM2_ID_AMP1=parFile["EM2_ID_AMP1"];
            em2::EM2_ID_LAMBDA1=parFile["EM2_ID_LAMBDA1"];
            em2::EM2_ID_AMP2=parFile["EM2_ID_AMP2"];
            //em2::EM2_ID_DELTA1=parFile["EM2_ID_DELTA1"];
            //em2::EM2_ID_DELTA2=parFile["EM2_ID_DELTA2"];
            //em2::EM2_ID_XC1=parFile["EM2_ID_XC1"];
            //em2::EM2_ID_YC1=parFile["EM2_ID_YC1"];
            //em2::EM2_ID_ZC1=parFile["EM2_ID_ZC1"];
            //em2::EM2_ID_XC2=parFile["EM2_ID_XC2"];
            //em2::EM2_ID_YC2=parFile["EM2_ID_YC2"];
            //em2::EM2_ID_ZC2=parFile["EM2_ID_ZC2"];
            
            //em2::EM2_ID_EPSX1=parFile["EM2_ID_EPSX1"];
            //em2::EM2_ID_EPSY1=parFile["EM2_ID_EPSY1"];
            //em2::EM2_ID_EPSZ1=parFile["EM2_ID_EPSZ1"];
            
            //em2::EM2_ID_EPSX2=parFile["EM2_ID_EPSX2"];
            //em2::EM2_ID_EPSY2=parFile["EM2_ID_EPSY2"];
            //em2::EM2_ID_EPSZ2=parFile["EM2_ID_EPSZ2"];

            //em2::EM2_ID_R1=parFile["EM2_ID_R1"];
            //em2::EM2_ID_R2=parFile["EM2_ID_R2"];
            //em2::EM2_ID_NU1=parFile["EM2_ID_NU1"];
            //em2::EM2_ID_NU2=parFile["EM2_ID_NU2"];
            //em2::EM2_ID_OMEGA=parFile["EM2_ID_OMEGA"];

            em2::EM2_WAVELET_TOL=parFile["EM2_WAVELET_TOL"];
            em2::EM2_CFL_FACTOR=parFile["EM2_CFL_FACTOR"];

            //if(parFile.find("EM2_WAVE_SPEED_X")!=parFile.end())
                //em2::EM2_WAVE_SPEED_X = parFile["EM2_WAVE_SPEED_X"];
            
            //if(parFile.find("EM2_WAVE_SPEED_Y")!=parFile.end())
                //em2::EM2_WAVE_SPEED_Y = parFile["EM2_WAVE_SPEED_Y"];

            //if(parFile.find("EM2_WAVE_SPEED_Z")!=parFile.end())
                //em2::EM2_WAVE_SPEED_Z = parFile["EM2_WAVE_SPEED_Z"];

            if(parFile.find("EM2_CHI_REFINE_VAL")!=parFile.end())
                em2::EM2_CHI_REFINE_VAL = parFile["EM2_CHI_REFINE_VAL"];

            if(parFile.find("EM2_VTU_Z_SLICE_ONLY")!=parFile.end())
                em2::EM2_VTU_Z_SLICE_ONLY = parFile["EM2_VTU_Z_SLICE_ONLY"];

            if(parFile.find("EM2_CHI_COARSEN_VAL")!=parFile.end())
                em2::EM2_CHI_COARSEN_VAL = parFile["EM2_CHI_COARSEN_VAL"];

            if(parFile.find("EM2_REFINEMENT_MODE")!=parFile.end())
                em2::EM2_REFINEMENT_MODE = static_cast<em2::RefinementMode>(parFile["EM2_REFINEMENT_MODE"]);

            em2::EM2_NUM_REFINE_VARS=parFile["EM2_NUM_REFINE_VARS"];

            for(unsigned int i=0;i<em2::EM2_NUM_REFINE_VARS;i++)
                em2::EM2_REFINE_VARIABLE_INDICES[i]=parFile["EM2_REFINE_VARIABLE_INDICES"][i];

            em2::EM2_NUM_EVOL_VARS_VTU_OUTPUT=parFile["EM2_NUM_EVOL_VARS_VTU_OUTPUT"];
            em2::EM2_NUM_CONST_VARS_VTU_OUTPUT=parFile["EM2_NUM_CONST_VARS_VTU_OUTPUT"];

            for(unsigned int i=0;i<em2::EM2_NUM_EVOL_VARS_VTU_OUTPUT;i++)
                em2::EM2_VTU_OUTPUT_EVOL_INDICES[i]=parFile["EM2_VTU_OUTPUT_EVOL_INDICES"][i];
            
            for(unsigned int i=0;i<em2::EM2_NUM_CONST_VARS_VTU_OUTPUT;i++)
                em2::EM2_VTU_OUTPUT_CONST_INDICES[i]=parFile["EM2_VTU_OUTPUT_CONST_INDICES"][i];

            vtu_len=EM2_VTU_FILE_PREFIX.size();
            chp_len=EM2_CHKPT_FILE_PREFIX.size();
            prf_len=EM2_PROFILE_FILE_PREFIX.size();

        }

        par::Mpi_Bcast(&EM2_ELE_ORDER,1,0,comm);
        par::Mpi_Bcast(&EM2_IO_OUTPUT_FREQ,1,0,comm);
        par::Mpi_Bcast(&EM2_REMESH_TEST_FREQ,1,0,comm);
        par::Mpi_Bcast(&EM2_CHECKPT_FREQ,1,0,comm);
        par::Mpi_Bcast(&EM2_IO_OUTPUT_GAP,1,0,comm);

        par::Mpi_Bcast(&vtu_len,1,0,comm);
        par::Mpi_Bcast(&chp_len,1,0,comm);
        par::Mpi_Bcast(&prf_len,1,0,comm);

        par::Mpi_Bcast(&EM2_DENDRO_GRAIN_SZ,1,0,comm);
        par::Mpi_Bcast(&EM2_DENDRO_AMR_FAC,1,0,comm);
        par::Mpi_Bcast(&EM2_ASYNC_COMM_K,1,0,comm);

        par::Mpi_Bcast(&EM2_CFL_FACTOR,1,0,comm);

        //par::Mpi_Bcast(&EM2_WAVE_SPEED_X,1,0,comm);
        //par::Mpi_Bcast(&EM2_WAVE_SPEED_Y,1,0,comm);
        //par::Mpi_Bcast(&EM2_WAVE_SPEED_Z,1,0,comm);

        par::Mpi_Bcast(&EM2_CHI_REFINE_VAL,1,0,comm);
        par::Mpi_Bcast(&EM2_CHI_COARSEN_VAL,1,0,comm);
        par::Mpi_Bcast((unsigned int*)&EM2_REFINEMENT_MODE,1,0,comm);
        
        par::Mpi_Bcast(&EM2_VTU_Z_SLICE_ONLY,1,0,comm);
        ...
        if(!rank)
        {
           for(unsigned int k=0;k<vtu_len;k++)
               vtu_name[k]=EM2_VTU_FILE_PREFIX[k];

            for(unsigned int k=0;k<chp_len;k++)
                chp_name[k]=EM2_CHKPT_FILE_PREFIX[k];

            for(unsigned int k=0;k<prf_len;k++)
                prf_name[k]=EM2_PROFILE_FILE_PREFIX[k];
        ...
        EM2_VTU_FILE_PREFIX=std::string(vtu_name);
        EM2_CHKPT_FILE_PREFIX=std::string(chp_name);
        EM2_PROFILE_FILE_PREFIX=std::string(prf_name);


        par::Mpi_Bcast(&EM2_RESTORE_SOLVER,1,0,comm);
        par::Mpi_Bcast(&EM2_ENABLE_BLOCK_ADAPTIVITY,1,0,comm);

        par::Mpi_Bcast(&EM2_WAVELET_TOL,1,0,comm);

        par::Mpi_Bcast(&EM2_LOAD_IMB_TOL,1,0,comm);
        par::Mpi_Bcast(&EM2_RK45_TIME_BEGIN,1,0,comm);
        par::Mpi_Bcast(&EM2_RK45_TIME_END,1,0,comm);
        par::Mpi_Bcast(&EM2_RK45_TIME_STEP_SIZE,1,0,comm);
        par::Mpi_Bcast(&EM2_RK45_DESIRED_TOL,1,0,comm);
        par::Mpi_Bcast(&EM2_DIM,1,0,comm);
        par::Mpi_Bcast(&EM2_MAXDEPTH,1,0,comm);

        par::Mpi_Bcast(&EM2_ID_TYPE,1,0,comm);
        par::Mpi_Bcast(&EM2_ID_AMP1,1,0,comm);
        par::Mpi_Bcast(&EM2_ID_LAMBDA1,1,0,comm);
        par::Mpi_Bcast(&EM2_ID_AMP2,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_DELTA1,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_DELTA2,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_XC1,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_YC1,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_ZC1,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_XC2,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_YC2,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_ZC2,1,0,comm);

        //par::Mpi_Bcast(&EM2_ID_EPSX1,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_EPSY1,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_EPSZ1,1,0,comm);

        //par::Mpi_Bcast(&EM2_ID_EPSX2,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_EPSY2,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_EPSZ2,1,0,comm);

        //par::Mpi_Bcast(&EM2_ID_R1,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_R2,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_NU1,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_NU2,1,0,comm);
        //par::Mpi_Bcast(&EM2_ID_OMEGA,1,0,comm);

        par::Mpi_Bcast(&EM2_GRID_MIN_X,1,0,comm);
        par::Mpi_Bcast(&EM2_GRID_MAX_X,1,0,comm);
        par::Mpi_Bcast(&EM2_GRID_MIN_Y,1,0,comm);
        par::Mpi_Bcast(&EM2_GRID_MAX_Y,1,0,comm);
        par::Mpi_Bcast(&EM2_GRID_MIN_Z,1,0,comm);
        par::Mpi_Bcast(&EM2_GRID_MAX_Z,1,0,comm);

        par::Mpi_Bcast(&EM2_BLK_MIN_X,1,0,comm);
        par::Mpi_Bcast(&EM2_BLK_MIN_Y,1,0,comm);
        par::Mpi_Bcast(&EM2_BLK_MIN_Z,1,0,comm);

        par::Mpi_Bcast(&EM2_BLK_MAX_X,1,0,comm);
        par::Mpi_Bcast(&EM2_BLK_MAX_Y,1,0,comm);
        par::Mpi_Bcast(&EM2_BLK_MAX_Z,1,0,comm);

        EM2_OCTREE_MAX[0]=(double )(1u<<em2::EM2_MAXDEPTH);
        EM2_OCTREE_MAX[1]=(double )(1u<<em2::EM2_MAXDEPTH);
        EM2_OCTREE_MAX[2]=(double )(1u<<em2::EM2_MAXDEPTH);

        EM2_COMPD_MIN[0]=EM2_GRID_MIN_X;
        EM2_COMPD_MIN[1]=EM2_GRID_MIN_Y;
        EM2_COMPD_MIN[2]=EM2_GRID_MIN_Z;

        EM2_COMPD_MAX[0]=EM2_GRID_MAX_X;
        EM2_COMPD_MAX[1]=EM2_GRID_MAX_Y;
        EM2_COMPD_MAX[2]=EM2_GRID_MAX_Z;
        EM2_PADDING_WIDTH = EM2_ELE_ORDER>>1u;


        par::Mpi_Bcast(&KO_DISS_SIGMA, 1, 0, comm);
        par::Mpi_Bcast(&DISSIPATION_TYPE, 1, 0, comm);

        par::Mpi_Bcast(&EM2_NUM_REFINE_VARS,1,0,comm);
        par::Mpi_Bcast(&EM2_NUM_EVOL_VARS_VTU_OUTPUT,1,0,comm);
        par::Mpi_Bcast(&EM2_NUM_CONST_VARS_VTU_OUTPUT,1,0,comm);


        if(EM2_NUM_REFINE_VARS>EM2_NUM_VARS){std::cout<<"Error[parameter file]: Number of refine variables should be less than number of EM2_NUM_VARS"<<std::endl; exit(0);}
        if(EM2_NUM_EVOL_VARS_VTU_OUTPUT>EM2_NUM_VARS){std::cout<<"Error[parameter file]: Number of evolution VTU variables should be less than number of EM2_NUM_VARS"<<std::endl; exit(0);}

        par::Mpi_Bcast(EM2_REFINE_VARIABLE_INDICES,EM2_NUM_VARS,0,comm);
        par::Mpi_Bcast(EM2_VTU_OUTPUT_EVOL_INDICES,EM2_NUM_VARS,0,comm);
        par::Mpi_Bcast(EM2_VTU_OUTPUT_CONST_INDICES,EM2_CONSTRAINT_NUM_VARS,0,comm);
    ...
    void dumpParamFile(std::ostream& sout, int root, MPI_Comm comm)
    {
        ...
        if(rank ==root)
        {
            ...
            sout<<YLW<<"\tEM2_ELE_ORDER :"<<em2::EM2_ELE_ORDER<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_PADDING_WIDTH :"<<em2::EM2_PADDING_WIDTH<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_DIM :"<<em2::EM2_DIM<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_IO_OUTPUT_FREQ :"<<em2::EM2_IO_OUTPUT_FREQ<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_REMESH_TEST_FREQ :"<<em2::EM2_REMESH_TEST_FREQ<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_CHECKPT_FREQ :"<<em2::EM2_CHECKPT_FREQ<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_RESTORE_SOLVER :"<<em2::EM2_RESTORE_SOLVER<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_ENABLE_BLOCK_ADAPTIVITY :"<<em2::EM2_ENABLE_BLOCK_ADAPTIVITY<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_VTU_FILE_PREFIX :"<<em2::EM2_VTU_FILE_PREFIX<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_CHKPT_FILE_PREFIX :"<<em2::EM2_CHKPT_FILE_PREFIX<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_PROFILE_FILE_PREFIX :"<<em2::EM2_PROFILE_FILE_PREFIX<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_VTU_Z_SLICE_ONLY :"<<em2::EM2_VTU_Z_SLICE_ONLY<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_IO_OUTPUT_GAP :"<<em2::EM2_IO_OUTPUT_GAP<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_DENDRO_GRAIN_SZ :"<<em2::EM2_DENDRO_GRAIN_SZ<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_ASYNC_COMM_K :"<<em2::EM2_ASYNC_COMM_K<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_DENDRO_AMR_FAC :"<<em2::EM2_DENDRO_AMR_FAC<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_CFL_FACTOR:"<<em2::EM2_CFL_FACTOR<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_WAVELET_TOL :"<<em2::EM2_WAVELET_TOL<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_LOAD_IMB_TOL :"<<em2::EM2_LOAD_IMB_TOL<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_RK45_TIME_BEGIN :"<<em2::EM2_RK45_TIME_BEGIN<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_RK45_TIME_END :"<<em2::EM2_RK45_TIME_END<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_RK45_TIME_STEP_SIZE :"<<em2::EM2_RK45_TIME_STEP_SIZE<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_RK45_DESIRED_TOL :"<<em2::EM2_RK45_DESIRED_TOL<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_COMPD_MIN : ( :"<<em2::EM2_COMPD_MIN[0]<<" ,"<<em2::EM2_COMPD_MIN[1]<<","<<em2::EM2_COMPD_MIN[2]<<" )"<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_COMPD_MAX : ( :"<<em2::EM2_COMPD_MAX[0]<<" ,"<<em2::EM2_COMPD_MAX[1]<<","<<em2::EM2_COMPD_MAX[2]<<" )"<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_BLK_MIN : ( :"<<em2::EM2_BLK_MIN_X<<" ,"<<em2::EM2_BLK_MIN_Y<<","<<em2::EM2_BLK_MIN_Z<<" )"<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_BLK_MAX : ( :"<<em2::EM2_BLK_MAX_X<<" ,"<<em2::EM2_BLK_MAX_Y<<","<<em2::EM2_BLK_MAX_Z<<" )"<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_OCTREE_MIN : ( :"<<em2::EM2_OCTREE_MIN[0]<<" ,"<<em2::EM2_OCTREE_MIN[1]<<","<<em2::EM2_OCTREE_MIN[2]<<" )"<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_OCTREE_MAX : ( :"<<em2::EM2_OCTREE_MAX[0]<<" ,"<<em2::EM2_OCTREE_MAX[1]<<","<<em2::EM2_OCTREE_MAX[2]<<" )"<<NRM<<std::endl;
            sout<<YLW<<"\tKO_DISS_SIGMA :"<<em2::KO_DISS_SIGMA<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_ID_TYPE:"<<em2::EM2_ID_TYPE<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_ID_AMP1:"<<em2::EM2_ID_AMP1<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_ID_LAMBDA1:"<<em2::EM2_ID_LAMBDA1<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_ID_AMP2:"<<em2::EM2_ID_AMP2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_DELTA1:"<<em2::EM2_ID_DELTA1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_DELTA2:"<<em2::EM2_ID_DELTA2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_XC1:"<<em2::EM2_ID_XC1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_YC1:"<<em2::EM2_ID_YC1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_ZC1:"<<em2::EM2_ID_ZC1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_XC2:"<<em2::EM2_ID_XC2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_YC2:"<<em2::EM2_ID_YC2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_ZC2:"<<em2::EM2_ID_ZC2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_EPSX1:"<<em2::EM2_ID_EPSX1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_EPSY1:"<<em2::EM2_ID_EPSY1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_EPSZ1:"<<em2::EM2_ID_EPSY1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_EPSX2:"<<em2::EM2_ID_EPSX2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_EPSY2:"<<em2::EM2_ID_EPSY2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_EPSZ2:"<<em2::EM2_ID_EPSY2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_R1:"<<em2::EM2_ID_R1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_R2:"<<em2::EM2_ID_R2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_NU1:"<<em2::EM2_ID_NU1<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_NU2:"<<em2::EM2_ID_NU2<<NRM<<std::endl;
            // sout<<YLW<<"\tEM2_ID_OMEGA:"<<em2::EM2_ID_OMEGA<<NRM<<std::endl;

        
        

            //std::cout<<YLW<<"\tEM2_DIM :"<<em2::EM2_DIM<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_MAXDEPTH :"<<em2::EM2_MAXDEPTH<<NRM<<std::endl;

            sout<<YLW<<"\tEM2_NUM_REFINE_VARS :"<<em2::EM2_NUM_REFINE_VARS<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_REFINE_VARIABLE_INDICES :[";
            for(unsigned int i=0;i<em2::EM2_NUM_REFINE_VARS-1;i++)
                sout<<em2::EM2_REFINE_VARIABLE_INDICES[i]<<", ";
            sout<<em2::EM2_REFINE_VARIABLE_INDICES[em2::EM2_NUM_REFINE_VARS-1]<<"]"<<NRM<<std::endl;

            sout<<YLW<<"\tEM2_REFINEMENT_MODE :"<<em2::EM2_REFINEMENT_MODE<<NRM<<std::endl;

            sout<<YLW<<"\tEM2_NUM_EVOL_VARS_VTU_OUTPUT :"<<em2::EM2_NUM_EVOL_VARS_VTU_OUTPUT<<NRM<<std::endl;
            sout<<YLW<<"\tEM2_VTU_OUTPUT_EVOL_INDICES :[";
            for(unsigned int i=0;i<em2::EM2_NUM_EVOL_VARS_VTU_OUTPUT-1;i++)
                sout<<em2::EM2_VTU_OUTPUT_EVOL_INDICES[i]<<", ";
            sout<<em2::EM2_VTU_OUTPUT_EVOL_INDICES[em2::EM2_NUM_EVOL_VARS_VTU_OUTPUT-1]<<"]"<<NRM<<std::endl;
    ...
    namespace timer
    {
        ...
        void profileInfo(const char* filePrefix,const ot::Mesh* pMesh)
        {
            ...
            if(!activeRank)
            {
                ...
                outfile<<"partition tol : "<<em2::EM2_LOAD_IMB_TOL<<std::endl;
                outfile<<"wavelet tol : "<<em2::EM2_WAVELET_TOL<<std::endl;
                outfile<<"maxdepth : "<<em2::EM2_MAXDEPTH<<std::endl;
        ...
        void profileInfoIntermediate(const char* filePrefix,const ot::Mesh* pMesh,const unsigned int currentStep)
        {
...
#ifdef EM2_PROFILE_HUMAN_READABLE
            if(!activeRank)
            {
            ...
            if(!rank) outfile<<em2::EM2_LOAD_IMB_TOL<<"\t ";
            if(!rank) outfile<<em2::EM2_WAVELET_TOL<<"\t ";
            if(!rank) outfile<<em2::EM2_MAXDEPTH<<"\t ";
