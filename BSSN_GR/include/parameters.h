...
namespace bssn
{
    ...
    /**@brief: skip grid point distance from bh < BSSN_BH1_CONSTRAINT_R when computing the constraint norms for BH1*/
    extern double BSSN_BH1_CONSTRAINT_R;
    
    /**@brief: skip grid point distance from bh < BSSN_BH2_CONSTRAINT_R when computing the constraint norms  for BH2*/
