...
#ifndef SFCSORTBENCH_RK4BSSN_H
#define SFCSORTBENCH_RK4BSSN_H
...
class RK4_BSSN : public RK {
   ...
   public:
     ...
     * * */
    RK4_BSSN(ot::Mesh *pMesh, double pTBegin, double pTEnd, double pTh);
