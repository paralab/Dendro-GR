...
const double DENDRO_0 = 2 * alpha;
const double DENDRO_1 =
    (3.0 / 4.0) * alpha * lambda_f[1] + (3.0 / 4.0) * lambda_f[0];
const double DENDRO_2  = (4.0 / 3.0) * grad_0_beta0;
const double DENDRO_3  = 2 * gt1;
const double DENDRO_4  = 2 * gt2;
const double DENDRO_5  = (2.0 / 3.0) * gt0;
const double DENDRO_6  = (1.0 / 3.0) * gt1;
const double DENDRO_7  = (2.0 / 3.0) * grad_2_beta2;
const double DENDRO_8  = (1.0 / 3.0) * gt2;
const double DENDRO_9  = (2.0 / 3.0) * grad_1_beta1;
const double DENDRO_10 = (2.0 / 3.0) * grad_0_beta0;
const double DENDRO_11 = (4.0 / 3.0) * grad_1_beta1;
const double DENDRO_12 = 2 * gt4;
const double DENDRO_13 = (1.0 / 3.0) * gt4;
const double DENDRO_14 = (4.0 / 3.0) * grad_2_beta2;
const double DENDRO_15 = (2.0 / 3.0) * chi;
const double DENDRO_16 = grad_0_beta0 + grad_1_beta1 + grad_2_beta2;
const double DENDRO_17 = 2 * At1;
const double DENDRO_18 = 2 * At2;
const double DENDRO_19 = gt2 * gt4;
const double DENDRO_20 = -DENDRO_19 + gt1 * gt5;
const double DENDRO_21 = At0 * DENDRO_20;
const double DENDRO_22 = gt0 * gt4 - gt1 * gt2;
const double DENDRO_23 = At2 * DENDRO_22;
const double DENDRO_24 = gt0 * gt5;
const double DENDRO_25 = pow(gt2, 2);
const double DENDRO_26 = DENDRO_24 - DENDRO_25;
const double DENDRO_27 = At1 * DENDRO_26;
const double DENDRO_28 = pow(gt4, 2);
const double DENDRO_29 = pow(gt1, 2);
const double DENDRO_30 = gt3 * gt5;
const double DENDRO_31 = -DENDRO_19 * DENDRO_3 + DENDRO_25 * gt3 +
                         DENDRO_28 * gt0 + DENDRO_29 * gt5 - DENDRO_30 * gt0;
const double DENDRO_32  = 1.0 / DENDRO_31;
const double DENDRO_33  = DENDRO_17 * DENDRO_32;
const double DENDRO_34  = At1 * DENDRO_20;
const double DENDRO_35  = gt1 * gt4;
const double DENDRO_36  = gt2 * gt3;
const double DENDRO_37  = DENDRO_35 - DENDRO_36;
const double DENDRO_38  = At2 * DENDRO_37;
const double DENDRO_39  = -DENDRO_38;
const double DENDRO_40  = -DENDRO_28 + DENDRO_30;
const double DENDRO_41  = At0 * DENDRO_40;
const double DENDRO_42  = 2 * DENDRO_32;
const double DENDRO_43  = At0 * DENDRO_42;
const double DENDRO_44  = At1 * DENDRO_22;
const double DENDRO_45  = gt0 * gt3;
const double DENDRO_46  = -DENDRO_29 + DENDRO_45;
const double DENDRO_47  = At2 * DENDRO_46;
const double DENDRO_48  = DENDRO_18 * DENDRO_32;
const double DENDRO_49  = DENDRO_20 * grad_0_chi + DENDRO_22 * grad_2_chi;
const double DENDRO_50  = -DENDRO_26 * grad_1_chi + DENDRO_49;
const double DENDRO_51  = 0.5 * DENDRO_50;
const double DENDRO_52  = 1.0 / chi;
const double DENDRO_53  = DENDRO_52 * gt0;
const double DENDRO_54  = 1.0 * grad_0_gt1;
const double DENDRO_55  = 0.5 * grad_1_gt0;
const double DENDRO_56  = DENDRO_54 - DENDRO_55;
const double DENDRO_57  = 1.0 * grad_0_gt2;
const double DENDRO_58  = 0.5 * grad_2_gt0;
const double DENDRO_59  = DENDRO_57 - DENDRO_58;
const double DENDRO_60  = 0.5 * grad_0_gt0;
...
const double DENDRO_64  = 12 * grad_1_alpha;
const double DENDRO_65  = DENDRO_32 * DENDRO_64;
const double DENDRO_66  = DENDRO_22 * grad_1_chi;
const double DENDRO_67  = DENDRO_37 * grad_0_chi;
const double DENDRO_68  = DENDRO_46 * grad_2_chi;
...
const double DENDRO_76  = 12 * grad_2_alpha;
...
const double DENDRO_84  = 1.0 * grad_0_chi;
const double DENDRO_85  = DENDRO_32 * gt0;
const double DENDRO_86  = DENDRO_20 * grad_1_chi;
const double DENDRO_87  = DENDRO_37 * grad_2_chi;
const double DENDRO_88  = DENDRO_40 * grad_0_chi;
...
const double DENDRO_92  = 12 * grad_0_alpha;
const double DENDRO_93  = -grad2_0_0_chi;
const double DENDRO_94  = -DENDRO_78 - DENDRO_80 + DENDRO_82;
const double DENDRO_95  = DENDRO_32 * grad_0_chi;
const double DENDRO_96  = DENDRO_32 * grad_1_chi;
const double DENDRO_97  = -DENDRO_72 + DENDRO_73 - DENDRO_74;
const double DENDRO_98  = DENDRO_32 * grad_2_chi;
const double DENDRO_99  = 2 * DENDRO_52;
const double DENDRO_100 = 0.5 * grad_0_gt3;
const double DENDRO_101 = 1.0 * grad_1_gt1;
const double DENDRO_102 = DENDRO_100 - DENDRO_101;
const double DENDRO_103 = grad_0_gt4 - grad_1_gt2 + grad_2_gt1;
const double DENDRO_104 = DENDRO_20 * grad_2_gt0 + DENDRO_22 * grad_0_gt5;
const double DENDRO_105 = -DENDRO_103 * DENDRO_26 + DENDRO_104;
const double DENDRO_106 = DENDRO_102 * DENDRO_105;
const double DENDRO_107 = DENDRO_26 * grad_0_gt3;
const double DENDRO_108 = DENDRO_20 * grad_1_gt0;
const double DENDRO_109 = grad_0_gt4 + grad_1_gt2 - grad_2_gt1;
...
const double DENDRO_118 = 0.5 * grad_0_gt5;
const double DENDRO_119 = 1.0 * grad_2_gt2;
const double DENDRO_120 = -DENDRO_119;
const double DENDRO_121 = DENDRO_118 + DENDRO_120;
const double DENDRO_122 = DENDRO_22 * grad_0_gt3;
const double DENDRO_123 = DENDRO_37 * grad_1_gt0;
...
const double DENDRO_127 = DENDRO_37 * grad_2_gt0;
const double DENDRO_128 = DENDRO_46 * grad_0_gt5;
...
const double DENDRO_177 = 0.5 * grad_2_gt5;
const double DENDRO_178 = DENDRO_177 * DENDRO_37;
const double DENDRO_179 = DENDRO_121 * DENDRO_40;
const double DENDRO_180 = 0.5 * grad_1_gt5;
const double DENDRO_181 = 1.0 * grad_2_gt4;
...
const double DENDRO_187 = 0.5 * grad_1_gt3;
const double DENDRO_188 = DENDRO_187 * DENDRO_20;
const double DENDRO_189 = 1.0 * grad_1_gt4;
const double DENDRO_190 = 0.5 * grad_2_gt3;
...
const double DENDRO_196 = 2.0 * grad_0_gt0;
const double DENDRO_197 = DENDRO_105 * DENDRO_37;
const double DENDRO_198 = DENDRO_26 * grad_2_gt3;
const double DENDRO_199 = DENDRO_22 * grad_1_gt5;
...
const double DENDRO_215 = 2.0 * grad_1_gt0;
const double DENDRO_216 = DENDRO_130 * DENDRO_37;
const double DENDRO_217 = DENDRO_22 * grad_2_gt3;
const double DENDRO_218 = DENDRO_46 * grad_1_gt5;
...
const double DENDRO_233 = 2.0 * grad_2_gt0;
const double DENDRO_234 = 2.0 * DENDRO_159;
const double DENDRO_235 = DENDRO_134 * grad_2_gt0;
const double DENDRO_236 = DENDRO_109 * DENDRO_75;
const double DENDRO_237 = 3 * DENDRO_52;
const double DENDRO_238 = grad_0_chi * grad_1_chi;
const double DENDRO_239 = 2 * DENDRO_20;
const double DENDRO_240 =
    DENDRO_239 * (-DENDRO_237 * DENDRO_238 + 2 * grad2_0_1_chi);
const double DENDRO_241 = DENDRO_237 * grad_2_chi;
const double DENDRO_242 = 2 * DENDRO_37;
const double DENDRO_243 =
    DENDRO_242 * (-DENDRO_241 * grad_0_chi + 2 * grad2_0_2_chi);
const double DENDRO_244 = 2 * DENDRO_22;
const double DENDRO_245 =
    DENDRO_244 * (-DENDRO_241 * grad_1_chi + 2 * grad2_1_2_chi);
const double DENDRO_246 = pow(grad_0_chi, 2);
const double DENDRO_247 =
    DENDRO_40 * (-DENDRO_237 * DENDRO_246 + 2 * grad2_0_0_chi);
const double DENDRO_248 = pow(grad_1_chi, 2);
const double DENDRO_249 =
    DENDRO_26 * (-DENDRO_237 * DENDRO_248 + 2 * grad2_1_1_chi);
const double DENDRO_250 = pow(grad_2_chi, 2);
const double DENDRO_251 =
    DENDRO_46 * (-DENDRO_237 * DENDRO_250 + 2 * grad2_2_2_chi);
...
const double DENDRO_262 = 0.25 * grad_0_gt4;
const double DENDRO_263 = -DENDRO_262;
const double DENDRO_264 = 0.75 * grad_1_gt2;
const double DENDRO_265 = 0.25 * grad_2_gt1;
...
const double DENDRO_272 = DENDRO_149 * grad_1_gt0;
const double DENDRO_273 = 3.0 * DENDRO_266;
const double DENDRO_274 = DENDRO_143 * grad_2_gt0;
const double DENDRO_275 = 3.0 * DENDRO_260;
const double DENDRO_276 = 6.0 * grad_0_gt0;
const double DENDRO_277 = pow(chi, -2);
const double DENDRO_278 = 4 * gt1;
const double DENDRO_279 = 4 * gt2;
...
const double DENDRO_284 = 0.25 * grad_0_gt3;
...
const double DENDRO_294 = DENDRO_112 * grad_1_gt0;
const double DENDRO_295 = DENDRO_62 * grad_0_gt3;
const double DENDRO_296 = DENDRO_105 * grad_1_gt0;
...
const double DENDRO_301 = 0.25 * grad_1_gt2;
const double DENDRO_302 = 0.75 * grad_2_gt1;
...
const double DENDRO_304 =
    ...
    DENDRO_278 * grad_0_Gt1 + DENDRO_279 * grad_0_Gt2 +
    DENDRO_283 * grad2_0_2_gt0 + DENDRO_289 * grad2_0_0_gt0 +
    DENDRO_291 * grad2_1_1_gt0 + DENDRO_293 * grad2_2_2_gt0 -
    DENDRO_299 * grad2_0_1_gt0 - DENDRO_300 * grad2_1_2_gt0 +
    4 * grad_0_Gt0 * gt0;
const double DENDRO_305 = 3 * alpha;
const double DENDRO_306 = DENDRO_52 * gt5;
const double DENDRO_307 = DENDRO_206 + DENDRO_306 * DENDRO_51;
const double DENDRO_308 = 4 * grad_1_alpha;
const double DENDRO_309 = DENDRO_308 * DENDRO_32;
const double DENDRO_310 = DENDRO_306 * DENDRO_90;
const double DENDRO_311 = 4 * grad_0_alpha;
...
const double DENDRO_316 = 1.0 * grad_2_chi;
const double DENDRO_317 = DENDRO_32 * gt5;
const double DENDRO_318 = DENDRO_52 * (DENDRO_316 - DENDRO_317 * DENDRO_70);
const double DENDRO_319 = 4 * grad_2_alpha;
const double DENDRO_320 = -grad2_2_2_chi;
...
const double DENDRO_340 = DENDRO_130 * grad_2_gt5;
const double DENDRO_341 = 0.25 * DENDRO_340;
const double DENDRO_342 = DENDRO_226 * grad_0_gt5;
...
const double DENDRO_346 = DENDRO_220 * grad_2_gt5;
const double DENDRO_347 = 0.25 * DENDRO_346;
const double DENDRO_348 = DENDRO_226 * grad_1_gt5;
...
const double DENDRO_353 = 0.25 * grad_1_gt5;
...
const double DENDRO_365 = DENDRO_185 * grad_2_gt0;
...
const double DENDRO_371 = DENDRO_130 * grad_0_gt5;
const double DENDRO_372 = 3.0 * DENDRO_270;
const double DENDRO_373 = DENDRO_220 * grad_1_gt5;
const double DENDRO_374 = 6.0 * DENDRO_115;
const double DENDRO_375 = 4 * gt4;
...
const double DENDRO_380 = 0.25 * grad_2_gt3;
const double DENDRO_381 = DENDRO_105 * DENDRO_380;
const double DENDRO_382 = DENDRO_202 * grad_1_gt5;
const double DENDRO_383 = DENDRO_206 * grad_2_gt3;
const double DENDRO_384 = DENDRO_105 * grad_1_gt5;
const double DENDRO_385 = DENDRO_103 * DENDRO_206;
const double DENDRO_386 = 0.75 * grad_0_gt4;
const double DENDRO_387 =
    ...
    DENDRO_250 * DENDRO_277 + DENDRO_279 * grad_2_Gt0 +
    DENDRO_283 * grad2_0_2_gt5 + DENDRO_289 * grad2_0_0_gt5 +
    DENDRO_291 * grad2_1_1_gt5 + DENDRO_293 * grad2_2_2_gt5 -
    DENDRO_299 * grad2_0_1_gt5 - DENDRO_300 * grad2_1_2_gt5 +
    DENDRO_364 * (DENDRO_382 + DENDRO_383) + DENDRO_375 * grad_2_Gt1 +
    4 * grad_2_Gt2 * gt5;
const double DENDRO_388 = DENDRO_52 * gt3;
...
const double DENDRO_393 = 1.0 * grad_1_chi;
const double DENDRO_394 = DENDRO_32 * gt3;
const double DENDRO_395 = DENDRO_52 * (DENDRO_393 - DENDRO_394 * DENDRO_51);
const double DENDRO_396 = -grad2_1_1_chi;
...
const double DENDRO_418 = DENDRO_202 * grad_1_gt3;
const double DENDRO_419 = 0.25 * DENDRO_418;
const double DENDRO_420 = DENDRO_211 * grad_2_gt3;
...
const double DENDRO_425 = DENDRO_112 * grad_1_gt3;
const double DENDRO_426 = 0.25 * DENDRO_425;
const double DENDRO_427 = DENDRO_211 * grad_0_gt3;
const double DENDRO_428 = DENDRO_192 * grad_1_gt0;
const double DENDRO_429 = DENDRO_137 * DENDRO_192;
const double DENDRO_430 = DENDRO_229 * grad_1_gt5;
...
const double DENDRO_438 = DENDRO_112 * grad_0_gt3;
const double DENDRO_439 = DENDRO_202 * grad_2_gt3;
const double DENDRO_440 =
    ...
    DENDRO_278 * grad_1_Gt0 + DENDRO_283 * grad2_0_2_gt3 +
    DENDRO_289 * grad2_0_0_gt3 + DENDRO_291 * grad2_1_1_gt3 +
    DENDRO_293 * grad2_2_2_gt3 - DENDRO_299 * grad2_0_1_gt3 -
    DENDRO_300 * grad2_1_2_gt3 - DENDRO_372 * DENDRO_438 +
    DENDRO_375 * grad_1_Gt2 + 4 * grad_1_Gt1 * gt3;
...
const double DENDRO_446 = DENDRO_168 * grad_0_gt0;
const double DENDRO_447 = 0.25 * DENDRO_446;
const double DENDRO_448 = DENDRO_94 * grad_2_gt0;
...
const double DENDRO_453 = DENDRO_175 * grad_0_gt0;
const double DENDRO_454 = 0.25 * DENDRO_453;
const double DENDRO_455 = DENDRO_94 * grad_1_gt0;
const double DENDRO_456 = DENDRO_109 * DENDRO_97;
const double DENDRO_457 = DENDRO_97 * grad_0_gt5;
const double DENDRO_458 = DENDRO_175 * grad_1_gt0;
const double DENDRO_459 = DENDRO_168 * grad_2_gt0;
const double DENDRO_460 = DENDRO_202 * grad_1_gt0;
const double DENDRO_461 = DENDRO_105 * grad_0_gt3;
const double DENDRO_462 = DENDRO_109 * DENDRO_112;
const double DENDRO_463 = DENDRO_461 + DENDRO_462;
const double DENDRO_464 = DENDRO_220 * grad_2_gt0;
const double DENDRO_465 = DENDRO_125 * grad_0_gt5;
...
const double DENDRO_503 = DENDRO_502 * grad_2_gt5;
...
const double DENDRO_508 = DENDRO_507 * grad_0_gt0;
...
const double DENDRO_517 = DENDRO_125 * grad_1_gt5;
const double DENDRO_518 = DENDRO_408 + DENDRO_517;
const double DENDRO_519 = 1.0 * DENDRO_266;
const double DENDRO_520 = -grad2_0_2_chi;
const double DENDRO_521 = DENDRO_321 * grad_0_gt5;
const double DENDRO_522 = DENDRO_324 * grad_2_gt0;
...
const double DENDRO_526 = DENDRO_329 * grad_0_gt5;
const double DENDRO_527 = DENDRO_321 * grad_2_gt0;
const double DENDRO_528 = 0.5 * DENDRO_98;
const double DENDRO_529 = 2.0 * gt2;
const double DENDRO_530 = DENDRO_529 * grad_0_Gt0;
const double DENDRO_531 = 2.0 * gt4;
const double DENDRO_532 = DENDRO_531 * grad_0_Gt1;
const double DENDRO_533 = 2.0 * gt5;
const double DENDRO_534 = DENDRO_533 * grad_0_Gt2;
const double DENDRO_535 = 2.0 * grad_2_Gt0;
const double DENDRO_536 = DENDRO_535 * gt0;
const double DENDRO_537 = 2.0 * grad_2_Gt1;
const double DENDRO_538 = DENDRO_537 * gt1;
const double DENDRO_539 = DENDRO_529 * grad_2_Gt2;
const double DENDRO_540 = DENDRO_277 * grad_2_chi;
const double DENDRO_541 = -DENDRO_540 * grad_0_chi;
const double DENDRO_542 = DENDRO_283 * grad2_0_2_gt2;
const double DENDRO_543 = DENDRO_289 * grad2_0_0_gt2;
const double DENDRO_544 = DENDRO_291 * grad2_1_1_gt2;
const double DENDRO_545 = DENDRO_293 * grad2_2_2_gt2;
const double DENDRO_546 = -DENDRO_299 * grad2_0_1_gt2;
const double DENDRO_547 = -DENDRO_300 * grad2_1_2_gt2;
const double DENDRO_548 = DENDRO_32 * gt2;
const double DENDRO_549 =
    DENDRO_358 * grad_0_gt2 + DENDRO_360 * grad_1_gt2 +
    DENDRO_362 * grad_2_gt2 + DENDRO_367 * DENDRO_548 + DENDRO_530 +
...
const double DENDRO_553 = DENDRO_52 * (-DENDRO_548 * DENDRO_89 + grad_2_chi);
const double DENDRO_554 = 2.0 * grad_0_alpha;
...
const double DENDRO_558 = DENDRO_52 * (-DENDRO_548 * DENDRO_69 + grad_0_chi);
const double DENDRO_559 = 2.0 * grad_2_alpha;
const double DENDRO_560 = 2.0 * grad_1_alpha;
const double DENDRO_561 = DENDRO_52 * gt2;
...
const double DENDRO_563 =
    ...
    DENDRO_560 * DENDRO_562 - 4 * grad2_0_2_alpha;
const double DENDRO_564 = DENDRO_173 * grad_2_gt0;
const double DENDRO_565 = DENDRO_175 * grad_0_gt5 + DENDRO_564;
...
const double DENDRO_575 = DENDRO_173 * grad_1_gt0;
const double DENDRO_576 = DENDRO_470 + DENDRO_575;
const double DENDRO_577 = DENDRO_105 * grad_2_gt3;
const double DENDRO_578 = DENDRO_112 * grad_1_gt5 + DENDRO_577;
...
const double DENDRO_583 = DENDRO_168 * grad_0_gt3;
const double DENDRO_584 = DENDRO_130 * grad_2_gt3;
...
const double DENDRO_613 = DENDRO_478 * grad_1_gt3;
...
const double DENDRO_622 = -grad2_1_2_chi;
const double DENDRO_623 =
    DENDRO_137 * DENDRO_324 + DENDRO_170 + DENDRO_321 * grad_1_gt5;
const double DENDRO_624 = DENDRO_327 * grad_2_gt3;
const double DENDRO_625 = DENDRO_329 * grad_1_gt5;
const double DENDRO_626 = DENDRO_137 * DENDRO_321;
const double DENDRO_627 = DENDRO_32 * gt4;
const double DENDRO_628 =
    DENDRO_283 * grad2_0_2_gt4 + DENDRO_289 * grad2_0_0_gt4 +
    DENDRO_291 * grad2_1_1_gt4 + DENDRO_293 * grad2_2_2_gt4 -
    DENDRO_299 * grad2_0_1_gt4 - DENDRO_300 * grad2_1_2_gt4 +
    DENDRO_529 * grad_1_Gt0 + DENDRO_531 * grad_1_Gt1 +
    DENDRO_531 * grad_2_Gt2 + DENDRO_533 * grad_1_Gt2 + DENDRO_535 * gt1 +
    DENDRO_537 * gt3 - DENDRO_540 * grad_1_chi;
const double DENDRO_629 =
    DENDRO_358 * grad_0_gt4 + DENDRO_360 * grad_1_gt4 +
    DENDRO_362 * grad_2_gt4 + DENDRO_367 * DENDRO_627 + DENDRO_628 -
    DENDRO_99 *
...
const double DENDRO_631 = -DENDRO_198 * DENDRO_32 -
                          DENDRO_52 * (-DENDRO_50 * DENDRO_627 + grad_2_chi) +
                          DENDRO_630;
...
const double DENDRO_635 = DENDRO_52 * (-DENDRO_627 * DENDRO_69 + grad_1_chi);
const double DENDRO_636 = DENDRO_52 * gt4;
...
const double DENDRO_638 =
    ...
    DENDRO_560 * DENDRO_631 - 4 * grad2_1_2_alpha;
...
const double DENDRO_682 = -grad2_0_1_chi;
const double DENDRO_683 = DENDRO_324 * grad_1_gt0;
const double DENDRO_684 = DENDRO_109 * DENDRO_321;
const double DENDRO_685 = DENDRO_327 * grad_0_gt3;
const double DENDRO_686 =
    DENDRO_109 * DENDRO_329 + DENDRO_122 + DENDRO_321 * grad_1_gt0;
const double DENDRO_687 = 2.0 * gt1;
const double DENDRO_688 = DENDRO_687 * grad_0_Gt0;
const double DENDRO_689 = 2.0 * grad_0_Gt1 * gt3;
const double DENDRO_690 = DENDRO_531 * grad_0_Gt2;
const double DENDRO_691 = 2.0 * grad_1_Gt0 * gt0;
const double DENDRO_692 = DENDRO_687 * grad_1_Gt1;
const double DENDRO_693 = DENDRO_529 * grad_1_Gt2;
const double DENDRO_694 = -DENDRO_238 * DENDRO_277;
const double DENDRO_695 = DENDRO_283 * grad2_0_2_gt1;
const double DENDRO_696 = DENDRO_289 * grad2_0_0_gt1;
const double DENDRO_697 = DENDRO_291 * grad2_1_1_gt1;
const double DENDRO_698 = DENDRO_293 * grad2_2_2_gt1;
const double DENDRO_699 = -DENDRO_299 * grad2_0_1_gt1;
const double DENDRO_700 = -DENDRO_300 * grad2_1_2_gt1;
const double DENDRO_701 = DENDRO_32 * gt1;
const double DENDRO_702 =
    DENDRO_358 * grad_0_gt1 + DENDRO_360 * grad_1_gt1 +
    DENDRO_362 * grad_2_gt1 + DENDRO_367 * DENDRO_701 + DENDRO_688 +
...
const double DENDRO_706 = DENDRO_52 * (-DENDRO_701 * DENDRO_89 + grad_1_chi);
const double DENDRO_707 = DENDRO_52 * (-DENDRO_50 * DENDRO_701 + grad_0_chi);
...
const double DENDRO_712 = DENDRO_52 * gt1;
const double DENDRO_713 =
    ...
    DENDRO_560 * (-DENDRO_707 - DENDRO_708 + DENDRO_711) - 4 * grad2_0_1_alpha;
...
const double DENDRO_719 =
    -DENDRO_20 * (DENDRO_713 +
                  alpha * (DENDRO_116 * (DENDRO_403 + DENDRO_575 + DENDRO_583) +
                           ...
                           DENDRO_234 * (DENDRO_458 + DENDRO_94 * grad_0_gt3) -
                           ...
                           DENDRO_271 * (DENDRO_454 + DENDRO_55 * DENDRO_94 +
                                         DENDRO_658) -
                           DENDRO_681 * (DENDRO_350 + DENDRO_564 + DENDRO_595) +
                           DENDRO_702 + DENDRO_718)) -
    DENDRO_20 *
        (DENDRO_713 +
         alpha *
             (DENDRO_117 * (DENDRO_405 + DENDRO_648) +
              ...
              DENDRO_234 * (DENDRO_211 * grad_1_gt0 + DENDRO_438) -
        ...
        (DENDRO_638 +
         alpha *
             (DENDRO_117 * (DENDRO_602 + DENDRO_645) +
              ...
              DENDRO_364 * (DENDRO_211 * grad_1_gt5 + DENDRO_439) + DENDRO_629 -
              DENDRO_651 * (DENDRO_565 + DENDRO_595) + DENDRO_652)) -
    DENDRO_22 *
        (DENDRO_638 +
         alpha *
             (DENDRO_117 * (DENDRO_606 + DENDRO_607) +
              ...
              DENDRO_364 * (DENDRO_226 * grad_2_gt3 + DENDRO_373) -
        ...
        (DENDRO_308 * (-DENDRO_390 + DENDRO_391 - DENDRO_392 - DENDRO_395) +
         ...
         alpha *
             (DENDRO_117 * (DENDRO_413 + DENDRO_414) +
              ...
              DENDRO_212 * DENDRO_374 * grad_1_gt3 -
              DENDRO_220 * DENDRO_261 * (DENDRO_181 - DENDRO_353) +
              DENDRO_234 * (DENDRO_425 + DENDRO_427) +
              DENDRO_234 * (DENDRO_125 * grad_2_gt3 + DENDRO_431) +
              DENDRO_234 * (DENDRO_175 * grad_0_gt3 + DENDRO_428) +
              DENDRO_358 * grad_0_gt3 + DENDRO_360 * grad_1_gt3 +
              DENDRO_362 * grad_2_gt3 + DENDRO_364 * (DENDRO_418 + DENDRO_420) +
              DENDRO_364 * (DENDRO_173 * grad_0_gt3 + DENDRO_429) +
              DENDRO_364 * (DENDRO_220 * grad_2_gt3 + DENDRO_430) +
        ...
        (DENDRO_563 +
         alpha *
             (DENDRO_116 * (DENDRO_350 + DENDRO_565) +
              ...
              DENDRO_165 * (DENDRO_459 + DENDRO_94 * grad_0_gt5) -
        ...
        (DENDRO_563 +
         alpha *
             (DENDRO_117 * (DENDRO_355 + DENDRO_491) +
              ...
              DENDRO_165 * (DENDRO_226 * grad_2_gt0 + DENDRO_371) -
        ...
        (DENDRO_309 * DENDRO_63 +
         ...
         alpha *
             (-DENDRO_115 * DENDRO_194 * DENDRO_276 +
              ...
              DENDRO_165 * (DENDRO_130 * grad_2_gt0 + DENDRO_457) +
              ...
              DENDRO_234 * (DENDRO_125 * grad_2_gt0 + DENDRO_456) +
        ...
        (DENDRO_307 * DENDRO_309 + DENDRO_312 * (DENDRO_185 + DENDRO_310) +
         ...
         alpha *
             (DENDRO_117 * (DENDRO_344 + DENDRO_345) +
              ...
              DENDRO_165 * (DENDRO_168 * grad_0_gt5 + DENDRO_365) -
              DENDRO_168 * DENDRO_370 - DENDRO_173 * DENDRO_369 -
              DENDRO_186 * DENDRO_303 * (DENDRO_118 + DENDRO_119) -
              DENDRO_227 * DENDRO_374 * grad_2_gt5 - DENDRO_273 * DENDRO_373 +
              DENDRO_317 * DENDRO_367 + DENDRO_358 * grad_0_gt5 +
              DENDRO_360 * grad_1_gt5 + DENDRO_362 * grad_2_gt5 +
              DENDRO_364 * (DENDRO_346 + DENDRO_348) +
              DENDRO_364 * (DENDRO_173 * grad_0_gt5 + DENDRO_363) -
...
const double DENDRO_721 = (1.0 / 12.0) * chi;
const double DENDRO_722 = (1.0 / 3.0) * At1;
const double DENDRO_723 = At4 * DENDRO_22;
const double DENDRO_724 = At3 * DENDRO_26;
const double DENDRO_725 = DENDRO_34 + DENDRO_723 - DENDRO_724;
const double DENDRO_726 = At3 * DENDRO_20;
const double DENDRO_727 = At4 * DENDRO_37;
const double DENDRO_728 = -At1 * DENDRO_40 + DENDRO_726 - DENDRO_727;
const double DENDRO_729 = At4 * DENDRO_46;
const double DENDRO_730 = -At1 * DENDRO_37 + At3 * DENDRO_22 - DENDRO_729;
const double DENDRO_731 = -DENDRO_66 + DENDRO_67 + DENDRO_68;
const double DENDRO_732 = 6.0 * grad_2_alpha;
const double DENDRO_733 = 6.0 * grad_0_alpha;
const double DENDRO_734 = 6.0 * grad_1_alpha;
const double DENDRO_735 = DENDRO_103 * DENDRO_143;
const double DENDRO_736 = -DENDRO_170 + DENDRO_171 + DENDRO_172;
const double DENDRO_737 = DENDRO_736 * grad_2_gt0;
...
const double DENDRO_744 =
    DENDRO_157 * DENDRO_286 + 0.25 * DENDRO_736 * grad_0_gt0;
...
const double DENDRO_751 = DENDRO_736 * grad_1_gt0 + DENDRO_750;
...
const double DENDRO_758 = (1.0 / 3.0) * At2;
const double DENDRO_759 = At5 * DENDRO_22;
const double DENDRO_760 = At2 * DENDRO_20 - At4 * DENDRO_26 + DENDRO_759;
const double DENDRO_761 = At5 * DENDRO_37;
const double DENDRO_762 = -At2 * DENDRO_40 + At4 * DENDRO_20 - DENDRO_761;
const double DENDRO_763 = -At5 * DENDRO_46 + DENDRO_39 + DENDRO_723;
const double DENDRO_764 = DENDRO_109 * DENDRO_149;
const double DENDRO_765 = DENDRO_138 * grad_2_gt5;
...
const double DENDRO_770 = 0.25 * DENDRO_134 * grad_2_gt5;
...
const double DENDRO_776 = DENDRO_149 * grad_0_gt5;
const double DENDRO_777 = 2 * At4;
const double DENDRO_778 = At3 * DENDRO_42;
...
const double DENDRO_782 = DENDRO_740 * grad_2_gt3;
...
const double DENDRO_786 = DENDRO_740 * grad_0_gt3;
const double DENDRO_787 = (1.0 / 3.0) * At4;
const double DENDRO_788 = DENDRO_747 * grad_2_gt5;
...
const double DENDRO_792 = DENDRO_766 * grad_1_gt5;
const double DENDRO_793 = DENDRO_766 * grad_0_gt5;
const double DENDRO_794 =
    DENDRO_321 * grad_2_chi + DENDRO_324 * grad_0_chi + DENDRO_86;
const double DENDRO_795 = 0.5 * DENDRO_306;
const double DENDRO_796 = DENDRO_32 * grad_0_alpha;
const double DENDRO_797 = DENDRO_327 * grad_1_chi + DENDRO_49;
const double DENDRO_798 = DENDRO_32 * grad_1_alpha;
const double DENDRO_799 =
    DENDRO_321 * grad_0_chi + DENDRO_329 * grad_2_chi + DENDRO_66;
const double DENDRO_800 = 0.5 * DENDRO_799;
const double DENDRO_801 = DENDRO_32 * grad_2_alpha;
const double DENDRO_802 = 0.5 * DENDRO_797;
const double DENDRO_803 = 0.5 * grad_1_alpha;
const double DENDRO_804 = 0.5 * grad_2_alpha;
const double DENDRO_805 = DENDRO_244 * DENDRO_32;
const double DENDRO_806 = 0.5 * grad_0_alpha;
...
const double DENDRO_812 = At0 * pow(DENDRO_40, 2) + At3 * DENDRO_809 +
                          At5 * DENDRO_810 - DENDRO_239 * DENDRO_727 -
...
const double DENDRO_816 = At0 * DENDRO_809 + At3 * pow(DENDRO_26, 2) +
                          At5 * DENDRO_814 + DENDRO_23 * DENDRO_239 -
                          DENDRO_34 * DENDRO_815 - DENDRO_723 * DENDRO_815;
const double DENDRO_817 = 2 * DENDRO_46;
const double DENDRO_818 = At0 * DENDRO_810 + At3 * DENDRO_814 +
                          At5 * pow(DENDRO_46, 2) - DENDRO_242 * DENDRO_44 +
                          DENDRO_38 * DENDRO_817 - DENDRO_723 * DENDRO_817;
const double DENDRO_819 =
    At2 * DENDRO_810 - DENDRO_20 * DENDRO_729 + DENDRO_22 * DENDRO_726 -
...
const double DENDRO_821 = At1 * DENDRO_809;
...
const double DENDRO_830 = DENDRO_821 + DENDRO_822 - DENDRO_823 + DENDRO_824 -
                          ...
                          DENDRO_829;
const double DENDRO_831 = At4 * DENDRO_814;
...
const double DENDRO_840 = DENDRO_831 + DENDRO_832 - DENDRO_833 + DENDRO_834 -
                          ...
                          DENDRO_839;
const double DENDRO_841 = (1.0 / 3.0) * alpha;
const double DENDRO_842 = 2 * DENDRO_115;
const double DENDRO_843 = DENDRO_842 * grad_0_alpha;
const double DENDRO_844 = DENDRO_842 * grad_1_alpha;
const double DENDRO_845 = DENDRO_842 * grad_2_alpha;
const double DENDRO_846 = (7.0 / 3.0) * DENDRO_282;
const double DENDRO_847 = 4 * grad_0_K;
...
const double DENDRO_851 = 4 * grad_2_K;
const double DENDRO_852 = DENDRO_848 * DENDRO_98;
const double DENDRO_853 = 4 * grad_1_K;
...
const double DENDRO_866 = 2.0 * DENDRO_861 * alpha;
...
const double DENDRO_871 =
    ...
    DENDRO_192 * DENDRO_863 - 4.0 / 3.0 * DENDRO_288 * grad2_0_0_beta0 -
    DENDRO_290 * grad2_1_1_beta0 - DENDRO_292 * grad2_2_2_beta0 +
    DENDRO_357 * DENDRO_859 - DENDRO_357 * grad_0_beta0 -
    DENDRO_359 * grad_1_beta0 - DENDRO_361 * grad_2_beta0 +
    DENDRO_805 * grad2_1_2_beta0 - DENDRO_812 * DENDRO_843 -
    DENDRO_819 * DENDRO_845 - DENDRO_830 * DENDRO_844 -
    DENDRO_846 * grad2_0_2_beta0 -
    ...
    DENDRO_855 * grad2_0_1_beta1 - DENDRO_855 * grad2_0_2_beta2 -
    DENDRO_856 * grad2_1_2_beta1 - DENDRO_856 * grad2_2_2_beta2 +
    DENDRO_858 * grad2_1_1_beta1 + DENDRO_858 * grad2_1_2_beta2 +
    DENDRO_860 * grad2_0_1_beta0 + DENDRO_865 * DENDRO_94 + DENDRO_870;
...
const double DENDRO_880 = (1.0 / 3.0) * grad2_0_2_beta0;
const double DENDRO_881 = (1.0 / 3.0) * DENDRO_879;
const double DENDRO_882 = (7.0 / 3.0) * DENDRO_879;
const double DENDRO_883 =
    beta0 * grad_0_Gt1 + beta1 * grad_1_Gt1 + beta2 * grad_2_Gt1;
const double DENDRO_884 =
    DENDRO_105 * DENDRO_869 + DENDRO_206 * DENDRO_864 -
    DENDRO_288 * grad2_0_0_beta1 - 4.0 / 3.0 * DENDRO_290 * grad2_1_1_beta1 -
    DENDRO_292 * grad2_2_2_beta1 + DENDRO_62 * DENDRO_865 -
    DENDRO_807 * grad2_0_2_beta1 - DENDRO_816 * DENDRO_844 +
    DENDRO_858 * grad2_0_0_beta0 + DENDRO_858 * grad2_0_2_beta2 +
    DENDRO_860 * grad2_0_1_beta1 - DENDRO_878 * grad2_0_1_beta0 -
    DENDRO_878 * grad2_1_2_beta2 + DENDRO_879 * DENDRO_880 +
    DENDRO_881 * grad2_2_2_beta2 + DENDRO_882 * grad2_1_2_beta1 + DENDRO_883;
const double DENDRO_885 =
    beta0 * grad_0_Gt2 + beta1 * grad_1_Gt2 + beta2 * grad_2_Gt2;
const double DENDRO_886 =
    DENDRO_125 * DENDRO_867 + DENDRO_130 * DENDRO_869 +
    DENDRO_220 * DENDRO_868 + DENDRO_226 * DENDRO_864 +
    DENDRO_229 * DENDRO_863 - DENDRO_288 * grad2_0_0_beta2 -
    DENDRO_290 * grad2_1_1_beta2 - DENDRO_292 * DENDRO_880 -
    1.0 / 3.0 * DENDRO_292 * grad2_1_2_beta1 -
    4.0 / 3.0 * DENDRO_292 * grad2_2_2_beta2 - DENDRO_357 * grad_0_beta2 -
    DENDRO_359 * grad_1_beta2 + DENDRO_361 * DENDRO_859 -
    DENDRO_361 * grad_2_beta2 + DENDRO_808 * grad2_0_1_beta2 -
    DENDRO_818 * DENDRO_845 - DENDRO_819 * DENDRO_843 -
    DENDRO_840 * DENDRO_844 - DENDRO_846 * grad2_0_2_beta2 -
    ...
    DENDRO_856 * grad2_0_0_beta0 - DENDRO_856 * grad2_0_1_beta1 +
    DENDRO_865 * DENDRO_97 + DENDRO_881 * grad2_0_1_beta0 +
    DENDRO_881 * grad2_1_1_beta1 + DENDRO_882 * grad2_1_2_beta2 + DENDRO_885;

// Dendro: printing variables
//--
a_rhs[pp] =
    -DENDRO_0 * K + lambda[0] * (beta0 * grad_0_alpha + beta1 * grad_1_alpha +
                                 beta2 * grad_2_alpha);
//--
b_rhs0[pp] =
    B0 * DENDRO_1 + lambda[1] * (beta0 * grad_0_beta0 + beta1 * grad_1_beta0 +
                                 beta2 * grad_2_beta0);
//--
b_rhs1[pp] =
    B1 * DENDRO_1 + lambda[1] * (beta0 * grad_0_beta1 + beta1 * grad_1_beta1 +
                                 beta2 * grad_2_beta1);
//--
b_rhs2[pp] =
    B2 * DENDRO_1 + lambda[1] * (beta0 * grad_0_beta2 + beta1 * grad_1_beta2 +
                                 beta2 * grad_2_beta2);
//--
gt_rhs00[pp] = -At0 * DENDRO_0 + DENDRO_2 * gt0 + DENDRO_3 * grad_0_beta1 +
               DENDRO_4 * grad_0_beta2 - DENDRO_5 * grad_1_beta1 -
               DENDRO_5 * grad_2_beta2 + beta0 * grad_0_gt0 +
               beta1 * grad_1_gt0 + beta2 * grad_2_gt0;
//--
gt_rhs01[pp] = -At1 * DENDRO_0 + DENDRO_6 * grad_0_beta0 +
               DENDRO_6 * grad_1_beta1 - DENDRO_7 * gt1 + beta0 * grad_0_gt1 +
               beta1 * grad_1_gt1 + beta2 * grad_2_gt1 + grad_0_beta1 * gt3 +
               grad_0_beta2 * gt4 + grad_1_beta0 * gt0 + grad_1_beta2 * gt2;
//--
gt_rhs02[pp] = -At2 * DENDRO_0 + DENDRO_8 * grad_0_beta0 +
               DENDRO_8 * grad_2_beta2 - DENDRO_9 * gt2 + beta0 * grad_0_gt2 +
               beta1 * grad_1_gt2 + beta2 * grad_2_gt2 + grad_0_beta1 * gt4 +
               grad_0_beta2 * gt5 + grad_2_beta0 * gt0 + grad_2_beta1 * gt1;
//--
gt_rhs11[pp] = -At3 * DENDRO_0 - DENDRO_10 * gt3 + DENDRO_11 * gt3 +
               DENDRO_12 * grad_1_beta2 + DENDRO_3 * grad_1_beta0 -
               DENDRO_7 * gt3 + beta0 * grad_0_gt3 + beta1 * grad_1_gt3 +
               beta2 * grad_2_gt3;
//--
gt_rhs12[pp] = -At4 * DENDRO_0 - DENDRO_10 * gt4 + DENDRO_13 * grad_1_beta1 +
               DENDRO_13 * grad_2_beta2 + beta0 * grad_0_gt4 +
               beta1 * grad_1_gt4 + beta2 * grad_2_gt4 + grad_1_beta0 * gt2 +
               grad_1_beta2 * gt5 + grad_2_beta0 * gt1 + grad_2_beta1 * gt3;
//--
gt_rhs22[pp] = -At5 * DENDRO_0 - DENDRO_10 * gt5 + DENDRO_12 * grad_2_beta1 +
               DENDRO_14 * gt5 + DENDRO_4 * grad_2_beta0 - DENDRO_9 * gt5 +
               beta0 * grad_0_gt5 + beta1 * grad_1_gt5 + beta2 * grad_2_gt5;
//--
chi_rhs[pp] = -DENDRO_15 * DENDRO_16 + DENDRO_15 * K * alpha +
              beta0 * grad_0_chi + beta1 * grad_1_chi + beta2 * grad_2_chi;
//--
At_rhs00[pp] =
    At0 * DENDRO_2 - At0 * DENDRO_7 - At0 * DENDRO_9 +
    DENDRO_17 * grad_0_beta1 + DENDRO_18 * grad_0_beta2 +
    DENDRO_721 *
        (DENDRO_305 *
         ...
         DENDRO_63 * DENDRO_65 + DENDRO_720 * gt0 -
         DENDRO_77 * (-DENDRO_71 + DENDRO_75) -
         DENDRO_92 * (DENDRO_79 + DENDRO_81 - DENDRO_83 + DENDRO_91) -
         12 * grad2_0_0_alpha) -
    alpha * (-At0 * K + DENDRO_33 * (DENDRO_21 + DENDRO_23 - DENDRO_27) +
             DENDRO_43 * (DENDRO_34 + DENDRO_39 - DENDRO_41) +
             DENDRO_48 * (-At0 * DENDRO_37 + DENDRO_44 - DENDRO_47)) +
    beta0 * grad_0_At0 + beta1 * grad_1_At0 + beta2 * grad_2_At0;
//--
At_rhs01[pp] =
    At0 * grad_1_beta0 - At1 * DENDRO_7 + At2 * grad_1_beta2 +
        ...
        (DENDRO_305 *
             (DENDRO_117 * (-DENDRO_286 * DENDRO_740 + DENDRO_716) -
              ...
              DENDRO_160 * (-DENDRO_134 * DENDRO_617 - DENDRO_191 * DENDRO_75 +
                            DENDRO_679) -
              DENDRO_234 * (DENDRO_157 * grad_0_gt3 + DENDRO_272) +
              ...
              DENDRO_718 - DENDRO_752 * (DENDRO_143 * grad_0_gt3 + DENDRO_751) -
              DENDRO_752 * (DENDRO_134 * grad_1_gt5 + DENDRO_138 * grad_2_gt3 +
                            DENDRO_753) -
              DENDRO_754 * grad_0_gt1 - DENDRO_755 * grad_1_gt1 -
              DENDRO_756 * grad_2_gt1 -
         ...
         12 * grad2_0_1_alpha) +
    DENDRO_722 * grad_0_beta0 + DENDRO_722 * grad_1_beta1 -
    alpha * (-At1 * K + DENDRO_33 * DENDRO_725 + DENDRO_43 * DENDRO_728 +
             DENDRO_48 * DENDRO_730) +
    beta0 * grad_0_At1 + beta1 * grad_1_At1 + beta2 * grad_2_At1;
//--
At_rhs02[pp] =
    At0 * grad_2_beta0 + At1 * grad_2_beta1 - At2 * DENDRO_9 +
    ...
    DENDRO_721 *
        (DENDRO_305 *
             (-DENDRO_117 * (DENDRO_487 - DENDRO_488 + DENDRO_568) +
              ...
              DENDRO_165 * (DENDRO_157 * grad_0_gt5 + DENDRO_274) -
              ...
              DENDRO_754 * grad_0_gt2 - DENDRO_755 * grad_1_gt2 -
              DENDRO_756 * grad_2_gt2 -
         ...
         12 * grad2_0_2_alpha) +
    DENDRO_758 * grad_0_beta0 + DENDRO_758 * grad_2_beta2 -
    alpha * (-At2 * K + DENDRO_33 * DENDRO_760 + DENDRO_43 * DENDRO_762 +
             DENDRO_48 * DENDRO_763) +
    beta0 * grad_0_At2 + beta1 * grad_1_At2 + beta2 * grad_2_At2;
//--
At_rhs11[pp] =
    -At3 * DENDRO_10 + At3 * DENDRO_11 - At3 * DENDRO_7 +
    DENDRO_17 * grad_1_beta0 +
    DENDRO_721 *
        (DENDRO_305 *
             (-DENDRO_117 * (DENDRO_412 - 1.0 * DENDRO_414) +
              ...
              DENDRO_234 * (-DENDRO_134 * grad_2_gt3 + DENDRO_431) +
              DENDRO_234 * (-DENDRO_149 * grad_0_gt3 + DENDRO_428) -
              DENDRO_261 * DENDRO_747 * (DENDRO_182 + DENDRO_353) +
              6.0 * DENDRO_266 * DENDRO_740 * grad_1_gt3 +
              DENDRO_364 * (DENDRO_418 - DENDRO_782) +
              DENDRO_364 * (DENDRO_429 - DENDRO_736 * grad_0_gt3) +
              DENDRO_364 * (DENDRO_430 - DENDRO_747 * grad_2_gt3) -
              DENDRO_394 * DENDRO_757 + DENDRO_433 * DENDRO_736 + DENDRO_440 -
              DENDRO_754 * grad_0_gt3 - DENDRO_755 * grad_1_gt3 -
              DENDRO_756 * grad_2_gt3 -
         ...
         DENDRO_720 * gt3 + DENDRO_77 * (DENDRO_229 - DENDRO_731 * DENDRO_780) +
         DENDRO_781 *
             (DENDRO_192 - DENDRO_780 * (-DENDRO_86 + DENDRO_87 + DENDRO_88)) -
         12 * grad2_1_1_alpha) +
    DENDRO_777 * grad_1_beta2 -
    alpha * (-At3 * K + DENDRO_33 * DENDRO_728 + DENDRO_725 * DENDRO_778 +
             DENDRO_730 * DENDRO_779) +
    beta0 * grad_0_At3 + beta1 * grad_1_At3 + beta2 * grad_2_At3;
//--
At_rhs12[pp] =
    At1 * grad_2_beta0 + At2 * grad_1_beta0 + At3 * grad_2_beta1 -
    At4 * DENDRO_10 + At5 * grad_1_beta2 +
    DENDRO_721 *
        (DENDRO_305 *
             (DENDRO_117 * (DENDRO_183 * DENDRO_740 + DENDRO_644) +
              ...
              DENDRO_364 * (DENDRO_439 - DENDRO_740 * grad_1_gt5) -
              DENDRO_627 * DENDRO_757 + DENDRO_628 + DENDRO_652 -
              DENDRO_754 * grad_0_gt4 - DENDRO_755 * grad_1_gt4 -
              DENDRO_756 * grad_2_gt4 -
         ...
         12 * grad2_1_2_alpha) +
    DENDRO_787 * grad_1_beta1 + DENDRO_787 * grad_2_beta2 -
    alpha * (-At4 * K + DENDRO_33 * DENDRO_762 + DENDRO_760 * DENDRO_778 +
             DENDRO_763 * DENDRO_779) +
    beta0 * grad_0_At4 + beta1 * grad_1_At4 + beta2 * grad_2_At4;
//--
At_rhs22[pp] =
    -At5 * DENDRO_10 + At5 * DENDRO_14 - At5 * DENDRO_9 +
    DENDRO_18 * grad_2_beta0 +
    DENDRO_721 *
        (DENDRO_305 *
             (-DENDRO_117 * (DENDRO_343 - 1.0 * DENDRO_345) -
              DENDRO_117 * (0.25 * DENDRO_788 + 1.0 * DENDRO_792) +
              DENDRO_138 * DENDRO_372 * grad_0_gt5 + DENDRO_143 * DENDRO_370 +
              ...
              DENDRO_165 * (DENDRO_143 * grad_0_gt5 + DENDRO_768 * grad_2_gt0) +
              6.0 * DENDRO_260 * DENDRO_766 * grad_2_gt5 -
              DENDRO_261 * DENDRO_768 * (DENDRO_120 + DENDRO_322) +
              DENDRO_273 * DENDRO_747 * grad_1_gt5 - DENDRO_317 * DENDRO_757 -
              DENDRO_364 * (DENDRO_788 + DENDRO_792) -
              DENDRO_364 * (DENDRO_137 * DENDRO_768 + DENDRO_736 * grad_0_gt5) +
              DENDRO_369 * DENDRO_736 + DENDRO_387 - DENDRO_754 * grad_0_gt5 -
              DENDRO_755 * grad_1_gt5 - DENDRO_756 * grad_2_gt5 -
              DENDRO_99 * (DENDRO_185 * DENDRO_95 + DENDRO_206 * DENDRO_96 +
                           DENDRO_226 * DENDRO_98 + DENDRO_320)) +
         DENDRO_307 * DENDRO_65 + DENDRO_720 * gt5 -
         DENDRO_76 * (DENDRO_313 - DENDRO_314 + DENDRO_315 + DENDRO_318) -
         DENDRO_781 * (-DENDRO_310 + DENDRO_768) - 12 * grad2_2_2_alpha) +
    DENDRO_777 * grad_2_beta1 -
    alpha * (At5 * DENDRO_42 * DENDRO_763 - At5 * K + DENDRO_48 * DENDRO_762 +
             DENDRO_760 * DENDRO_779) +
    beta0 * grad_0_At5 + beta1 * grad_1_At5 + beta2 * grad_2_At5;
//--
K_rhs[pp] =
    -DENDRO_288 * chi *
        (DENDRO_798 * (DENDRO_443 + DENDRO_53 * DENDRO_802) +
         DENDRO_801 * (DENDRO_444 + DENDRO_53 * DENDRO_800) - grad2_0_0_alpha +
         grad_0_alpha *
    ...
    DENDRO_290 * chi *
        (DENDRO_796 * (DENDRO_398 + DENDRO_780 * DENDRO_794) +
         DENDRO_801 * (DENDRO_401 + DENDRO_780 * DENDRO_799) - grad2_1_1_alpha +
         grad_1_alpha *
    ...
    DENDRO_292 * chi *
        (DENDRO_796 * (DENDRO_326 + DENDRO_794 * DENDRO_795) +
         DENDRO_798 * (DENDRO_328 + DENDRO_795 * DENDRO_797) - grad2_2_2_alpha +
         grad_2_alpha * (DENDRO_32 * DENDRO_330 + DENDRO_32 * DENDRO_331 +
    ...
    DENDRO_805 * chi *
        (0.5 * DENDRO_796 * (DENDRO_623 + DENDRO_636 * DENDRO_794) +
         DENDRO_803 * (DENDRO_32 * DENDRO_624 -
                       DENDRO_52 * (-DENDRO_627 * DENDRO_797 + grad_2_chi) +
                       DENDRO_630) +
         DENDRO_804 * (DENDRO_32 * DENDRO_625 + DENDRO_32 * DENDRO_626 -
                       DENDRO_52 * (-DENDRO_627 * DENDRO_799 + grad_1_chi) +
                       DENDRO_632) -
         grad2_1_2_alpha) -
    DENDRO_807 * chi *
        (0.5 * DENDRO_798 * (DENDRO_524 + DENDRO_561 * DENDRO_797) +
         DENDRO_804 * (DENDRO_32 * DENDRO_526 + DENDRO_32 * DENDRO_527 -
                       DENDRO_52 * (-DENDRO_548 * DENDRO_799 + grad_0_chi) +
                       DENDRO_557) +
         DENDRO_806 * (DENDRO_32 * DENDRO_521 + DENDRO_32 * DENDRO_522 -
                       DENDRO_52 * (-DENDRO_548 * DENDRO_794 + grad_2_chi) +
                       DENDRO_552) -
         grad2_0_2_alpha) +
    DENDRO_808 * chi *
        (0.5 * DENDRO_801 * (DENDRO_686 + DENDRO_712 * DENDRO_799) +
         DENDRO_803 * (DENDRO_32 * DENDRO_685 -
                       DENDRO_52 * (-DENDRO_701 * DENDRO_797 + grad_0_chi) +
                       DENDRO_711) +
         DENDRO_806 * (DENDRO_32 * DENDRO_683 + DENDRO_32 * DENDRO_684 -
                       DENDRO_52 * (-DENDRO_701 * DENDRO_794 + grad_1_chi) +
                       DENDRO_703) -
         grad2_0_1_alpha) +
    DENDRO_841 *
        (At0 * DENDRO_812 * DENDRO_813 + At1 * DENDRO_820 * DENDRO_830 +
         At2 * DENDRO_819 * DENDRO_820 + At3 * DENDRO_813 * DENDRO_816 +
         At4 * DENDRO_820 * DENDRO_840 + At5 * DENDRO_813 * DENDRO_818 +
         pow(K, 2)) +
...
Gt_rhs1[pp] = -DENDRO_112 * DENDRO_866 * DENDRO_872 +
              DENDRO_195 * grad_0_beta1 - DENDRO_202 * DENDRO_866 * DENDRO_873 -
              DENDRO_214 * DENDRO_859 + DENDRO_214 * grad_1_beta1 +
              DENDRO_232 * grad_2_beta1 - DENDRO_740 * DENDRO_863 +
              DENDRO_843 * DENDRO_872 + DENDRO_845 * DENDRO_873 +
              DENDRO_850 * (DENDRO_876 - DENDRO_877) -
...
//--
B_rhs0[pp] =
    -B0 * eta - DENDRO_870 * lambda[3] + DENDRO_871 +
    lambda[2] * (beta0 * grad_0_B0 + beta1 * grad_1_B0 + beta2 * grad_2_B0);
//--
B_rhs1[pp] =
    -B1 * eta + DENDRO_112 * DENDRO_867 + DENDRO_202 * DENDRO_868 +
    DENDRO_211 * DENDRO_863 - DENDRO_357 * grad_0_beta1 +
    DENDRO_359 * DENDRO_859 - DENDRO_359 * grad_1_beta1 -
    DENDRO_361 * grad_2_beta1 - DENDRO_830 * DENDRO_843 -
...
//--
B_rhs2[pp] =
    -B2 * eta - DENDRO_885 * lambda[3] + DENDRO_886 +
