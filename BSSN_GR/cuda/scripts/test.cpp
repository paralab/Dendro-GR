...
// Dendro: printing variables
//--
b_rhs0[pp] = B0[pp]*DENDRO_0 + lambda[1]*(beta0[pp]*grad_0_beta0 + beta1[pp]*grad_1_beta0 + beta2[pp]*grad_2_beta0);
//--
b_rhs1[pp] = B1[pp]*DENDRO_0 + lambda[1]*(beta0[pp]*grad_0_beta1 + beta1[pp]*grad_1_beta1 + beta2[pp]*grad_2_beta1);
//--
b_rhs2[pp] = B2[pp]*DENDRO_0 + lambda[1]*(beta0[pp]*grad_0_beta2 + beta1[pp]*grad_1_beta2 + beta2[pp]*grad_2_beta2);
...
// Dendro: printing variables
//--
gt_rhs00[pp] = -At0[pp]*DENDRO_0 + DENDRO_1*grad_0_beta1 + DENDRO_2*grad_0_beta2 - DENDRO_3*grad_1_beta1 - DENDRO_3*grad_2_beta2 + beta0[pp]*grad_0_gt0 + beta1[pp]*grad_1_gt0 + beta2[pp]*grad_2_gt0 + (4.0/3.0)*grad_0_beta0*gt0[pp];
//--
gt_rhs01[pp] = -At1[pp]*DENDRO_0 + DENDRO_4*grad_0_beta0 + DENDRO_4*grad_1_beta1 - DENDRO_5*gt1[pp] + beta0[pp]*grad_0_gt1 + beta1[pp]*grad_1_gt1 + beta2[pp]*grad_2_gt1 + grad_0_beta1*gt3[pp] + grad_0_beta2*gt4[pp] + grad_1_beta0*gt0[pp] + grad_1_beta2*gt2[pp];
//--
gt_rhs02[pp] = -At2[pp]*DENDRO_0 + DENDRO_6*grad_0_beta0 + DENDRO_6*grad_2_beta2 - DENDRO_7*gt2[pp] + beta0[pp]*grad_0_gt2 + beta1[pp]*grad_1_gt2 + beta2[pp]*grad_2_gt2 + grad_0_beta1*gt4[pp] + grad_0_beta2*gt5[pp] + grad_2_beta0*gt0[pp] + grad_2_beta1*gt1[pp];
//--
gt_rhs11[pp] = -At3[pp]*DENDRO_0 + DENDRO_1*grad_1_beta0 - DENDRO_5*gt3[pp] - DENDRO_8*gt3[pp] + DENDRO_9*grad_1_beta2 + beta0[pp]*grad_0_gt3 + beta1[pp]*grad_1_gt3 + beta2[pp]*grad_2_gt3 + (4.0/3.0)*grad_1_beta1*gt3[pp];
//--
gt_rhs12[pp] = -At4[pp]*DENDRO_0 + DENDRO_10*grad_1_beta1 + DENDRO_10*grad_2_beta2 - DENDRO_8*gt4[pp] + beta0[pp]*grad_0_gt4 + beta1[pp]*grad_1_gt4 + beta2[pp]*grad_2_gt4 + grad_1_beta0*gt2[pp] + grad_1_beta2*gt5[pp] + grad_2_beta0*gt1[pp] + grad_2_beta1*gt3[pp];
//--
gt_rhs22[pp] = -At5[pp]*DENDRO_0 + DENDRO_2*grad_2_beta0 - DENDRO_7*gt5[pp] - DENDRO_8*gt5[pp] + DENDRO_9*grad_2_beta1 + beta0[pp]*grad_0_gt5 + beta1[pp]*grad_1_gt5 + beta2[pp]*grad_2_gt5 + (4.0/3.0)*grad_2_beta2*gt5[pp];
...
const double DENDRO_7 = At0[pp]*(DENDRO_igt0 * DENDRO_igt0) + At3[pp]*DENDRO_0 + 2*At4[pp]*DENDRO_6 + At5[pp]*DENDRO_1 + DENDRO_2*DENDRO_3 + DENDRO_4*DENDRO_5;
...
const double DENDRO_14 = At1[pp]*DENDRO_0 + At2[pp]*DENDRO_6 + DENDRO_10*DENDRO_igt3 + DENDRO_11*DENDRO_igt4 + DENDRO_12*DENDRO_igt3 + DENDRO_13*DENDRO_igt4 + DENDRO_2*DENDRO_igt3 + DENDRO_4*DENDRO_igt4 + DENDRO_9*DENDRO_igt1;
const double DENDRO_15 = 2*grad_1_alpha;
const double DENDRO_16 = At1[pp]*DENDRO_6 + At2[pp]*DENDRO_1 + DENDRO_10*DENDRO_igt4 + DENDRO_11*DENDRO_igt5 + DENDRO_12*DENDRO_igt4 + DENDRO_13*DENDRO_igt5 + DENDRO_2*DENDRO_igt4 + DENDRO_4*DENDRO_igt5 + DENDRO_9*DENDRO_igt2;
...
const double DENDRO_30 = (2.0/3.0)*grad_0_beta0 + (2.0/3.0)*grad_1_beta1 + (2.0/3.0)*grad_2_beta2;
...
const double DENDRO_39 = At0[pp]*DENDRO_0 + At3[pp]*(DENDRO_igt3 * DENDRO_igt3) + At5[pp]*DENDRO_35 + DENDRO_18*DENDRO_37 + DENDRO_18*DENDRO_38 + 2*DENDRO_36*DENDRO_igt3;
...
const double DENDRO_43 = At0[pp]*DENDRO_1 + At3[pp]*DENDRO_35 + At4[pp]*DENDRO_18*DENDRO_igt5 + At5[pp]*(DENDRO_igt5 * DENDRO_igt5) + DENDRO_18*DENDRO_41 + 2*DENDRO_42*DENDRO_igt5;
...
const double DENDRO_48 = At0[pp]*DENDRO_6 + At3[pp]*DENDRO_igt3*DENDRO_igt4 + At4[pp]*DENDRO_35 + At5[pp]*DENDRO_igt4*DENDRO_igt5 + DENDRO_36*DENDRO_igt4 + DENDRO_37*DENDRO_igt5 + DENDRO_38*DENDRO_igt5 + DENDRO_41*DENDRO_igt3 + DENDRO_42*DENDRO_igt4;
const double DENDRO_49 = DENDRO_45*DENDRO_48;
const double DENDRO_50 = beta0[pp]*grad_0_Gt0 + beta1[pp]*grad_1_Gt0 + beta2[pp]*grad_2_Gt0;
const double DENDRO_51 = -DENDRO_14*DENDRO_15 - DENDRO_16*DENDRO_17 + DENDRO_18*grad2_1_2_beta0 - DENDRO_22*(DENDRO_14*DENDRO_24 + DENDRO_23*DENDRO_igt1) - DENDRO_22*(DENDRO_16*DENDRO_26 + DENDRO_25*DENDRO_igt2) - DENDRO_22*(DENDRO_19*DENDRO_igt0 + DENDRO_21*DENDRO_7) + DENDRO_27*grad2_0_1_beta1 + DENDRO_27*grad2_0_2_beta2 + DENDRO_28*grad2_1_1_beta1 + DENDRO_28*grad2_1_2_beta2 + DENDRO_29*grad2_1_2_beta1 + DENDRO_29*grad2_2_2_beta2 + DENDRO_30*DENDRO_Gtk0 + DENDRO_31*grad2_0_1_beta0 + DENDRO_32*grad2_0_2_beta0 + DENDRO_34*DENDRO_C2_k0_0 + DENDRO_40*DENDRO_C2_k0_3 + DENDRO_44*DENDRO_C2_k0_5 + DENDRO_46*DENDRO_C2_k0_1 + DENDRO_47*DENDRO_C2_k0_2 + DENDRO_49*DENDRO_C2_k0_4 + DENDRO_50 - DENDRO_7*DENDRO_8 - DENDRO_Gtk0*grad_0_beta0 - DENDRO_Gtk1*grad_1_beta0 - DENDRO_Gtk2*grad_2_beta0 + (4.0/3.0)*DENDRO_igt0*grad2_0_0_beta0 + DENDRO_igt3*grad2_1_1_beta0 + DENDRO_igt5*grad2_2_2_beta0;
...
const double DENDRO_55 = beta0[pp]*grad_0_Gt1 + beta1[pp]*grad_1_Gt1 + beta2[pp]*grad_2_Gt1;
const double DENDRO_56 = -DENDRO_14*DENDRO_8 - DENDRO_15*DENDRO_39 - DENDRO_17*DENDRO_48 - DENDRO_22*(DENDRO_14*DENDRO_21 + DENDRO_19*DENDRO_igt1) - DENDRO_22*(DENDRO_23*DENDRO_igt3 + DENDRO_24*DENDRO_39) - DENDRO_22*(DENDRO_25*DENDRO_igt4 + DENDRO_26*DENDRO_48) + DENDRO_28*grad2_0_0_beta0 + DENDRO_28*grad2_0_2_beta2 + DENDRO_30*DENDRO_Gtk1 + DENDRO_31*grad2_0_1_beta1 + DENDRO_34*DENDRO_C2_k1_0 + DENDRO_40*DENDRO_C2_k1_3 + DENDRO_44*DENDRO_C2_k1_5 + DENDRO_46*DENDRO_C2_k1_1 + DENDRO_47*DENDRO_C2_k1_2 + DENDRO_49*DENDRO_C2_k1_4 + DENDRO_5*grad2_0_2_beta1 + DENDRO_52*grad2_0_1_beta0 + DENDRO_52*grad2_1_2_beta2 + DENDRO_53*grad2_0_2_beta0 + DENDRO_53*grad2_2_2_beta2 + DENDRO_54*grad2_1_2_beta1 + DENDRO_55 - DENDRO_Gtk0*grad_0_beta1 - DENDRO_Gtk1*grad_1_beta1 - DENDRO_Gtk2*grad_2_beta1 + DENDRO_igt0*grad2_0_0_beta1 + (4.0/3.0)*DENDRO_igt3*grad2_1_1_beta1 + DENDRO_igt5*grad2_2_2_beta1;
const double DENDRO_57 = (1.0/3.0)*DENDRO_igt5;
const double DENDRO_58 = beta0[pp]*grad_0_Gt2 + beta1[pp]*grad_1_Gt2 + beta2[pp]*grad_2_Gt2;
const double DENDRO_59 = -DENDRO_15*DENDRO_48 - DENDRO_16*DENDRO_8 - DENDRO_17*DENDRO_43 - DENDRO_22*(DENDRO_16*DENDRO_21 + DENDRO_19*DENDRO_igt2) - DENDRO_22*(DENDRO_23*DENDRO_igt4 + DENDRO_24*DENDRO_48) - DENDRO_22*(DENDRO_25*DENDRO_igt5 + DENDRO_26*DENDRO_43) + DENDRO_29*grad2_0_0_beta0 + DENDRO_29*grad2_0_1_beta1 + DENDRO_3*grad2_0_1_beta2 + DENDRO_30*DENDRO_Gtk2 + DENDRO_32*grad2_0_2_beta2 + DENDRO_34*DENDRO_C2_k2_0 + DENDRO_40*DENDRO_C2_k2_3 + DENDRO_44*DENDRO_C2_k2_5 + DENDRO_46*DENDRO_C2_k2_1 + DENDRO_47*DENDRO_C2_k2_2 + DENDRO_49*DENDRO_C2_k2_4 + DENDRO_53*grad2_0_1_beta0 + DENDRO_53*grad2_1_1_beta1 + DENDRO_54*grad2_1_2_beta2 + DENDRO_57*grad2_0_2_beta0 + DENDRO_57*grad2_1_2_beta1 + DENDRO_58 - DENDRO_Gtk0*grad_0_beta2 - DENDRO_Gtk1*grad_1_beta2 - DENDRO_Gtk2*grad_2_beta2 + DENDRO_igt0*grad2_0_0_beta2 + DENDRO_igt3*grad2_1_1_beta2 + (4.0/3.0)*DENDRO_igt5*grad2_2_2_beta2;
...
//--
B_rhs0[pp] = -B0[pp]*eta - DENDRO_50*lambda[3] + DENDRO_51 + lambda[2]*(beta0[pp]*grad_0_B0 + beta1[pp]*grad_1_B0 + beta2[pp]*grad_2_B0);
//--
B_rhs1[pp] = -B1[pp]*eta - DENDRO_55*lambda[3] + DENDRO_56 + lambda[2]*(beta0[pp]*grad_0_B1 + beta1[pp]*grad_1_B1 + beta2[pp]*grad_2_B1);
//--
B_rhs2[pp] = -B2[pp]*eta - DENDRO_58*lambda[3] + DENDRO_59 + lambda[2]*(beta0[pp]*grad_0_B2 + beta1[pp]*grad_1_B2 + beta2[pp]*grad_2_B2);
...
// Dendro: printing variables
//--
At_rhs00[pp] = (4.0/3.0)*At0[pp]*grad_0_beta0 - DENDRO_0*grad_1_beta1 - DENDRO_0*grad_2_beta2 + DENDRO_1*grad_0_beta1 + DENDRO_2*grad_0_beta2 + DENDRO_31*(-DENDRO_30*gt0[pp] + 3*DENDRO_6 + 3*DENDRO_7 + 3*DENDRO_8 + 3*DENDRO_9 - 3*grad2_0_0_alpha) - alpha[pp]*(-At0[pp]*K[pp] + DENDRO_1*(At0[pp]*DENDRO_igt1 + At1[pp]*DENDRO_igt3 + At2[pp]*DENDRO_igt4) + DENDRO_2*(At0[pp]*DENDRO_igt2 + At1[pp]*DENDRO_igt4 + At2[pp]*DENDRO_igt5) + DENDRO_5*(At0[pp]*DENDRO_igt0 + DENDRO_3 + DENDRO_4)) + beta0[pp]*grad_0_At0 + beta1[pp]*grad_1_At0 + beta2[pp]*grad_2_At0;
//--
At_rhs01[pp] = At0[pp]*grad_1_beta0 - At1[pp]*DENDRO_33 + At2[pp]*grad_1_beta2 + At3[pp]*grad_0_beta1 + At4[pp]*grad_0_beta2 + DENDRO_31*(3*DENDRO_18 + 3*DENDRO_19 + 3*DENDRO_20 + 3*DENDRO_21 - DENDRO_30*gt1[pp] - 3*grad2_0_1_alpha) + DENDRO_32*grad_0_beta0 + DENDRO_32*grad_1_beta1 - alpha[pp]*(-At1[pp]*K[pp] + DENDRO_1*DENDRO_36 + DENDRO_2*DENDRO_37 + DENDRO_34*DENDRO_5) + beta0[pp]*grad_0_At1 + beta1[pp]*grad_1_At1 + beta2[pp]*grad_2_At1;
//--
At_rhs02[pp] = At0[pp]*grad_2_beta0 + At1[pp]*grad_2_beta1 - At2[pp]*DENDRO_39 + At4[pp]*grad_0_beta1 + At5[pp]*grad_0_beta2 + DENDRO_31*(3*DENDRO_22 + 3*DENDRO_23 + 3*DENDRO_24 + 3*DENDRO_25 - DENDRO_30*gt2[pp] - 3*grad2_0_2_alpha) + DENDRO_38*grad_0_beta0 + DENDRO_38*grad_2_beta2 - alpha[pp]*(-At2[pp]*K[pp] + DENDRO_1*DENDRO_41 + DENDRO_2*DENDRO_42 + DENDRO_40*DENDRO_5) + beta0[pp]*grad_0_At2 + beta1[pp]*grad_1_At2 + beta2[pp]*grad_2_At2;
//--
At_rhs11[pp] = -At3[pp]*DENDRO_33 - At3[pp]*DENDRO_43 + (4.0/3.0)*At3[pp]*grad_1_beta1 + DENDRO_1*grad_1_beta0 + DENDRO_31*(3*DENDRO_10 + 3*DENDRO_11 + 3*DENDRO_12 + 3*DENDRO_13 - DENDRO_30*gt3[pp] - 3*grad2_1_1_alpha) + DENDRO_44*grad_1_beta2 - alpha[pp]*(-At3[pp]*K[pp] + DENDRO_1*DENDRO_34 + DENDRO_36*DENDRO_45 + DENDRO_37*DENDRO_44) + beta0[pp]*grad_0_At3 + beta1[pp]*grad_1_At3 + beta2[pp]*grad_2_At3;
//--
At_rhs12[pp] = At1[pp]*grad_2_beta0 + At2[pp]*grad_1_beta0 + At3[pp]*grad_2_beta1 - At4[pp]*DENDRO_43 + At5[pp]*grad_1_beta2 + DENDRO_31*(3*DENDRO_26 + 3*DENDRO_27 + 3*DENDRO_28 + 3*DENDRO_29 - DENDRO_30*gt4[pp] - 3*grad2_1_2_alpha) + DENDRO_46*grad_1_beta1 + DENDRO_46*grad_2_beta2 - alpha[pp]*(-At4[pp]*K[pp] + DENDRO_1*DENDRO_40 + DENDRO_41*DENDRO_45 + DENDRO_42*DENDRO_44) + beta0[pp]*grad_0_At4 + beta1[pp]*grad_1_At4 + beta2[pp]*grad_2_At4;
//--
At_rhs22[pp] = -At5[pp]*DENDRO_39 - At5[pp]*DENDRO_43 + (4.0/3.0)*At5[pp]*grad_2_beta2 + DENDRO_2*grad_2_beta0 + DENDRO_31*(3*DENDRO_14 + 3*DENDRO_15 + 3*DENDRO_16 + 3*DENDRO_17 - DENDRO_30*gt5[pp] - 3*grad2_2_2_alpha) + DENDRO_44*grad_2_beta1 - alpha[pp]*(2*At5[pp]*DENDRO_42 - At5[pp]*K[pp] + DENDRO_2*DENDRO_40 + DENDRO_41*DENDRO_44) + beta0[pp]*grad_0_At5 + beta1[pp]*grad_1_At5 + beta2[pp]*grad_2_At5;
