...
// Dendro: printing variables
//--
K_rhs[pp] = DENDRO_0*DENDRO_igt1*((deriv_evars->grad_0_alpha[d_pp])*DENDRO_C3_k0_1 + (deriv_evars->grad_1_alpha[d_pp])*DENDRO_C3_k1_1 + (deriv_evars->grad_2_alpha[d_pp])*DENDRO_C3_k2_1 - deriv_evars->grad2_0_1_alpha[d_pp]) + DENDRO_0*DENDRO_igt2*((deriv_evars->grad_0_alpha[d_pp])*DENDRO_C3_k0_2 + (deriv_evars->grad_1_alpha[d_pp])*DENDRO_C3_k1_2 + (deriv_evars->grad_2_alpha[d_pp])*DENDRO_C3_k2_2 - deriv_evars->grad2_0_2_alpha[d_pp]) + DENDRO_0*DENDRO_igt4*((deriv_evars->grad_0_alpha[d_pp])*DENDRO_C3_k0_4 + (deriv_evars->grad_1_alpha[d_pp])*DENDRO_C3_k1_4 + (deriv_evars->grad_2_alpha[d_pp])*DENDRO_C3_k2_4 - deriv_evars->grad2_1_2_alpha[d_pp]) + DENDRO_igt0*chi[pp]*((deriv_evars->grad_0_alpha[d_pp])*DENDRO_C3_k0_0 + (deriv_evars->grad_1_alpha[d_pp])*DENDRO_C3_k1_0 + (deriv_evars->grad_2_alpha[d_pp])*DENDRO_C3_k2_0 - deriv_evars->grad2_0_0_alpha[d_pp]) + DENDRO_igt3*chi[pp]*((deriv_evars->grad_0_alpha[d_pp])*DENDRO_C3_k0_3 + (deriv_evars->grad_1_alpha[d_pp])*DENDRO_C3_k1_3 + (deriv_evars->grad_2_alpha[d_pp])*DENDRO_C3_k2_3 - deriv_evars->grad2_1_1_alpha[d_pp]) + DENDRO_igt5*chi[pp]*((deriv_evars->grad_0_alpha[d_pp])*DENDRO_C3_k0_5 + (deriv_evars->grad_1_alpha[d_pp])*DENDRO_C3_k1_5 + (deriv_evars->grad_2_alpha[d_pp])*DENDRO_C3_k2_5 - deriv_evars->grad2_2_2_alpha[d_pp]) + K_rhs[pp];
