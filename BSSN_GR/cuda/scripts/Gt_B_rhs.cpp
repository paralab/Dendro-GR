...
const double DENDRO_30 = (2.0/3.0)*(deriv_evars->grad_0_beta0[d_pp]) + (2.0/3.0)*(deriv_evars->grad_1_beta1[d_pp]) + (2.0/3.0)*(deriv_evars->grad_2_beta2[d_pp]);
...
const double DENDRO_50 = (deriv_evars->grad_0_Gt0[d_pp])*beta0[pp] + (deriv_evars->grad_1_Gt0[d_pp])*beta1[pp] + (deriv_evars->grad_2_Gt0[d_pp])*beta2[pp];
const double DENDRO_51 = (1.0/3.0)*DENDRO_igt3;
const double DENDRO_52 = (1.0/3.0)*DENDRO_igt4;
const double DENDRO_53 = (7.0/3.0)*DENDRO_igt4;
const double DENDRO_54 = (deriv_evars->grad_0_Gt1[d_pp])*beta0[pp] + (deriv_evars->grad_1_Gt1[d_pp])*beta1[pp] + (deriv_evars->grad_2_Gt1[d_pp])*beta2[pp];
const double DENDRO_55 = (1.0/3.0)*DENDRO_igt5;
const double DENDRO_56 = (deriv_evars->grad_0_Gt2[d_pp])*beta0[pp] + (deriv_evars->grad_1_Gt2[d_pp])*beta1[pp] + (deriv_evars->grad_2_Gt2[d_pp])*beta2[pp];

// Dendro: printing variables
//--
Gt_rhs0[pp] = -(deriv_evars->grad_0_beta0[d_pp])*DENDRO_Gtk0 - (deriv_evars->grad_1_beta0[d_pp])*DENDRO_Gtk1 - (deriv_evars->grad_2_beta0[d_pp])*DENDRO_Gtk2 - DENDRO_14*DENDRO_15 - DENDRO_16*DENDRO_17 + DENDRO_18*deriv_evars->grad2_1_2_beta0[d_pp] - DENDRO_22*(DENDRO_14*DENDRO_24 + DENDRO_23*DENDRO_igt1) - DENDRO_22*(DENDRO_16*DENDRO_26 + DENDRO_25*DENDRO_igt2) - DENDRO_22*(DENDRO_19*DENDRO_igt0 + DENDRO_21*DENDRO_7) + DENDRO_27*deriv_evars->grad2_0_1_beta1[d_pp] + DENDRO_27*deriv_evars->grad2_0_2_beta2[d_pp] + DENDRO_28*deriv_evars->grad2_1_1_beta1[d_pp] + DENDRO_28*deriv_evars->grad2_1_2_beta2[d_pp] + DENDRO_29*deriv_evars->grad2_1_2_beta1[d_pp] + DENDRO_29*deriv_evars->grad2_2_2_beta2[d_pp] + DENDRO_30*DENDRO_Gtk0 + DENDRO_31*deriv_evars->grad2_0_1_beta0[d_pp] + DENDRO_32*deriv_evars->grad2_0_2_beta0[d_pp] + DENDRO_34*DENDRO_C2_k0_0 + DENDRO_40*DENDRO_C2_k0_3 + DENDRO_44*DENDRO_C2_k0_5 + DENDRO_46*DENDRO_C2_k0_1 + DENDRO_47*DENDRO_C2_k0_2 + DENDRO_49*DENDRO_C2_k0_4 + DENDRO_50 - DENDRO_7*DENDRO_8 + (4.0/3.0)*DENDRO_igt0*deriv_evars->grad2_0_0_beta0[d_pp] + DENDRO_igt3*deriv_evars->grad2_1_1_beta0[d_pp] + DENDRO_igt5*deriv_evars->grad2_2_2_beta0[d_pp];
//--
Gt_rhs1[pp] = -(deriv_evars->grad_0_beta1[d_pp])*DENDRO_Gtk0 - (deriv_evars->grad_1_beta1[d_pp])*DENDRO_Gtk1 - (deriv_evars->grad_2_beta1[d_pp])*DENDRO_Gtk2 - DENDRO_14*DENDRO_8 - DENDRO_15*DENDRO_39 - DENDRO_17*DENDRO_48 - DENDRO_22*(DENDRO_14*DENDRO_21 + DENDRO_19*DENDRO_igt1) - DENDRO_22*(DENDRO_23*DENDRO_igt3 + DENDRO_24*DENDRO_39) - DENDRO_22*(DENDRO_25*DENDRO_igt4 + DENDRO_26*DENDRO_48) + DENDRO_28*deriv_evars->grad2_0_0_beta0[d_pp] + DENDRO_28*deriv_evars->grad2_0_2_beta2[d_pp] + DENDRO_30*DENDRO_Gtk1 + DENDRO_31*deriv_evars->grad2_0_1_beta1[d_pp] + DENDRO_34*DENDRO_C2_k1_0 + DENDRO_40*DENDRO_C2_k1_3 + DENDRO_44*DENDRO_C2_k1_5 + DENDRO_46*DENDRO_C2_k1_1 + DENDRO_47*DENDRO_C2_k1_2 + DENDRO_49*DENDRO_C2_k1_4 + DENDRO_5*deriv_evars->grad2_0_2_beta1[d_pp] + DENDRO_51*deriv_evars->grad2_0_1_beta0[d_pp] + DENDRO_51*deriv_evars->grad2_1_2_beta2[d_pp] + DENDRO_52*deriv_evars->grad2_0_2_beta0[d_pp] + DENDRO_52*deriv_evars->grad2_2_2_beta2[d_pp] + DENDRO_53*deriv_evars->grad2_1_2_beta1[d_pp] + DENDRO_54 + DENDRO_igt0*deriv_evars->grad2_0_0_beta1[d_pp] + (4.0/3.0)*DENDRO_igt3*deriv_evars->grad2_1_1_beta1[d_pp] + DENDRO_igt5*deriv_evars->grad2_2_2_beta1[d_pp];
//--
Gt_rhs2[pp] = -(deriv_evars->grad_0_beta2[d_pp])*DENDRO_Gtk0 - (deriv_evars->grad_1_beta2[d_pp])*DENDRO_Gtk1 - (deriv_evars->grad_2_beta2[d_pp])*DENDRO_Gtk2 - DENDRO_15*DENDRO_48 - DENDRO_16*DENDRO_8 - DENDRO_17*DENDRO_43 - DENDRO_22*(DENDRO_16*DENDRO_21 + DENDRO_19*DENDRO_igt2) - DENDRO_22*(DENDRO_23*DENDRO_igt4 + DENDRO_24*DENDRO_48) - DENDRO_22*(DENDRO_25*DENDRO_igt5 + DENDRO_26*DENDRO_43) + DENDRO_29*deriv_evars->grad2_0_0_beta0[d_pp] + DENDRO_29*deriv_evars->grad2_0_1_beta1[d_pp] + DENDRO_3*deriv_evars->grad2_0_1_beta2[d_pp] + DENDRO_30*DENDRO_Gtk2 + DENDRO_32*deriv_evars->grad2_0_2_beta2[d_pp] + DENDRO_34*DENDRO_C2_k2_0 + DENDRO_40*DENDRO_C2_k2_3 + DENDRO_44*DENDRO_C2_k2_5 + DENDRO_46*DENDRO_C2_k2_1 + DENDRO_47*DENDRO_C2_k2_2 + DENDRO_49*DENDRO_C2_k2_4 + DENDRO_52*deriv_evars->grad2_0_1_beta0[d_pp] + DENDRO_52*deriv_evars->grad2_1_1_beta1[d_pp] + DENDRO_53*deriv_evars->grad2_1_2_beta2[d_pp] + DENDRO_55*deriv_evars->grad2_0_2_beta0[d_pp] + DENDRO_55*deriv_evars->grad2_1_2_beta1[d_pp] + DENDRO_56 + DENDRO_igt0*deriv_evars->grad2_0_0_beta2[d_pp] + DENDRO_igt3*deriv_evars->grad2_1_1_beta2[d_pp] + (4.0/3.0)*DENDRO_igt5*deriv_evars->grad2_2_2_beta2[d_pp];
//--
B_rhs0[pp] = -B0[pp]*eta - DENDRO_50*lambda[3] + Gt_rhs0[pp] + lambda[2]*((deriv_evars->grad_0_B0[d_pp])*beta0[pp] + (deriv_evars->grad_1_B0[d_pp])*beta1[pp] + (deriv_evars->grad_2_B0[d_pp])*beta2[pp]);
//--
B_rhs1[pp] = -B1[pp]*eta - DENDRO_54*lambda[3] + Gt_rhs1[pp] + lambda[2]*((deriv_evars->grad_0_B1[d_pp])*beta0[pp] + (deriv_evars->grad_1_B1[d_pp])*beta1[pp] + (deriv_evars->grad_2_B1[d_pp])*beta2[pp]);
//--
B_rhs2[pp] = -B2[pp]*eta - DENDRO_56*lambda[3] + Gt_rhs2[pp] + lambda[2]*((deriv_evars->grad_0_B2[d_pp])*beta0[pp] + (deriv_evars->grad_1_B2[d_pp])*beta1[pp] + (deriv_evars->grad_2_B2[d_pp])*beta2[pp]);
