...

{
    ...
    const double DENDRO_54 = (deriv_evars->grad_0_Gt1[d_pp]) * beta0[pp] +
                             (deriv_evars->grad_1_Gt1[d_pp]) * beta1[pp] +
                             (deriv_evars->grad_2_Gt1[d_pp]) * beta2[pp];
    const double DENDRO_55 = (1.0 / 3.0) * DENDRO_igt5;
    const double DENDRO_56 = (deriv_evars->grad_0_Gt2[d_pp]) * beta0[pp] +
    ...
    Gt_rhs1[pp] =
        ...
        DENDRO_51 * deriv_evars->grad2_0_1_beta0[d_pp] +
        DENDRO_51 * deriv_evars->grad2_1_2_beta2[d_pp] +
        DENDRO_52 * deriv_evars->grad2_0_2_beta0[d_pp] +
        DENDRO_52 * deriv_evars->grad2_2_2_beta2[d_pp] +
        DENDRO_53 * deriv_evars->grad2_1_2_beta1[d_pp] + DENDRO_54 +
    ...
    Gt_rhs2[pp] =
        ...
        DENDRO_52 * deriv_evars->grad2_1_1_beta1[d_pp] +
        DENDRO_53 * deriv_evars->grad2_1_2_beta2[d_pp] +
        DENDRO_55 * deriv_evars->grad2_0_2_beta0[d_pp] +
        DENDRO_55 * deriv_evars->grad2_1_2_beta1[d_pp] + DENDRO_56 +
