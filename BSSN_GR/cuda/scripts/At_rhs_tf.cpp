...

{
    ...
    // Dendro: printing temp variables
    const double DENDRO_0 = (deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_0 +
    ...
    At_rhs00[pp] =
        ...
        (DENDRO_0 +
         (1.0 / 3.0) * alpha[pp] *
             (3 * DENDRO_RIJ0 -
              gt0[pp] *
                  (DENDRO_1 * DENDRO_RIJ1 + DENDRO_2 * DENDRO_RIJ2 +
                   DENDRO_3 * DENDRO_RIJ4 + DENDRO_RIJ0 * DENDRO_igt0 +
                   DENDRO_RIJ3 * DENDRO_igt3 + DENDRO_RIJ5 * DENDRO_igt5)) -
         1.0 / 3.0 * gt0[pp] *
             (DENDRO_0 * DENDRO_igt0 +
              DENDRO_1 * ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_1 +
                          (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_1 +
                          (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_1 -
                          deriv_evars->grad2_0_1_alpha[d_pp]) +
              DENDRO_2 * ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_2 +
                          (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_2 +
                          (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_2 -
                          deriv_evars->grad2_0_2_alpha[d_pp]) +
              DENDRO_3 * ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_4 +
...

{
    ...
    // Dendro: original ops: 86
    // Dendro: printing temp variables
    const double DENDRO_0 = (deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_1 +
                            (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_1 +
                            (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_1 -
                            deriv_evars->grad2_0_1_alpha[d_pp];
    const double DENDRO_1 = 2 * DENDRO_igt1;
    ...
    At_rhs02[pp] =
        ...
        (DENDRO_1 +
         (1.0 / 3.0) * alpha[pp] *
             (3 * DENDRO_RIJ2 -
              gt2[pp] *
                  (DENDRO_0 * DENDRO_RIJ1 + DENDRO_2 * DENDRO_RIJ2 +
                   DENDRO_3 * DENDRO_RIJ4 + DENDRO_RIJ0 * DENDRO_igt0 +
                   DENDRO_RIJ3 * DENDRO_igt3 + DENDRO_RIJ5 * DENDRO_igt5)) -
         1.0 / 3.0 * gt2[pp] *
             (DENDRO_0 * ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_1 +
                          (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_1 +
                          (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_1 -
                          deriv_evars->grad2_0_1_alpha[d_pp]) +
              DENDRO_1 * DENDRO_2 +
...

{
    ...
    // Dendro: original ops: 86
    // Dendro: printing temp variables
    const double DENDRO_0 = (deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_3 +
                            (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_3 +
                            (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_3 -
                            deriv_evars->grad2_1_1_alpha[d_pp];
    const double DENDRO_1 = 2 * DENDRO_igt1;
...

{
    ...
    const double DENDRO_2 = (deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_4 +
                            (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_4 +
                            (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_4 -
                            deriv_evars->grad2_1_2_alpha[d_pp];
    const double DENDRO_3 = 2 * DENDRO_igt4;
    ...
    At_rhs12[pp] =
        ...
        (DENDRO_2 +
         (1.0 / 3.0) * alpha[pp] *
             (3 * DENDRO_RIJ4 -
              gt4[pp] *
                  (DENDRO_0 * DENDRO_RIJ1 + DENDRO_1 * DENDRO_RIJ2 +
                   DENDRO_3 * DENDRO_RIJ4 + DENDRO_RIJ0 * DENDRO_igt0 +
                   DENDRO_RIJ3 * DENDRO_igt3 + DENDRO_RIJ5 * DENDRO_igt5)) -
         1.0 / 3.0 * gt4[pp] *
             (DENDRO_0 * ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_1 +
                          ...
                          (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_1 -
                          deriv_evars->grad2_0_1_alpha[d_pp]) +
              DENDRO_1 * ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_2 +
                          (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_2 +
                          (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_2 -
                          deriv_evars->grad2_0_2_alpha[d_pp]) +
              DENDRO_2 * DENDRO_3 +
...

{
    ...
    // Dendro: original ops: 86
    // Dendro: printing temp variables
    const double DENDRO_0 = (deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_5 +
                            (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_5 +
                            (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_5 -
                            deriv_evars->grad2_2_2_alpha[d_pp];
    const double DENDRO_1 = 2 * DENDRO_igt1;
