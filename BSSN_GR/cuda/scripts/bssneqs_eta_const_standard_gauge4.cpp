...
}
{
    ...
    gt_rhs00[pp] = (4.0 / 3.0) * (deriv_evars->grad_0_beta0[d_pp]) * gt0[pp] +
                   2 * (deriv_evars->grad_0_beta1[d_pp]) * gt1[pp] +
                   2 * (deriv_evars->grad_0_beta2[d_pp]) * gt2[pp] +
                   (deriv_evars->grad_0_gt0[d_pp]) * beta0[pp] -
                   (deriv_evars->grad_1_beta1[d_pp]) * DENDRO_0 +
                   (deriv_evars->grad_1_gt0[d_pp]) * beta1[pp] -
                   (deriv_evars->grad_2_beta2[d_pp]) * DENDRO_0 +
...
}
{
    ...
    // Dendro: printing variables
    //--
    gt_rhs01[pp]          = (deriv_evars->grad_0_beta0[d_pp]) * DENDRO_0 +
                   ...
                   2.0 / 3.0 * (deriv_evars->grad_2_beta2[d_pp]) * gt1[pp] +
...
}
{
    ...
    // Dendro: printing variables
    //--
    gt_rhs11[pp]          = -(deriv_evars->grad_0_beta0[d_pp]) * DENDRO_0 +
                   (deriv_evars->grad_0_gt3[d_pp]) * beta0[pp] +
                   2 * (deriv_evars->grad_1_beta0[d_pp]) * gt1[pp] +
                   (4.0 / 3.0) * (deriv_evars->grad_1_beta1[d_pp]) * gt3[pp] +
                   2 * (deriv_evars->grad_1_beta2[d_pp]) * gt4[pp] +
...
}
{
    ...
    // Dendro: printing variables
    //--
    gt_rhs12[pp] = -2.0 / 3.0 * (deriv_evars->grad_0_beta0[d_pp]) * gt4[pp] +
                   (deriv_evars->grad_0_gt4[d_pp]) * beta0[pp] +
...
}
{
    ...
    // Dendro: printing variables
    //--
    gt_rhs22[pp]          = -(deriv_evars->grad_0_beta0[d_pp]) * DENDRO_0 +
                   (deriv_evars->grad_0_gt5[d_pp]) * beta0[pp] -
                   (deriv_evars->grad_1_beta1[d_pp]) * DENDRO_0 +
                   (deriv_evars->grad_1_gt5[d_pp]) * beta1[pp] +
                   2 * (deriv_evars->grad_2_beta0[d_pp]) * gt2[pp] +
                   2 * (deriv_evars->grad_2_beta1[d_pp]) * gt4[pp] +
...
}
{
    ...
    chi_rhs[pp]           = (deriv_evars->grad_0_chi[d_pp]) * beta0[pp] +
                  ...
                  DENDRO_0 * K[pp] * alpha[pp] -
                  DENDRO_0 * ((deriv_evars->grad_0_beta0[d_pp]) +
...
}
{
    ...
    DENDRO_RIJ0 =
        -1.0 / 4.0 *
        (-DENDRO_0 *
             (4.0 * (deriv_evars->grad_0_Gt0[d_pp]) * gt0[pp] +
              4.0 * (deriv_evars->grad_0_Gt1[d_pp]) * gt1[pp] +
              4.0 * (deriv_evars->grad_0_Gt2[d_pp]) * gt2[pp] +
              ...
              2.0 * DENDRO_igt0 * deriv_evars->grad2_0_0_gt0[d_pp] -
              4.0 * DENDRO_igt1 * deriv_evars->grad2_0_1_gt0[d_pp] -
              4.0 * DENDRO_igt2 * deriv_evars->grad2_0_2_gt0[d_pp] -
              2.0 * DENDRO_igt3 * deriv_evars->grad2_1_1_gt0[d_pp] -
              4.0 * DENDRO_igt4 * deriv_evars->grad2_1_2_gt0[d_pp] -
              2.0 * DENDRO_igt5 * deriv_evars->grad2_2_2_gt0[d_pp]) +
         DENDRO_1 +
         DENDRO_2 * ((deriv_evars->grad_0_chi[d_pp]) * DENDRO_C2_k0_0 +
                     (deriv_evars->grad_1_chi[d_pp]) * DENDRO_C2_k1_0 +
                     (deriv_evars->grad_2_chi[d_pp]) * DENDRO_C2_k2_0 -
                     deriv_evars->grad2_0_0_chi[d_pp]) +
         gt0[pp] *
             (DENDRO_2 * ((deriv_evars->grad_0_chi[d_pp]) * DENDRO_8 +
                          (deriv_evars->grad_1_chi[d_pp]) * DENDRO_10 +
                          (deriv_evars->grad_2_chi[d_pp]) * DENDRO_12) +
              DENDRO_4 * ((deriv_evars->grad_1_chi[d_pp]) * DENDRO_3 -
                          DENDRO_2 * deriv_evars->grad2_0_1_chi[d_pp]) +
              DENDRO_5 * ((deriv_evars->grad_2_chi[d_pp]) * DENDRO_3 -
                          DENDRO_2 * deriv_evars->grad2_0_2_chi[d_pp]) +
              DENDRO_6 * (3 * (deriv_evars->grad_1_chi[d_pp]) *
                              (deriv_evars->grad_2_chi[d_pp]) -
                          DENDRO_2 * deriv_evars->grad2_1_2_chi[d_pp]) +
              DENDRO_igt0 *
                  (3 * DENDRO_1 - DENDRO_2 * deriv_evars->grad2_0_0_chi[d_pp]) +
...
}
{
    ...
    const double DENDRO_0 = pow(chi[pp], 2);
    const double DENDRO_1 =
        (deriv_evars->grad_0_chi[d_pp]) * (deriv_evars->grad_1_chi[d_pp]);
    const double DENDRO_2 = 2 * chi[pp];
    ...
    DENDRO_RIJ1 =
        -1.0 / 4.0 *
        (-DENDRO_0 *
             ((deriv_evars->grad_0_Gt0[d_pp]) * DENDRO_10 +
              2.0 * (deriv_evars->grad_0_Gt1[d_pp]) * gt3[pp] +
              2.0 * (deriv_evars->grad_0_Gt2[d_pp]) * gt4[pp] +
              2.0 * (deriv_evars->grad_1_Gt0[d_pp]) * gt0[pp] +
              (deriv_evars->grad_1_Gt1[d_pp]) * DENDRO_10 +
              2.0 * (deriv_evars->grad_1_Gt2[d_pp]) * gt2[pp] +
              ...
              2.0 * DENDRO_igt0 * deriv_evars->grad2_0_0_gt1[d_pp] -
              4.0 * DENDRO_igt1 * deriv_evars->grad2_0_1_gt1[d_pp] -
              4.0 * DENDRO_igt2 * deriv_evars->grad2_0_2_gt1[d_pp] -
              2.0 * DENDRO_igt3 * deriv_evars->grad2_1_1_gt1[d_pp] -
              4.0 * DENDRO_igt4 * deriv_evars->grad2_1_2_gt1[d_pp] -
              2.0 * DENDRO_igt5 * deriv_evars->grad2_2_2_gt1[d_pp]) +
         DENDRO_1 +
         DENDRO_2 * ((deriv_evars->grad_0_chi[d_pp]) * DENDRO_C2_k0_1 +
                     (deriv_evars->grad_1_chi[d_pp]) * DENDRO_C2_k1_1 +
                     (deriv_evars->grad_2_chi[d_pp]) * DENDRO_C2_k2_1 -
                     deriv_evars->grad2_0_1_chi[d_pp]) +
         gt1[pp] *
             (DENDRO_2 * ((deriv_evars->grad_0_chi[d_pp]) * DENDRO_7 +
                          (deriv_evars->grad_1_chi[d_pp]) * DENDRO_8 +
                          (deriv_evars->grad_2_chi[d_pp]) * DENDRO_9) +
              DENDRO_3 *
                  (3 * DENDRO_1 - DENDRO_2 * deriv_evars->grad2_0_1_chi[d_pp]) +
              DENDRO_5 * ((deriv_evars->grad_0_chi[d_pp]) * DENDRO_4 -
                          DENDRO_2 * deriv_evars->grad2_0_2_chi[d_pp]) +
              DENDRO_6 * ((deriv_evars->grad_1_chi[d_pp]) * DENDRO_4 -
                          DENDRO_2 * deriv_evars->grad2_1_2_chi[d_pp]) +
         ...
         gt2[pp] *
             (DENDRO_2 * ((deriv_evars->grad_0_chi[d_pp]) * DENDRO_7 +
              ...
              DENDRO_4 * ((deriv_evars->grad_0_chi[d_pp]) * DENDRO_3 -
                          DENDRO_2 * deriv_evars->grad2_0_1_chi[d_pp]) +
              DENDRO_5 *
                  (3 * DENDRO_1 - DENDRO_2 * deriv_evars->grad2_0_2_chi[d_pp]) +
...
}
{
    ...
    DENDRO_RIJ3 =
        -1.0 / 4.0 *
        (-DENDRO_0 *
             (4.0 * (deriv_evars->grad_1_Gt0[d_pp]) * gt1[pp] +
              4.0 * (deriv_evars->grad_1_Gt1[d_pp]) * gt3[pp] +
              4.0 * (deriv_evars->grad_1_Gt2[d_pp]) * gt4[pp] +
              ...
              2.0 * DENDRO_igt0 * deriv_evars->grad2_0_0_gt3[d_pp] -
              4.0 * DENDRO_igt1 * deriv_evars->grad2_0_1_gt3[d_pp] -
              4.0 * DENDRO_igt2 * deriv_evars->grad2_0_2_gt3[d_pp] -
              2.0 * DENDRO_igt3 * deriv_evars->grad2_1_1_gt3[d_pp] -
              4.0 * DENDRO_igt4 * deriv_evars->grad2_1_2_gt3[d_pp] -
              2.0 * DENDRO_igt5 * deriv_evars->grad2_2_2_gt3[d_pp]) +
         DENDRO_1 +
         DENDRO_2 * ((deriv_evars->grad_0_chi[d_pp]) * DENDRO_C2_k0_3 +
                     (deriv_evars->grad_1_chi[d_pp]) * DENDRO_C2_k1_3 +
                     (deriv_evars->grad_2_chi[d_pp]) * DENDRO_C2_k2_3 -
                     deriv_evars->grad2_1_1_chi[d_pp]) +
         gt3[pp] *
             (DENDRO_2 * ((deriv_evars->grad_0_chi[d_pp]) * DENDRO_8 +
                          (deriv_evars->grad_1_chi[d_pp]) * DENDRO_10 +
                          (deriv_evars->grad_2_chi[d_pp]) * DENDRO_12) +
              ...
              DENDRO_igt0 * (3 * pow((deriv_evars->grad_0_chi[d_pp]), 2) -
                             DENDRO_2 * deriv_evars->grad2_0_0_chi[d_pp]) +
              DENDRO_igt3 *
                  (3 * DENDRO_1 - DENDRO_2 * deriv_evars->grad2_1_1_chi[d_pp]) +
              DENDRO_igt5 * (3 * pow((deriv_evars->grad_2_chi[d_pp]), 2) -
                             DENDRO_2 * deriv_evars->grad2_2_2_chi[d_pp]))) /
        DENDRO_0;
    // Dendro: reduced ops: 264
...
}
{
    ...
    const double DENDRO_0 = pow(chi[pp], 2);
    const double DENDRO_1 =
        (deriv_evars->grad_1_chi[d_pp]) * (deriv_evars->grad_2_chi[d_pp]);
    const double DENDRO_2 = 2 * chi[pp];
    const double DENDRO_3 = 3 * (deriv_evars->grad_0_chi[d_pp]);
    const double DENDRO_4 = 2 * DENDRO_igt1;
    const double DENDRO_5 = 2 * DENDRO_igt2;
    ...
    DENDRO_RIJ4 =
        -1.0 / 4.0 *
        (-DENDRO_0 *
             (2.0 * (deriv_evars->grad_1_Gt0[d_pp]) * gt2[pp] +
              (deriv_evars->grad_1_Gt1[d_pp]) * DENDRO_10 +
              2.0 * (deriv_evars->grad_1_Gt2[d_pp]) * gt5[pp] +
              2.0 * (deriv_evars->grad_2_Gt0[d_pp]) * gt1[pp] +
              2.0 * (deriv_evars->grad_2_Gt1[d_pp]) * gt3[pp] +
              (deriv_evars->grad_2_Gt2[d_pp]) * DENDRO_10 +
              ...
              2.0 * DENDRO_igt0 * deriv_evars->grad2_0_0_gt4[d_pp] -
              4.0 * DENDRO_igt1 * deriv_evars->grad2_0_1_gt4[d_pp] -
              4.0 * DENDRO_igt2 * deriv_evars->grad2_0_2_gt4[d_pp] -
              2.0 * DENDRO_igt3 * deriv_evars->grad2_1_1_gt4[d_pp] -
              4.0 * DENDRO_igt4 * deriv_evars->grad2_1_2_gt4[d_pp] -
              2.0 * DENDRO_igt5 * deriv_evars->grad2_2_2_gt4[d_pp]) +
         DENDRO_1 +
         DENDRO_2 * ((deriv_evars->grad_0_chi[d_pp]) * DENDRO_C2_k0_4 +
                     (deriv_evars->grad_1_chi[d_pp]) * DENDRO_C2_k1_4 +
                     (deriv_evars->grad_2_chi[d_pp]) * DENDRO_C2_k2_4 -
                     deriv_evars->grad2_1_2_chi[d_pp]) +
         gt4[pp] *
             (DENDRO_2 * ((deriv_evars->grad_0_chi[d_pp]) * DENDRO_7 +
                          (deriv_evars->grad_1_chi[d_pp]) * DENDRO_8 +
                          (deriv_evars->grad_2_chi[d_pp]) * DENDRO_9) +
              ...
              DENDRO_5 * ((deriv_evars->grad_2_chi[d_pp]) * DENDRO_3 -
                          DENDRO_2 * deriv_evars->grad2_0_2_chi[d_pp]) +
              DENDRO_6 *
                  (3 * DENDRO_1 - DENDRO_2 * deriv_evars->grad2_1_2_chi[d_pp]) +
              DENDRO_igt0 * (3 * pow((deriv_evars->grad_0_chi[d_pp]), 2) -
                             DENDRO_2 * deriv_evars->grad2_0_0_chi[d_pp]) +
              DENDRO_igt3 * (3 * pow((deriv_evars->grad_1_chi[d_pp]), 2) -
                             DENDRO_2 * deriv_evars->grad2_1_1_chi[d_pp]) +
...
}
{
    ...
    DENDRO_RIJ5 =
        -1.0 / 4.0 *
        (-DENDRO_0 *
             (4.0 * (deriv_evars->grad_2_Gt0[d_pp]) * gt2[pp] +
              4.0 * (deriv_evars->grad_2_Gt1[d_pp]) * gt4[pp] +
              4.0 * (deriv_evars->grad_2_Gt2[d_pp]) * gt5[pp] +
              ...
              2.0 * DENDRO_igt0 * deriv_evars->grad2_0_0_gt5[d_pp] -
              4.0 * DENDRO_igt1 * deriv_evars->grad2_0_1_gt5[d_pp] -
              4.0 * DENDRO_igt2 * deriv_evars->grad2_0_2_gt5[d_pp] -
              2.0 * DENDRO_igt3 * deriv_evars->grad2_1_1_gt5[d_pp] -
              4.0 * DENDRO_igt4 * deriv_evars->grad2_1_2_gt5[d_pp] -
              2.0 * DENDRO_igt5 * deriv_evars->grad2_2_2_gt5[d_pp]) +
         DENDRO_1 +
         DENDRO_2 * ((deriv_evars->grad_0_chi[d_pp]) * DENDRO_C2_k0_5 +
                     (deriv_evars->grad_1_chi[d_pp]) * DENDRO_C2_k1_5 +
                     (deriv_evars->grad_2_chi[d_pp]) * DENDRO_C2_k2_5 -
                     deriv_evars->grad2_2_2_chi[d_pp]) +
         gt5[pp] *
             (DENDRO_2 * ((deriv_evars->grad_0_chi[d_pp]) * DENDRO_8 +
                          (deriv_evars->grad_1_chi[d_pp]) * DENDRO_10 +
                          (deriv_evars->grad_2_chi[d_pp]) * DENDRO_12) +
...

{
    ...
    //--
    At_rhs00[pp] =
        (deriv_evars->grad_0_At0[d_pp]) * beta0[pp] +
        (4.0 / 3.0) * (deriv_evars->grad_0_beta0[d_pp]) * At0[pp] +
        (deriv_evars->grad_0_beta1[d_pp]) * DENDRO_0 +
        (deriv_evars->grad_0_beta2[d_pp]) * DENDRO_1 +
        (deriv_evars->grad_1_At0[d_pp]) * beta1[pp] -
        (deriv_evars->grad_1_beta1[d_pp]) * DENDRO_2 +
        (deriv_evars->grad_2_At0[d_pp]) * beta2[pp] -
        (deriv_evars->grad_2_beta2[d_pp]) * DENDRO_2 -
        alpha[pp] * (-At0[pp] * K[pp] +
                     2 * At0[pp] *
                         (At0[pp] * DENDRO_igt0 + At1[pp] * DENDRO_igt1 +
                          At2[pp] * DENDRO_igt2) +
                     DENDRO_0 * (At0[pp] * DENDRO_igt1 + At1[pp] * DENDRO_igt3 +
                                 At2[pp] * DENDRO_igt4) +
                     DENDRO_1 * (At0[pp] * DENDRO_igt2 + At1[pp] * DENDRO_igt4 +
                                 At2[pp] * DENDRO_igt5)) +
        (1.0 / 3.0) * chi[pp] *
            (3 * DENDRO_3 + 3 * DENDRO_4 + 3 * DENDRO_5 + 3 * DENDRO_6 -
             3 * deriv_evars->grad2_0_0_alpha[d_pp] -
             gt0[pp] *
                 (DENDRO_igt0 * (DENDRO_3 + DENDRO_4 + DENDRO_5 + DENDRO_6 -
                                 deriv_evars->grad2_0_0_alpha[d_pp]) +
                  2 * DENDRO_igt1 *
                      ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_1 +
                       (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_1 +
                       (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_1 +
                       DENDRO_RIJ1 * alpha[pp] -
                       deriv_evars->grad2_0_1_alpha[d_pp]) +
                  2 * DENDRO_igt2 *
                      ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_2 +
                       (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_2 +
                       (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_2 +
                       DENDRO_RIJ2 * alpha[pp] -
                       deriv_evars->grad2_0_2_alpha[d_pp]) +
                  DENDRO_igt3 *
                      ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_3 +
                       (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_3 +
                       (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_3 +
                       DENDRO_RIJ3 * alpha[pp] -
                       deriv_evars->grad2_1_1_alpha[d_pp]) +
                  2 * DENDRO_igt4 *
                      ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_4 +
                       (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_4 +
                       (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_4 +
                       DENDRO_RIJ4 * alpha[pp] -
                       deriv_evars->grad2_1_2_alpha[d_pp]) +
                  DENDRO_igt5 *
                      ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_5 +
                       (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_5 +
                       (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_5 +
                       DENDRO_RIJ5 * alpha[pp] -
                       deriv_evars->grad2_2_2_alpha[d_pp])));
...
}
{
    ...
    //--
    At_rhs01[pp] =
        (deriv_evars->grad_0_At1[d_pp]) * beta0[pp] +
        (deriv_evars->grad_0_beta0[d_pp]) * DENDRO_0 +
        (deriv_evars->grad_0_beta1[d_pp]) * At3[pp] +
        (deriv_evars->grad_0_beta2[d_pp]) * At4[pp] +
        (deriv_evars->grad_1_At1[d_pp]) * beta1[pp] +
        (deriv_evars->grad_1_beta0[d_pp]) * At0[pp] +
        (deriv_evars->grad_1_beta1[d_pp]) * DENDRO_0 +
        (deriv_evars->grad_1_beta2[d_pp]) * At2[pp] +
        (deriv_evars->grad_2_At1[d_pp]) * beta2[pp] -
        2.0 / 3.0 * (deriv_evars->grad_2_beta2[d_pp]) * At1[pp] -
        alpha[pp] * (2 * At0[pp] *
        ...
        (1.0 / 3.0) * chi[pp] *
            (3 * DENDRO_1 + 3 * DENDRO_2 + 3 * DENDRO_3 + 3 * DENDRO_4 -
             3 * deriv_evars->grad2_0_1_alpha[d_pp] -
             gt1[pp] *
                 (DENDRO_igt0 *
                      ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_0 +
                       (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_0 +
                       (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_C3_k2_0 +
                       DENDRO_RIJ0 * alpha[pp] -
                       deriv_evars->grad2_0_0_alpha[d_pp]) +
                  2 * DENDRO_igt1 *
...
}
{
    ...
    //--
    At_rhs02[pp] =
        (deriv_evars->grad_0_At2[d_pp]) * beta0[pp] +
        (deriv_evars->grad_0_beta0[d_pp]) * DENDRO_0 +
        (deriv_evars->grad_0_beta1[d_pp]) * At4[pp] +
        (deriv_evars->grad_0_beta2[d_pp]) * At5[pp] +
        (deriv_evars->grad_1_At2[d_pp]) * beta1[pp] -
        2.0 / 3.0 * (deriv_evars->grad_1_beta1[d_pp]) * At2[pp] +
        (deriv_evars->grad_2_At2[d_pp]) * beta2[pp] +
        (deriv_evars->grad_2_beta0[d_pp]) * At0[pp] +
        (deriv_evars->grad_2_beta1[d_pp]) * At1[pp] +
        (deriv_evars->grad_2_beta2[d_pp]) * DENDRO_0 -
        alpha[pp] * (2 * At0[pp] *
        ...
        (1.0 / 3.0) * chi[pp] *
            (3 * DENDRO_1 + 3 * DENDRO_2 + 3 * DENDRO_3 + 3 * DENDRO_4 -
             3 * deriv_evars->grad2_0_2_alpha[d_pp] -
             gt2[pp] *
                 (DENDRO_igt0 *
                      ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_0 +
                       (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_0 +
...
}
{
    ...
    //--
    At_rhs11[pp] =
        (deriv_evars->grad_0_At3[d_pp]) * beta0[pp] -
        (deriv_evars->grad_0_beta0[d_pp]) * DENDRO_0 +
        (deriv_evars->grad_1_At3[d_pp]) * beta1[pp] +
        (deriv_evars->grad_1_beta0[d_pp]) * DENDRO_1 +
        (4.0 / 3.0) * (deriv_evars->grad_1_beta1[d_pp]) * At3[pp] +
        (deriv_evars->grad_1_beta2[d_pp]) * DENDRO_2 +
        (deriv_evars->grad_2_At3[d_pp]) * beta2[pp] -
        (deriv_evars->grad_2_beta2[d_pp]) * DENDRO_0 -
        alpha[pp] * (-At3[pp] * K[pp] +
                     2 * At3[pp] *
                         (At1[pp] * DENDRO_igt1 + At3[pp] * DENDRO_igt3 +
                          At4[pp] * DENDRO_igt4) +
                     DENDRO_1 * (At1[pp] * DENDRO_igt0 + At3[pp] * DENDRO_igt1 +
                                 At4[pp] * DENDRO_igt2) +
                     DENDRO_2 * (At1[pp] * DENDRO_igt2 + At3[pp] * DENDRO_igt4 +
                                 At4[pp] * DENDRO_igt5)) +
        (1.0 / 3.0) * chi[pp] *
            (3 * DENDRO_3 + 3 * DENDRO_4 + 3 * DENDRO_5 + 3 * DENDRO_6 -
             3 * deriv_evars->grad2_1_1_alpha[d_pp] -
             gt3[pp] *
                 (DENDRO_igt0 *
                      ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_0 +
                       (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_0 +
...
}
{
    ...
    //--
    At_rhs12[pp] =
        (deriv_evars->grad_0_At4[d_pp]) * beta0[pp] -
        2.0 / 3.0 * (deriv_evars->grad_0_beta0[d_pp]) * At4[pp] +
        (deriv_evars->grad_1_At4[d_pp]) * beta1[pp] +
        (deriv_evars->grad_1_beta0[d_pp]) * At2[pp] +
        (deriv_evars->grad_1_beta1[d_pp]) * DENDRO_0 +
        (deriv_evars->grad_1_beta2[d_pp]) * At5[pp] +
        (deriv_evars->grad_2_At4[d_pp]) * beta2[pp] +
        (deriv_evars->grad_2_beta0[d_pp]) * At1[pp] +
        (deriv_evars->grad_2_beta1[d_pp]) * At3[pp] +
        (deriv_evars->grad_2_beta2[d_pp]) * DENDRO_0 -
        alpha[pp] * (2 * At1[pp] *
                         (At2[pp] * DENDRO_igt0 + At4[pp] * DENDRO_igt1 +
                          At5[pp] * DENDRO_igt2) +
        ...
        (1.0 / 3.0) * chi[pp] *
            (3 * DENDRO_1 + 3 * DENDRO_2 + 3 * DENDRO_3 + 3 * DENDRO_4 -
             3 * deriv_evars->grad2_1_2_alpha[d_pp] -
             gt4[pp] *
                 (DENDRO_igt0 *
                      ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_0 +
                       (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_0 +
...
}
{
    ...
    //--
    At_rhs22[pp] =
        (deriv_evars->grad_0_At5[d_pp]) * beta0[pp] -
        (deriv_evars->grad_0_beta0[d_pp]) * DENDRO_0 +
        (deriv_evars->grad_1_At5[d_pp]) * beta1[pp] -
        (deriv_evars->grad_1_beta1[d_pp]) * DENDRO_0 +
        (deriv_evars->grad_2_At5[d_pp]) * beta2[pp] +
        (deriv_evars->grad_2_beta0[d_pp]) * DENDRO_1 +
        (deriv_evars->grad_2_beta1[d_pp]) * DENDRO_2 +
        (4.0 / 3.0) * (deriv_evars->grad_2_beta2[d_pp]) * At5[pp] -
        alpha[pp] * (-At5[pp] * K[pp] +
                     2 * At5[pp] *
                         (At2[pp] * DENDRO_igt2 + At4[pp] * DENDRO_igt4 +
                          At5[pp] * DENDRO_igt5) +
                     DENDRO_1 * (At2[pp] * DENDRO_igt0 + At4[pp] * DENDRO_igt1 +
                                 At5[pp] * DENDRO_igt2) +
                     DENDRO_2 * (At2[pp] * DENDRO_igt1 + At4[pp] * DENDRO_igt3 +
                                 At5[pp] * DENDRO_igt4)) +
        (1.0 / 3.0) * chi[pp] *
            (3 * DENDRO_3 + 3 * DENDRO_4 + 3 * DENDRO_5 + 3 * DENDRO_6 -
             3 * deriv_evars->grad2_2_2_alpha[d_pp] -
             gt5[pp] *
                 (DENDRO_igt0 *
                      ((deriv_evars->grad_0_alpha[d_pp]) * DENDRO_C3_k0_0 +
                       (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_C3_k1_0 +
...
}
{
    ...
    //--
    K_rhs[pp] =
        (deriv_evars->grad_0_K[d_pp]) * beta0[pp] +
...
}
{
    ...
    Gt_rhs0[pp] =
        (deriv_evars->grad_0_Gt0[d_pp]) * beta0[pp] -
        (deriv_evars->grad_0_alpha[d_pp]) * DENDRO_10 -
        (deriv_evars->grad_0_beta0[d_pp]) * DENDRO_Gtk0 +
        (deriv_evars->grad_1_Gt0[d_pp]) * beta1[pp] -
        2 * (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_23 -
        (deriv_evars->grad_1_beta0[d_pp]) * DENDRO_Gtk1 +
        (deriv_evars->grad_2_Gt0[d_pp]) * beta2[pp] -
        2 * (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_24 -
        (deriv_evars->grad_2_beta0[d_pp]) * DENDRO_Gtk2 +
        DENDRO_0 * deriv_evars->grad2_0_1_beta1[d_pp] +
        DENDRO_0 * deriv_evars->grad2_0_2_beta2[d_pp] +
        DENDRO_1 * deriv_evars->grad2_1_1_beta1[d_pp] +
        DENDRO_1 * deriv_evars->grad2_1_2_beta2[d_pp] +
        DENDRO_10 * DENDRO_C2_k0_0 * alpha[pp] +
        ...
        DENDRO_2 * deriv_evars->grad2_1_2_beta1[d_pp] +
        DENDRO_2 * deriv_evars->grad2_2_2_beta2[d_pp] +
        DENDRO_23 * DENDRO_25 * DENDRO_C2_k0_1 +
        DENDRO_24 * DENDRO_25 * DENDRO_C2_k0_2 +
        ...
        DENDRO_27 * (4 * (deriv_evars->grad_0_K[d_pp]) * DENDRO_igt0 +
                     (deriv_evars->grad_0_chi[d_pp]) * DENDRO_26 * DENDRO_9) -
        DENDRO_27 * (4 * (deriv_evars->grad_1_K[d_pp]) * DENDRO_igt1 +
                     (deriv_evars->grad_1_chi[d_pp]) * DENDRO_23 * DENDRO_26) -
        DENDRO_27 * (4 * (deriv_evars->grad_2_K[d_pp]) * DENDRO_igt2 +
                     (deriv_evars->grad_2_chi[d_pp]) * DENDRO_24 * DENDRO_26) +
        DENDRO_3 * deriv_evars->grad2_1_2_beta0[d_pp] +
        (2.0 / 3.0) * DENDRO_Gtk0 *
            ((deriv_evars->grad_0_beta0[d_pp]) +
             (deriv_evars->grad_1_beta1[d_pp]) +
             (deriv_evars->grad_2_beta2[d_pp])) +
        (4.0 / 3.0) * DENDRO_igt0 * deriv_evars->grad2_0_0_beta0[d_pp] +
        (7.0 / 3.0) * DENDRO_igt1 * deriv_evars->grad2_0_1_beta0[d_pp] +
        (7.0 / 3.0) * DENDRO_igt2 * deriv_evars->grad2_0_2_beta0[d_pp] +
...
}
{
    ...
    Gt_rhs1[pp] =
        (deriv_evars->grad_0_Gt1[d_pp]) * beta0[pp] -
        2 * (deriv_evars->grad_0_alpha[d_pp]) * DENDRO_23 -
        (deriv_evars->grad_0_beta1[d_pp]) * DENDRO_Gtk0 +
        (deriv_evars->grad_1_Gt1[d_pp]) * beta1[pp] -
        (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_11 -
        (deriv_evars->grad_1_beta1[d_pp]) * DENDRO_Gtk1 +
        (deriv_evars->grad_2_Gt1[d_pp]) * beta2[pp] -
        2 * (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_24 -
        (deriv_evars->grad_2_beta1[d_pp]) * DENDRO_Gtk2 +
        DENDRO_0 * deriv_evars->grad2_0_0_beta0[d_pp] +
        DENDRO_0 * deriv_evars->grad2_0_2_beta2[d_pp] +
        DENDRO_1 * deriv_evars->grad2_0_2_beta1[d_pp] +
        DENDRO_11 * DENDRO_C2_k1_3 * alpha[pp] +
        ...
        DENDRO_16 * DENDRO_C2_k1_5 *
            (At0[pp] * DENDRO_12 + At1[pp] * DENDRO_1 * DENDRO_igt4 +
             ...
             At5[pp] * (DENDRO_igt5 * DENDRO_igt5) +
             2 * DENDRO_17 * DENDRO_igt5) +
        DENDRO_2 * deriv_evars->grad2_0_1_beta0[d_pp] +
        DENDRO_2 * deriv_evars->grad2_1_2_beta2[d_pp] +
        DENDRO_23 * DENDRO_25 * DENDRO_C2_k1_1 +
        DENDRO_24 * DENDRO_25 * DENDRO_C2_k1_4 +
        ...
        DENDRO_27 * (4 * (deriv_evars->grad_0_K[d_pp]) * DENDRO_igt1 +
                     (deriv_evars->grad_0_chi[d_pp]) * DENDRO_23 * DENDRO_26) -
        DENDRO_27 * (4 * (deriv_evars->grad_1_K[d_pp]) * DENDRO_igt3 +
                     (deriv_evars->grad_1_chi[d_pp]) * DENDRO_10 * DENDRO_26) -
        DENDRO_27 * (4 * (deriv_evars->grad_2_K[d_pp]) * DENDRO_igt4 +
                     (deriv_evars->grad_2_chi[d_pp]) * DENDRO_24 * DENDRO_26) +
        DENDRO_3 * deriv_evars->grad2_0_2_beta0[d_pp] +
        DENDRO_3 * deriv_evars->grad2_2_2_beta2[d_pp] +
        (2.0 / 3.0) * DENDRO_Gtk1 *
            ((deriv_evars->grad_0_beta0[d_pp]) +
             (deriv_evars->grad_1_beta1[d_pp]) +
             (deriv_evars->grad_2_beta2[d_pp])) +
        DENDRO_igt0 * deriv_evars->grad2_0_0_beta1[d_pp] +
        (7.0 / 3.0) * DENDRO_igt1 * deriv_evars->grad2_0_1_beta1[d_pp] +
        (4.0 / 3.0) * DENDRO_igt3 * deriv_evars->grad2_1_1_beta1[d_pp] +
        (7.0 / 3.0) * DENDRO_igt4 * deriv_evars->grad2_1_2_beta1[d_pp] +
...
}
{
    ...
    Gt_rhs2[pp] =
        ...
        (deriv_evars->grad_1_Gt2[d_pp]) * beta1[pp] -
        2 * (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_24 -
        (deriv_evars->grad_1_beta2[d_pp]) * DENDRO_Gtk1 +
        (deriv_evars->grad_2_Gt2[d_pp]) * beta2[pp] -
        (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_11 -
        (deriv_evars->grad_2_beta2[d_pp]) * DENDRO_Gtk2 +
        DENDRO_0 * deriv_evars->grad2_0_1_beta2[d_pp] +
        DENDRO_1 * deriv_evars->grad2_0_0_beta0[d_pp] +
        DENDRO_1 * deriv_evars->grad2_0_1_beta1[d_pp] +
        DENDRO_11 * DENDRO_C2_k2_5 * alpha[pp] +
        ...
        DENDRO_2 * deriv_evars->grad2_0_1_beta0[d_pp] +
        DENDRO_2 * deriv_evars->grad2_1_1_beta1[d_pp] +
        DENDRO_23 * DENDRO_25 * DENDRO_C2_k2_2 +
        DENDRO_24 * DENDRO_25 * DENDRO_C2_k2_4 +
        ...
        DENDRO_27 * (4 * (deriv_evars->grad_0_K[d_pp]) * DENDRO_igt2 +
                     (deriv_evars->grad_0_chi[d_pp]) * DENDRO_23 * DENDRO_26) -
        DENDRO_27 * (4 * (deriv_evars->grad_1_K[d_pp]) * DENDRO_igt4 +
                     (deriv_evars->grad_1_chi[d_pp]) * DENDRO_24 * DENDRO_26) -
        DENDRO_27 * (4 * (deriv_evars->grad_2_K[d_pp]) * DENDRO_igt5 +
                     (deriv_evars->grad_2_chi[d_pp]) * DENDRO_10 * DENDRO_26) +
        DENDRO_3 * deriv_evars->grad2_0_2_beta0[d_pp] +
        DENDRO_3 * deriv_evars->grad2_1_2_beta1[d_pp] +
        (2.0 / 3.0) * DENDRO_Gtk2 *
            ((deriv_evars->grad_0_beta0[d_pp]) +
             (deriv_evars->grad_1_beta1[d_pp]) +
             (deriv_evars->grad_2_beta2[d_pp])) +
        DENDRO_igt0 * deriv_evars->grad2_0_0_beta2[d_pp] +
        (7.0 / 3.0) * DENDRO_igt2 * deriv_evars->grad2_0_2_beta2[d_pp] +
        DENDRO_igt3 * deriv_evars->grad2_1_1_beta2[d_pp] +
        (7.0 / 3.0) * DENDRO_igt4 * deriv_evars->grad2_1_2_beta2[d_pp] +
...
}
{
    ...
    // Dendro: printing temp variables
    const double DENDRO_0 = (deriv_evars->grad_0_Gt0[d_pp]) * beta0[pp] +
                            (deriv_evars->grad_1_Gt0[d_pp]) * beta1[pp] +
                            (deriv_evars->grad_2_Gt0[d_pp]) * beta2[pp];
    ...
    //--
    B_rhs0[pp] =
        -(deriv_evars->grad_0_alpha[d_pp]) * DENDRO_7 -
        (deriv_evars->grad_0_beta0[d_pp]) * DENDRO_Gtk0 -
        2 * (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_13 -
        (deriv_evars->grad_1_beta0[d_pp]) * DENDRO_Gtk1 -
        2 * (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_14 -
        (deriv_evars->grad_2_beta0[d_pp]) * DENDRO_Gtk2 - B0[pp] * eta -
        DENDRO_0 * lambda[3] + DENDRO_0 +
        DENDRO_13 * DENDRO_28 * DENDRO_C2_k0_1 +
        DENDRO_14 * DENDRO_28 * DENDRO_C2_k0_2 +
        DENDRO_15 * deriv_evars->grad2_1_2_beta0[d_pp] -
        DENDRO_17 * (4 * (deriv_evars->grad_0_K[d_pp]) * DENDRO_igt0 +
                     (deriv_evars->grad_0_chi[d_pp]) * DENDRO_16 * DENDRO_6) -
        DENDRO_17 * (4 * (deriv_evars->grad_1_K[d_pp]) * DENDRO_igt1 +
                     (deriv_evars->grad_1_chi[d_pp]) * DENDRO_13 * DENDRO_16) -
        DENDRO_17 * (4 * (deriv_evars->grad_2_K[d_pp]) * DENDRO_igt2 +
                     (deriv_evars->grad_2_chi[d_pp]) * DENDRO_14 * DENDRO_16) +
        DENDRO_18 * deriv_evars->grad2_0_1_beta1[d_pp] +
        DENDRO_18 * deriv_evars->grad2_0_2_beta2[d_pp] +
        DENDRO_19 * deriv_evars->grad2_1_1_beta1[d_pp] +
        DENDRO_19 * deriv_evars->grad2_1_2_beta2[d_pp] +
        DENDRO_20 * deriv_evars->grad2_1_2_beta1[d_pp] +
        DENDRO_20 * deriv_evars->grad2_2_2_beta2[d_pp] +
        ...
        DENDRO_7 * DENDRO_C2_k0_0 * alpha[pp] +
        (2.0 / 3.0) * DENDRO_Gtk0 *
            ((deriv_evars->grad_0_beta0[d_pp]) +
             (deriv_evars->grad_1_beta1[d_pp]) +
             (deriv_evars->grad_2_beta2[d_pp])) +
...
}
{
    ...
    // Dendro: original ops: 430
    // Dendro: printing temp variables
    const double DENDRO_0 = (deriv_evars->grad_0_Gt1[d_pp]) * beta0[pp] +
                            (deriv_evars->grad_1_Gt1[d_pp]) * beta1[pp] +
                            (deriv_evars->grad_2_Gt1[d_pp]) * beta2[pp];
    ...
    //--
    B_rhs1[pp] =
        -2 * (deriv_evars->grad_0_alpha[d_pp]) * DENDRO_10 -
        (deriv_evars->grad_0_beta1[d_pp]) * DENDRO_Gtk0 -
        (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_14 -
        (deriv_evars->grad_1_beta1[d_pp]) * DENDRO_Gtk1 -
        2 * (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_15 -
        (deriv_evars->grad_2_beta1[d_pp]) * DENDRO_Gtk2 - B1[pp] * eta -
        DENDRO_0 * lambda[3] + DENDRO_0 +
        DENDRO_10 * DENDRO_28 * DENDRO_C2_k1_1 +
        DENDRO_14 * DENDRO_C2_k1_3 * alpha[pp] +
        DENDRO_15 * DENDRO_28 * DENDRO_C2_k1_4 +
        DENDRO_16 * deriv_evars->grad2_0_2_beta1[d_pp] -
        DENDRO_18 * (4 * (deriv_evars->grad_0_K[d_pp]) * DENDRO_igt1 +
                     (deriv_evars->grad_0_chi[d_pp]) * DENDRO_10 * DENDRO_17) -
        DENDRO_18 * (4 * (deriv_evars->grad_1_K[d_pp]) * DENDRO_igt3 +
                     (deriv_evars->grad_1_chi[d_pp]) * DENDRO_13 * DENDRO_17) -
        DENDRO_18 * (4 * (deriv_evars->grad_2_K[d_pp]) * DENDRO_igt4 +
                     (deriv_evars->grad_2_chi[d_pp]) * DENDRO_15 * DENDRO_17) +
        DENDRO_19 * deriv_evars->grad2_0_0_beta0[d_pp] +
        DENDRO_19 * deriv_evars->grad2_0_2_beta2[d_pp] +
        DENDRO_20 * deriv_evars->grad2_0_1_beta0[d_pp] +
        DENDRO_20 * deriv_evars->grad2_1_2_beta2[d_pp] +
        DENDRO_21 * deriv_evars->grad2_0_2_beta0[d_pp] +
        DENDRO_21 * deriv_evars->grad2_2_2_beta2[d_pp] +
...
}
{
    ...
    // Dendro: original ops: 430
    // Dendro: printing temp variables
    const double DENDRO_0 = (deriv_evars->grad_0_Gt2[d_pp]) * beta0[pp] +
                            (deriv_evars->grad_1_Gt2[d_pp]) * beta1[pp] +
                            (deriv_evars->grad_2_Gt2[d_pp]) * beta2[pp];
    ...
    B_rhs2[pp] =
        -2 * (deriv_evars->grad_0_alpha[d_pp]) * DENDRO_10 -
        (deriv_evars->grad_0_beta2[d_pp]) * DENDRO_Gtk0 -
        2 * (deriv_evars->grad_1_alpha[d_pp]) * DENDRO_12 -
        (deriv_evars->grad_1_beta2[d_pp]) * DENDRO_Gtk1 -
        (deriv_evars->grad_2_alpha[d_pp]) * DENDRO_15 -
        (deriv_evars->grad_2_beta2[d_pp]) * DENDRO_Gtk2 - B2[pp] * eta -
        DENDRO_0 * lambda[3] + DENDRO_0 +
        DENDRO_10 * DENDRO_28 * DENDRO_C2_k2_2 +
        DENDRO_12 * DENDRO_28 * DENDRO_C2_k2_4 +
        DENDRO_15 * DENDRO_C2_k2_5 * alpha[pp] +
        DENDRO_16 * deriv_evars->grad2_0_1_beta2[d_pp] -
        DENDRO_18 * (4 * (deriv_evars->grad_0_K[d_pp]) * DENDRO_igt2 +
                     (deriv_evars->grad_0_chi[d_pp]) * DENDRO_10 * DENDRO_17) -
        DENDRO_18 * (4 * (deriv_evars->grad_1_K[d_pp]) * DENDRO_igt4 +
                     (deriv_evars->grad_1_chi[d_pp]) * DENDRO_12 * DENDRO_17) -
        DENDRO_18 * (4 * (deriv_evars->grad_2_K[d_pp]) * DENDRO_igt5 +
                     (deriv_evars->grad_2_chi[d_pp]) * DENDRO_14 * DENDRO_17) +
        DENDRO_19 * deriv_evars->grad2_0_0_beta0[d_pp] +
        DENDRO_19 * deriv_evars->grad2_0_1_beta1[d_pp] +
        DENDRO_20 * deriv_evars->grad2_0_1_beta0[d_pp] +
        DENDRO_20 * deriv_evars->grad2_1_1_beta1[d_pp] +
        DENDRO_21 * deriv_evars->grad2_0_2_beta0[d_pp] +
        DENDRO_21 * deriv_evars->grad2_1_2_beta1[d_pp] +
