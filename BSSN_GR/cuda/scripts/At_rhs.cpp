...

{
    ...
    At_rhs00[pp] =
        ...
        (deriv_evars->grad_2_beta2[d_pp]) * DENDRO_2 + At_rhs00[pp] -
...

{
    ...
    At_rhs01[pp] =
        ...
        2.0 / 3.0 * (deriv_evars->grad_2_beta2[d_pp]) * At1[pp] + At_rhs01[pp] -
        alpha[pp] * (2 * At0[pp] *
...

{
    ...
    At_rhs02[pp] =
        ...
        (deriv_evars->grad_2_beta2[d_pp]) * DENDRO_0 + At_rhs02[pp] -
        alpha[pp] * (2 * At0[pp] *
...

{
    ...
    At_rhs11[pp] =
        ...
        (deriv_evars->grad_2_beta2[d_pp]) * DENDRO_0 + At_rhs11[pp] -
...

{
    ...
    At_rhs12[pp] =
        ...
        (deriv_evars->grad_2_beta2[d_pp]) * DENDRO_0 + At_rhs12[pp] -
        alpha[pp] * (2 * At1[pp] *
                         (At2[pp] * DENDRO_igt0 + At4[pp] * DENDRO_igt1 +
                          At5[pp] * DENDRO_igt2) +
                     2 * At3[pp] *
