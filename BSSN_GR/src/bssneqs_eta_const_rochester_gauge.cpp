...
const double DENDRO_809 = (DENDRO_20 * DENDRO_20);
const double DENDRO_810 = (DENDRO_37 * DENDRO_37);
const double DENDRO_811 = 2 * DENDRO_40;
const double DENDRO_812 = At0[pp] * (DENDRO_40 * DENDRO_40) +
                          At3[pp] * DENDRO_809 + At5[pp] * DENDRO_810 -
                          DENDRO_239 * DENDRO_727 - DENDRO_34 * DENDRO_811 +
                          DENDRO_38 * DENDRO_811;
const double DENDRO_813 = 3 * DENDRO_115;
const double DENDRO_814 = (DENDRO_22 * DENDRO_22);
const double DENDRO_815 = 2 * DENDRO_26;
const double DENDRO_816 = At0[pp] * DENDRO_809 +
...
const double DENDRO_818 = At0[pp] * DENDRO_810 + At3[pp] * DENDRO_814 +
                          ...
                          DENDRO_242 * DENDRO_44 + DENDRO_38 * DENDRO_817 -
                          DENDRO_723 * DENDRO_817;
...
const double DENDRO_842 = DENDRO_20 * DENDRO_32;
const double DENDRO_843 = (7.0 / 3.0) * DENDRO_842;
const double DENDRO_844 = (7.0 / 3.0) * DENDRO_282;
const double DENDRO_845 = (1.0 / 3.0) * DENDRO_842;
const double DENDRO_846 = (1.0 / 3.0) * DENDRO_282;
const double DENDRO_847 = (1.0 / 3.0) * DENDRO_288;
const double DENDRO_848 = 2 * DENDRO_115;
const double DENDRO_849 = DENDRO_848 * grad_0_alpha[pp];
const double DENDRO_850 = pow(DENDRO_31, -3);
const double DENDRO_851 = DENDRO_0 * DENDRO_850;
const double DENDRO_852 = DENDRO_812 * DENDRO_851;
const double DENDRO_853 = DENDRO_816 * DENDRO_851;
const double DENDRO_854 = DENDRO_818 * DENDRO_851;
const double DENDRO_855 = 4 * grad_0_K[pp];
const double DENDRO_856 = 9 * DENDRO_52;
const double DENDRO_857 = DENDRO_856 * DENDRO_95;
const double DENDRO_858 = DENDRO_32 * DENDRO_841;
const double DENDRO_859 = DENDRO_848 * grad_2_alpha[pp];
const double DENDRO_860 = DENDRO_848 * grad_1_alpha[pp];
const double DENDRO_861 = 2.0 * DENDRO_850 * alpha[pp];
const double DENDRO_862 = DENDRO_819 * DENDRO_861;
const double DENDRO_863 = DENDRO_830 * DENDRO_861;
const double DENDRO_864 = DENDRO_840 * DENDRO_861;
const double DENDRO_865 = 4 * grad_2_K[pp];
const double DENDRO_866 = DENDRO_856 * DENDRO_98;
const double DENDRO_867 = 4 * grad_1_K[pp];
const double DENDRO_868 = DENDRO_856 * DENDRO_96;
const double DENDRO_869 = (2.0 / 3.0) * DENDRO_16;
const double DENDRO_870 = DENDRO_22 * DENDRO_32;
const double DENDRO_871 = (1.0 / 3.0) * grad2_0_2_beta0[pp];
const double DENDRO_872 = (7.0 / 3.0) * DENDRO_870;
const double DENDRO_873 = (1.0 / 3.0) * DENDRO_870;
const double DENDRO_874 = (1.0 / 3.0) * DENDRO_290;
const double DENDRO_875 = -DENDRO_821 - DENDRO_822 + DENDRO_823 - DENDRO_824 +
                          DENDRO_825 + DENDRO_826 - DENDRO_827 + DENDRO_828 +
                          DENDRO_829;
const double DENDRO_876 = -DENDRO_831 - DENDRO_832 + DENDRO_833 - DENDRO_834 +
                          DENDRO_835 + DENDRO_836 + DENDRO_837 - DENDRO_838 +
                          DENDRO_839;
...
//--
Gt_rhs0[pp] =
    DENDRO_168 * DENDRO_862 + DENDRO_173 * DENDRO_864 +
    DENDRO_175 * DENDRO_863 + DENDRO_185 * DENDRO_854 +
    DENDRO_192 * DENDRO_853 - 4.0 / 3.0 * DENDRO_288 * grad2_0_0_beta0[pp] -
    DENDRO_290 * grad2_1_1_beta0[pp] - DENDRO_292 * grad2_2_2_beta0[pp] +
    DENDRO_357 * DENDRO_869 - DENDRO_357 * grad_0_beta0[pp] -
    DENDRO_359 * grad_1_beta0[pp] - DENDRO_361 * grad_2_beta0[pp] +
    DENDRO_805 * grad2_1_2_beta0[pp] - DENDRO_812 * DENDRO_849 -
    DENDRO_819 * DENDRO_859 - DENDRO_830 * DENDRO_860 +
    DENDRO_843 * grad2_0_1_beta0[pp] - DENDRO_844 * grad2_0_2_beta0[pp] +
    DENDRO_845 * grad2_1_1_beta1[pp] + DENDRO_845 * grad2_1_2_beta2[pp] -
    DENDRO_846 * grad2_1_2_beta1[pp] - DENDRO_846 * grad2_2_2_beta2[pp] -
    DENDRO_847 * grad2_0_1_beta1[pp] - DENDRO_847 * grad2_0_2_beta2[pp] +
    DENDRO_852 * DENDRO_94 -
    DENDRO_858 * (DENDRO_20 * DENDRO_867 + DENDRO_830 * DENDRO_868) -
    DENDRO_858 * (-DENDRO_37 * DENDRO_865 + DENDRO_819 * DENDRO_866) -
    DENDRO_858 * (-DENDRO_40 * DENDRO_855 + DENDRO_812 * DENDRO_857) +
    beta0[pp] * grad_0_Gt0[pp] + beta1[pp] * grad_1_Gt0[pp] +
    beta2[pp] * grad_2_Gt0[pp];
//--
Gt_rhs1[pp] = DENDRO_105 * DENDRO_862 - DENDRO_112 * DENDRO_861 * DENDRO_875 +
              DENDRO_195 * grad_0_beta1[pp] -
              DENDRO_202 * DENDRO_861 * DENDRO_876 + DENDRO_206 * DENDRO_854 -
              DENDRO_214 * DENDRO_869 + DENDRO_214 * grad_1_beta1[pp] +
              DENDRO_232 * grad_2_beta1[pp] - DENDRO_288 * grad2_0_0_beta1[pp] -
              4.0 / 3.0 * DENDRO_290 * grad2_1_1_beta1[pp] -
              DENDRO_292 * grad2_2_2_beta1[pp] + DENDRO_62 * DENDRO_852 -
              DENDRO_740 * DENDRO_853 - DENDRO_807 * grad2_0_2_beta1[pp] -
              DENDRO_816 * DENDRO_860 + DENDRO_843 * grad2_0_1_beta1[pp] +
              DENDRO_845 * grad2_0_0_beta0[pp] +
              DENDRO_845 * grad2_0_2_beta2[pp] + DENDRO_849 * DENDRO_875 -
              DENDRO_858 * (DENDRO_20 * DENDRO_855 - DENDRO_857 * DENDRO_875) -
              DENDRO_858 * (DENDRO_22 * DENDRO_865 - DENDRO_866 * DENDRO_876) +
              DENDRO_858 * (DENDRO_26 * DENDRO_867 - DENDRO_816 * DENDRO_868) +
              DENDRO_859 * DENDRO_876 + DENDRO_870 * DENDRO_871 +
              DENDRO_872 * grad2_1_2_beta1[pp] +
              DENDRO_873 * grad2_2_2_beta2[pp] -
              DENDRO_874 * grad2_0_1_beta0[pp] -
              DENDRO_874 * grad2_1_2_beta2[pp] + beta0[pp] * grad_0_Gt1[pp] +
              beta1[pp] * grad_1_Gt1[pp] + beta2[pp] * grad_2_Gt1[pp];
//--
Gt_rhs2[pp] =
    DENDRO_125 * DENDRO_863 + DENDRO_130 * DENDRO_862 +
    DENDRO_220 * DENDRO_864 + DENDRO_226 * DENDRO_854 +
    DENDRO_229 * DENDRO_853 - DENDRO_288 * grad2_0_0_beta2[pp] -
    DENDRO_290 * grad2_1_1_beta2[pp] - DENDRO_292 * DENDRO_871 -
    ...
    DENDRO_361 * DENDRO_869 - DENDRO_361 * grad_2_beta2[pp] +
    DENDRO_808 * grad2_0_1_beta2[pp] - DENDRO_818 * DENDRO_859 -
    DENDRO_819 * DENDRO_849 - DENDRO_840 * DENDRO_860 -
    DENDRO_844 * grad2_0_2_beta2[pp] - DENDRO_846 * grad2_0_0_beta0[pp] -
    DENDRO_846 * grad2_0_1_beta1[pp] + DENDRO_852 * DENDRO_97 -
    DENDRO_858 * (DENDRO_22 * DENDRO_867 + DENDRO_840 * DENDRO_868) -
    DENDRO_858 * (-DENDRO_37 * DENDRO_855 + DENDRO_819 * DENDRO_857) -
    DENDRO_858 * (-DENDRO_46 * DENDRO_865 + DENDRO_818 * DENDRO_866) +
    DENDRO_872 * grad2_1_2_beta2[pp] + DENDRO_873 * grad2_0_1_beta0[pp] +
    DENDRO_873 * grad2_1_1_beta1[pp] + beta0[pp] * grad_0_Gt2[pp] +
    beta1[pp] * grad_1_Gt2[pp] + beta2[pp] * grad_2_Gt2[pp];
// Dendro: reduced ops: 3892
// Dendro: }}}
