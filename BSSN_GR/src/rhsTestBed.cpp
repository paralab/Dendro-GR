...
int main (int argc, char** argv) {
    ...
    #pragma omp parallel for default(none) shared(blkList,pt_min,pt_max,varUnzipIn,bssn::BSSN_COMPD_MAX,bssn::BSSN_COMPD_MIN,bssn::BSSN_OCTREE_MAX,bssn::BSSN_OCTREE_MIN,PW) schedule(dynamic)
    ...
    t1=Time::now();
    #pragma omp parallel for default(none) shared(blkList,pt_min,pt_max,varUnzipIn,varUnzipOutCPU0,bssn::BSSN_COMPD_MAX,bssn::BSSN_COMPD_MIN,bssn::BSSN_OCTREE_MAX,bssn::BSSN_OCTREE_MIN,PW) schedule(dynamic)
    for(unsigned int blk=0;blk<blkList.size();blk++) {
    ...
    #pragma omp parallel for default(none) shared(blkList,pt_min,pt_max,varUnzipIn,varUnzipOutCPU1,bssn::BSSN_COMPD_MAX,bssn::BSSN_COMPD_MIN,bssn::BSSN_OCTREE_MAX,bssn::BSSN_OCTREE_MIN,PW) schedule(dynamic)
    for(unsigned int blk=0;blk<blkList.size();blk++) {
