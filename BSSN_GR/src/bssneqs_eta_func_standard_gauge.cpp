...
const double DENDRO_886 =
    ...
    DENDRO_885;
const double DENDRO_887 = 2 * grad_0_chi[pp];
const double DENDRO_888 =
    BSSN_ETA_R0 *
    sqrt(DENDRO_32 * (-DENDRO_246 * DENDRO_40 - DENDRO_248 * DENDRO_26 -
                      DENDRO_250 * DENDRO_46 + 2 * DENDRO_66 * grad_2_chi[pp] +
                      DENDRO_86 * DENDRO_887 - DENDRO_87 * DENDRO_887)) *
...
//--
B_rhs0[pp] =
    -B0[pp] * DENDRO_888 - DENDRO_870 * lambda[3] + DENDRO_871 +
    lambda[2] * (beta0[pp] * grad_0_B0[pp] + beta1[pp] * grad_1_B0[pp] +
                 beta2[pp] * grad_2_B0[pp]);
//--
B_rhs1[pp] =
    -B1[pp] * DENDRO_888 + DENDRO_112 * DENDRO_867 + DENDRO_202 * DENDRO_868 +
