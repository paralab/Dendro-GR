...
const double DENDRO_888 = BSSN_ETA_R0*sqrt(DENDRO_32*(-DENDRO_246*DENDRO_40 - DENDRO_248*DENDRO_26 - DENDRO_250*DENDRO_46 + 2*DENDRO_66*grad_2_chi[pp] + DENDRO_86*DENDRO_887 - DENDRO_87*DENDRO_887))*pow(1 - pow(chi[pp], BSSN_ETA_POWER[0]), -BSSN_ETA_POWER[1]);
...
//--
B_rhs0[pp] = -B0[pp]*DENDRO_888 - DENDRO_870*lambda[3] + DENDRO_871 + lambda[2]*(beta0[pp]*grad_0_B0[pp] + beta1[pp]*grad_1_B0[pp] + beta2[pp]*grad_2_B0[pp]);
//--
B_rhs1[pp] = -B1[pp]*DENDRO_888 + DENDRO_112*DENDRO_867 + DENDRO_202*DENDRO_868 + DENDRO_211*DENDRO_863 - DENDRO_357*grad_0_beta1[pp] + DENDRO_359*DENDRO_859 - DENDRO_359*grad_1_beta1[pp] - DENDRO_361*grad_2_beta1[pp] - DENDRO_830*DENDRO_843 - DENDRO_840*DENDRO_845 - DENDRO_850*(-DENDRO_876 + DENDRO_877) - DENDRO_850*(DENDRO_830*DENDRO_849 + DENDRO_874) - DENDRO_850*(DENDRO_840*DENDRO_852 + DENDRO_875) - DENDRO_883*lambda[3] + DENDRO_884 + lambda[2]*(beta0[pp]*grad_0_B1[pp] + beta1[pp]*grad_1_B1[pp] + beta2[pp]*grad_2_B1[pp]);
//--
B_rhs2[pp] = -B2[pp]*DENDRO_888 - DENDRO_885*lambda[3] + DENDRO_886 + lambda[2]*(beta0[pp]*grad_0_B2[pp] + beta1[pp]*grad_1_B2[pp] + beta2[pp]*grad_2_B2[pp]);
