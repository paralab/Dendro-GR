...
int main(int argc, char **argv) {
    ...
    double t1      = MPI_Wtime();
    // TwoPunctures(&cctkGH, &massp, &massm, &massp_adm, &massm_adm,&E, &J1,
    // &J2, &J3);
    TP_SOLVE_VALID = 0;
    if (TP_SOLVE_VALID == 0) {
