...
class GWExtract:
    ...
    def __init__(self,N,qprec,lmodes,spin,varNames):
        ...
        self.psi4=dtypes.vec("psi4_",N) # different lm values at the extraction radius
        self.argpsi4=dtypes.vec("apsi4_",N) # different lm values at the extraction radius
