...
int main(int argc, char** argv) {
    ...
    const unsigned int grainSz =
        nlsm::NLSM_DENDRO_GRAIN_SZ;  // DENDRO_DEFAULT_GRAIN_SZ;
    ...
    shrinkOrExpandOctree(tmpNodes, nlsm::NLSM_LOAD_IMB_TOL, DENDRO_DEFAULT_SF_K,
    ...
    if (isActive) {
        ...
        SFC::parSort::SFC_treeSort(tmpNodes, tmpVec, tmpVec, tmpVec,
                                   nlsm::NLSM_LOAD_IMB_TOL, m_uiMaxDepth, root,
                                   ROOT_ROTATION, 1, TS_REMOVE_DUPLICATES,
                                   nlsm::NLSM_SPLIT_FIX, commActive);
    ...
    ot::Mesh* mesh =
        new ot::Mesh(balOct, 1, nlsm::NLSM_ELE_ORDER, comm, true,
                     ot::SM_TYPE::FDM, nlsm::NLSM_DENDRO_GRAIN_SZ,
    ...
    ode::solver::RK4_NLSM rk_nlsm(mesh, nlsm::NLSM_RK45_TIME_BEGIN,
                                  nlsm::NLSM_RK45_TIME_END,
                                  nlsm::NLSM_RK45_TIME_STEP_SIZE);
    // ode::solver::RK3_NLSM
    // rk_nlsm(mesh,nlsm::NLSM_RK45_TIME_BEGIN,nlsm::NLSM_RK45_TIME_END,nlsm::NLSM_RK45_TIME_STEP_SIZE);
