...
double NLSM_OCTREE_MAX[3] = {(double)(1u << NLSM_MAXDEPTH),
                             (double)(1u << NLSM_MAXDEPTH),
                             (double)(1u << NLSM_MAXDEPTH)};

//@note assumes the computational domain is a cube as well.
double NLSM_RK45_TIME_STEP_SIZE = NLSM_CFL_FACTOR *
                                  (NLSM_COMPD_MAX[0] - NLSM_COMPD_MIN[0]) *
                                  (1.0 / (double)(1u << NLSM_MAXDEPTH));
