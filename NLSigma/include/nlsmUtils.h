...
#define GRIDX_TO_X(xg) \
    (((Rx / RgX) * (xg - nlsm::NLSM_OCTREE_MIN[0])) + nlsm::NLSM_COMPD_MIN[0])
#define GRIDY_TO_Y(yg) \
    (((Ry / RgY) * (yg - nlsm::NLSM_OCTREE_MIN[1])) + nlsm::NLSM_COMPD_MIN[1])
#define GRIDZ_TO_Z(zg) \
    (((Rz / RgZ) * (zg - nlsm::NLSM_OCTREE_MIN[2])) + nlsm::NLSM_COMPD_MIN[2])

#define X_TO_GRIDX(xc) \
    (((RgX / Rx) * (xc - nlsm::NLSM_COMPD_MIN[0])) + nlsm::NLSM_OCTREE_MIN[0])
#define Y_TO_GRIDY(yc) \
    (((RgY / Ry) * (yc - nlsm::NLSM_COMPD_MIN[1])) + nlsm::NLSM_OCTREE_MIN[1])
#define Z_TO_GRIDZ(zc) \
    (((RgZ / Rz) * (zc - nlsm::NLSM_COMPD_MIN[2])) + nlsm::NLSM_OCTREE_MIN[2])
