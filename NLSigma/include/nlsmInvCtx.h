...
namespace nlsm
{
    ...
    struct NLSM_CNTRL_VARS
    {
        ...
        Point WAVE_EXTRAC_LOC[6]={Point(-1,0,0), Point(1,0,0), Point(0,-1,0), Point(0,1,0), Point(0,0,-1), Point(0,0,1) };
    ...
    class InvNLSMCtx : public invp::InverseCtx<InvNLSMCtx, NLSMCtx>
    {
        ...
        public:
            ...
            int set_parameter_filename(char* fname) { m_uiParFile = std::string(fname); return 0;}
