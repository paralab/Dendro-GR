             ...
             const unsigned int& bflag)
{
  ...
  for (unsigned int k = PW; k < nz-PW; k++) {
    ...
    if (bflag != 0) {
      ...
      em1_bcs(E_rhs0, E0, grad_0_E0, grad_1_E0, grad_2_E0, pmin, pmax,
              2.0, 0.0, sz, bflag);
      em1_bcs(E_rhs1, E1, grad_0_E1, grad_1_E1, grad_2_E1, pmin, pmax,
              2.0, 0.0, sz, bflag);
      em1_bcs(E_rhs2, E2, grad_0_E2, grad_1_E2, grad_2_E2, pmin, pmax,
              2.0, 0.0, sz, bflag);
      
      em1_bcs(A_rhs0, A0, grad_0_A0, grad_1_A0, grad_2_A0, pmin, pmax,
              1.0, 0.0, sz, bflag);
      em1_bcs(A_rhs1, A1, grad_0_A1, grad_1_A1, grad_2_A1, pmin, pmax,
              1.0, 0.0, sz, bflag);
      em1_bcs(A_rhs2, A2, grad_0_A2, grad_1_A2, grad_2_A2, pmin, pmax,
              1.0, 0.0, sz, bflag);
 ...
 *
 *----------------------------------------------------------------------*/
void em1_bcs(double *f_rhs, const double *f,
