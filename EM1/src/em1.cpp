...
int main (int argc, char** argv)
{
    ...
    if(rank==1|| npes==1)
    {
        ...
        std::cout<<YLW<<"\tEM1_ELE_ORDER :"<<em1::EM1_ELE_ORDER<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_PADDING_WIDTH :"<<em1::EM1_PADDING_WIDTH<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_DIM :"<<em1::EM1_DIM<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_IO_OUTPUT_FREQ :"<<em1::EM1_IO_OUTPUT_FREQ<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_REMESH_TEST_FREQ :"<<em1::EM1_REMESH_TEST_FREQ<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_CHECKPT_FREQ :"<<em1::EM1_CHECKPT_FREQ<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_RESTORE_SOLVER :"<<em1::EM1_RESTORE_SOLVER<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_ENABLE_BLOCK_ADAPTIVITY :"<<em1::EM1_ENABLE_BLOCK_ADAPTIVITY<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_VTU_FILE_PREFIX :"<<em1::EM1_VTU_FILE_PREFIX<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_CHKPT_FILE_PREFIX :"<<em1::EM1_CHKPT_FILE_PREFIX<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_PROFILE_FILE_PREFIX :"<<em1::EM1_PROFILE_FILE_PREFIX<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_VTU_Z_SLICE_ONLY :"<<em1::EM1_VTU_Z_SLICE_ONLY<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_IO_OUTPUT_GAP :"<<em1::EM1_IO_OUTPUT_GAP<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_DENDRO_GRAIN_SZ :"<<em1::EM1_DENDRO_GRAIN_SZ<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_ASYNC_COMM_K :"<<em1::EM1_ASYNC_COMM_K<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_DENDRO_AMR_FAC :"<<em1::EM1_DENDRO_AMR_FAC<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_CFL_FACTOR:"<<em1::EM1_CFL_FACTOR<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_WAVELET_TOL :"<<em1::EM1_WAVELET_TOL<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_LOAD_IMB_TOL :"<<em1::EM1_LOAD_IMB_TOL<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_RK45_TIME_BEGIN :"<<em1::EM1_RK45_TIME_BEGIN<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_RK45_TIME_END :"<<em1::EM1_RK45_TIME_END<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_RK45_TIME_STEP_SIZE :"<<em1::EM1_RK45_TIME_STEP_SIZE<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_RK45_DESIRED_TOL :"<<em1::EM1_RK45_DESIRED_TOL<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_COMPD_MIN : ( :"<<em1::EM1_COMPD_MIN[0]<<" ,"<<em1::EM1_COMPD_MIN[1]<<","<<em1::EM1_COMPD_MIN[2]<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_COMPD_MAX : ( :"<<em1::EM1_COMPD_MAX[0]<<" ,"<<em1::EM1_COMPD_MAX[1]<<","<<em1::EM1_COMPD_MAX[2]<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_BLK_MIN : ( :"<<em1::EM1_BLK_MIN_X<<" ,"<<em1::EM1_BLK_MIN_Y<<","<<em1::EM1_BLK_MIN_Z<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_BLK_MAX : ( :"<<em1::EM1_BLK_MAX_X<<" ,"<<em1::EM1_BLK_MAX_Y<<","<<em1::EM1_BLK_MAX_Z<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_OCTREE_MIN : ( :"<<em1::EM1_OCTREE_MIN[0]<<" ,"<<em1::EM1_OCTREE_MIN[1]<<","<<em1::EM1_OCTREE_MIN[2]<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_OCTREE_MAX : ( :"<<em1::EM1_OCTREE_MAX[0]<<" ,"<<em1::EM1_OCTREE_MAX[1]<<","<<em1::EM1_OCTREE_MAX[2]<<" )"<<NRM<<std::endl;
        std::cout<<YLW<<"\tKO_DISS_SIGMA :"<<em1::KO_DISS_SIGMA<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_ID_TYPE:"<<em1::EM1_ID_TYPE<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_ID_AMP1:"<<em1::EM1_ID_AMP1<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_ID_LAMBDA1:"<<em1::EM1_ID_LAMBDA1<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_ID_AMP2:"<<em1::EM1_ID_AMP2<<NRM<<std::endl;
        ...
        //std::cout<<YLW<<"\tEM1_DIM :"<<em1::EM1_DIM<<NRM<<std::endl;
        std::cout<<YLW<<"\tEM1_MAXDEPTH :"<<em1::EM1_MAXDEPTH<<NRM<<std::endl;

        std::cout<<YLW<<"\tEM1_NUM_REFINE_VARS :"<<em1::EM1_NUM_REFINE_VARS<<NRM<<std::endl;
        ...
        std::cout<<em1::EM1_REFINE_VARIABLE_INDICES[em1::EM1_NUM_REFINE_VARS-1]<<"]"<<NRM<<std::endl;

        std::cout<<YLW<<"\tEM1_REFINEMENT_MODE :"<<em1::EM1_REFINEMENT_MODE<<NRM<<std::endl;

        std::cout<<YLW<<"\tEM1_NUM_EVOL_VARS_VTU_OUTPUT :"<<em1::EM1_NUM_EVOL_VARS_VTU_OUTPUT<<NRM<<std::endl;
        ...
        std::cout<<em1::EM1_VTU_OUTPUT_EVOL_INDICES[em1::EM1_NUM_EVOL_VARS_VTU_OUTPUT-1]<<"]"<<NRM<<std::endl;
    ...
    {
        if(!rank) std::cout<<"[overlap communication error]: total EM1_NUM_VARS: "<<em1::EM1_NUM_VARS<<" is not divisable by EM1_ASYNC_COMM_K: "<<em1::EM1_ASYNC_COMM_K<<std::endl;
        exit(0);
    }
    ...
    std::function<void(double,double,double,double*)> f_init=[](double x,double y,double z,double*var){em1::initData(x,y,z,var);};
    //std::function<void(double,double,double,double,double*)> u_x_t=[](double x,double y,double z,double t,double*var){em1::analyticalSol(x,y,z,t,var);};

    const unsigned int interpVars=em1::EM1_NUM_VARS;
    unsigned int varIndex[interpVars];
    for(unsigned int i=0;i<em1::EM1_NUM_VARS;i++)
        varIndex[i]=i;
    ...
    if(em1::EM1_ENABLE_BLOCK_ADAPTIVITY)
    {
        ...
        const Point pt_min(em1::EM1_BLK_MIN_X,em1::EM1_BLK_MIN_Y,em1::EM1_BLK_MIN_Z);
        const Point pt_max(em1::EM1_BLK_MAX_X,em1::EM1_BLK_MAX_Y,em1::EM1_BLK_MAX_Z);

        em1::blockAdaptiveOctree(tmpNodes,pt_min,pt_max,m_uiMaxDepth-(binOp::fastLog2(em1::EM1_ELE_ORDER)),m_uiMaxDepth,comm);
    }else
    {

        if(!rank) std::cout<<YLW<<"Using function2Octree. AMR enabled "<<NRM<<std::endl;
        function2Octree(f_init,em1::EM1_NUM_VARS,em1::EM1_REFINE_VARIABLE_INDICES,em1::EM1_NUM_REFINE_VARS,tmpNodes,m_uiMaxDepth,em1::EM1_WAVELET_TOL,em1::EM1_ELE_ORDER,comm);
    ...
    const unsigned int grainSz=em1::EM1_DENDRO_GRAIN_SZ;//DENDRO_DEFAULT_GRAIN_SZ;
    ...
    shrinkOrExpandOctree(tmpNodes,em1::EM1_LOAD_IMB_TOL,DENDRO_DEFAULT_SF_K,isActive,commActive,comm);
    ...
    if(isActive)
    {
        ...
        SFC::parSort::SFC_treeSort(tmpNodes,tmpVec,tmpVec,tmpVec,em1::EM1_LOAD_IMB_TOL,m_uiMaxDepth,root,ROOT_ROTATION,1,TS_REMOVE_DUPLICATES,em1::EM1_SPLIT_FIX,commActive);
        std::swap(tmpNodes,tmpVec);
        tmpVec.clear();

        SFC::parSort::SFC_treeSort(tmpNodes,tmpVec,tmpVec,tmpVec,em1::EM1_LOAD_IMB_TOL,m_uiMaxDepth,root,ROOT_ROTATION,1,TS_CONSTRUCT_OCTREE,em1::EM1_SPLIT_FIX,commActive);
        std::swap(tmpNodes,tmpVec);
        tmpVec.clear();
        ...
        SFC::parSort::SFC_treeSort(tmpNodes,balOct,balOct,balOct,em1::EM1_LOAD_IMB_TOL,m_uiMaxDepth,root,ROOT_ROTATION,1,TS_BALANCE_OCTREE,em1::EM1_SPLIT_FIX,commActive);
        tmpNodes.clear();
    ...
    ot::Mesh * mesh=new ot::Mesh(balOct,1,em1::EM1_ELE_ORDER,comm,true,ot::SM_TYPE::FDM,em1::EM1_DENDRO_GRAIN_SZ,em1::EM1_LOAD_IMB_TOL,em1::EM1_SPLIT_FIX);
    mesh->setDomainBounds(Point(em1::EM1_GRID_MIN_X,em1::EM1_GRID_MIN_Y,em1::EM1_GRID_MIN_Z), Point(em1::EM1_GRID_MAX_X, em1::EM1_GRID_MAX_Y,em1::EM1_GRID_MAX_Z));
    ...
    ode::solver::RK4_EM1 rk_em1(mesh,em1::EM1_RK45_TIME_BEGIN,em1::EM1_RK45_TIME_END,em1::EM1_RK45_TIME_STEP_SIZE);
    //ode::solver::RK3_EM1 rk_em1(mesh,em1::EM1_RK45_TIME_BEGIN,em1::EM1_RK45_TIME_END,em1::EM1_RK45_TIME_STEP_SIZE);
