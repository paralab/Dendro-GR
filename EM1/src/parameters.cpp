...
namespace em1 {
mem::memory_pool<DendroScalar> EM1_MEM_POOL =
...
double EM1_OCTREE_MAX[3] = {(double)(1u << EM1_MAXDEPTH),
                            (double)(1u << EM1_MAXDEPTH),
                            (double)(1u << EM1_MAXDEPTH)};

//@note assumes the computational domain is a cube as well.
double EM1_RK45_TIME_STEP_SIZE = EM1_CFL_FACTOR *
                                 (EM1_COMPD_MAX[0] - EM1_COMPD_MIN[0]) *
                                 (1.0 / (double)(1u << EM1_MAXDEPTH));
