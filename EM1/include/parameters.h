...
static const char* EM1_VAR_NAMES[]            = {"U_E0", "U_E1", "U_E2", "U_A0",
                                                 "U_A1", "U_A2", "U_PSI"};
...
static const unsigned int EM1_NUM_VARS_INTENL =
    (EM1_RK45_STAGES + 1) * EM1_NUM_VARS;
 ...
 * solution if currentTime > lastIOOutputTime + EM1_IO_OUTPUT_GAP)*/
 ...
 * tol<EM1_DENDRO_AMR_FAC*EM1_WAVELET_TOL)*/
