...
/**
 * @brief Note that we are computing the mixed derivatives, after applying the
...
void deriv42_xy(double *const DxDyu, double *const Dxu, const double *const u,
                const double dx, const double dy, const unsigned int *sz,
                unsigned bflag);
void deriv42_xz(double *const DxDzu, double *const Dxu, const double *const u,
                const double dx, const double dz, const unsigned int *sz,
                unsigned bflag);
void deriv42_yz(double *const DyDzu, double *const Dyu, const double *const u,
                const double dy, const double dz, const unsigned int *sz,
                unsigned bflag);
...
void deriv22_xx(double *const DxDxu, const double *const u, const double dx,
                const unsigned int *sz, unsigned bflag);
void deriv22_yy(double *const DyDyu, const double *const u, const double dy,
                const unsigned int *sz, unsigned bflag);
void deriv22_zz(double *const DzDzu, const double *const u, const double dz,
                const unsigned int *sz, unsigned bflag);

// -- (centered) 6th order derivs (in the interior) with (shifted) 4th order
// derivs near and on the boundaries.
...
void deriv644_xy(double *const DxDyu, double *const Dxu, const double *const u,
                 const double dx, const double dy, const unsigned int *sz,
                 unsigned bflag);
void deriv644_xz(double *const DxDzu, double *const Dxu, const double *const u,
                 const double dx, const double dz, const unsigned int *sz,
                 unsigned bflag);
void deriv644_yz(double *const DyDzu, double *const Dyu, const double *const u,
                 const double dy, const double dz, const unsigned int *sz,
                 unsigned bflag);

// -- (centered) 6th order derivs (in the interior) reducing to centered 4th
// order and centered 2nd order derivs near boundaries. On the boundary, we use
// a shifted second order derivative approximation.
...
void deriv642_xy(double *const DxDyu, double *const Dxu, const double *const u,
                 const double dx, const double dy, const unsigned int *sz,
                 unsigned bflag);
void deriv642_xz(double *const DxDzu, double *const Dxu, const double *const u,
                 const double dx, const double dz, const unsigned int *sz,
                 unsigned bflag);
void deriv642_yz(double *const DyDzu, double *const Dyu, const double *const u,
                 const double dy, const double dz, const unsigned int *sz,
                 unsigned bflag);
...
// -- (centered) 8th order derivs (in the interior) reducing to centered 6th
// order, centered 4th order and centered 2nd order derivs near boundaries. On
// the boundary, we use a shifted second order derivative approximation.
...
void deriv8642_xy(double *const DxDyu, double *const Dxu, const double *const u,
                  const double dx, const double dy, const unsigned int *sz,
                  unsigned bflag);
void deriv8642_xz(double *const DxDzu, double *const Dxu, const double *const u,
                  const double dx, const double dz, const unsigned int *sz,
                  unsigned bflag);
void deriv8642_yz(double *const DyDzu, double *const Dyu, const double *const u,
                  const double dy, const double dz, const unsigned int *sz,
                  unsigned bflag);

// -- (centered) 8th order derivs (in the interior) reducing to centered 6th
// order, shifted 6th order and shifted 4th order derivs near boundaries. On the
// boundary, we use a shifted 4th order derivative approximation.
...
void deriv8664_xy(double *const DxDyu, double *const Dxu, const double *const u,
                  const double dx, const double dy, const unsigned int *sz,
                  unsigned bflag);
void deriv8664_xz(double *const DxDzu, double *const Dxu, const double *const u,
                  const double dx, const double dz, const unsigned int *sz,
                  unsigned bflag);
void deriv8664_yz(double *const DyDzu, double *const Dyu, const double *const u,
                  const double dy, const double dz, const unsigned int *sz,
                  unsigned bflag);

// -- (centered) 8th order derivs (in the interior) reducing to centered 6th
// order and shifted 6th order near and on boundaries.
...
void deriv8666_xy(double *const DxDyu, double *const Dxu, const double *const u,
                  const double dx, const double dy, const unsigned int *sz,
                  unsigned bflag);
void deriv8666_xz(double *const DxDzu, double *const Dxu, const double *const u,
                  const double dx, const double dz, const unsigned int *sz,
                  unsigned bflag);
void deriv8666_yz(double *const DyDzu, double *const Dyu, const double *const u,
                  const double dy, const double dz, const unsigned int *sz,
                  unsigned bflag);
...
#ifdef EM1_USE_8TH_ORDER_DERIVS
