...
*@brief rk4 solver for em1 equations.
*/
//

#ifndef SFCSORTBENCH_RK4EM1_H
#define SFCSORTBENCH_RK4EM1_H
...
namespace ode
{
    namespace solver
    {
        ...
        class RK4_EM1 : public RK
        {

        private:

            // variables for EM1 formulation.
        ...
        public:
             ...
             * * */
            RK4_EM1(ot::Mesh *pMesh, double pTBegin, double pTEnd,double pTh);

            /**@brief default destructor*/
            ~RK4_EM1();

            /** @brief: read parameters related to EM1 simulation and store them in static variables defined in parameters.h*/
