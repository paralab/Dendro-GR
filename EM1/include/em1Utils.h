...
#define GRIDX_TO_X(xg) \
    (((Rx / RgX) * (xg - em1::EM1_OCTREE_MIN[0])) + em1::EM1_COMPD_MIN[0])
#define GRIDY_TO_Y(yg) \
    (((Ry / RgY) * (yg - em1::EM1_OCTREE_MIN[1])) + em1::EM1_COMPD_MIN[1])
#define GRIDZ_TO_Z(zg) \
    (((Rz / RgZ) * (zg - em1::EM1_OCTREE_MIN[2])) + em1::EM1_COMPD_MIN[2])

#define X_TO_GRIDX(xc) \
    (((RgX / Rx) * (xc - em1::EM1_COMPD_MIN[0])) + em1::EM1_OCTREE_MIN[0])
#define Y_TO_GRIDY(yc) \
    (((RgY / Ry) * (yc - em1::EM1_COMPD_MIN[1])) + em1::EM1_OCTREE_MIN[1])
#define Z_TO_GRIDZ(zc) \
    (((RgZ / Rz) * (zc - em1::EM1_COMPD_MIN[2])) + em1::EM1_OCTREE_MIN[2])
 ...
 * @param[in/out] zipVars: em1 variables to which dissipation needs to be
 * appied.
